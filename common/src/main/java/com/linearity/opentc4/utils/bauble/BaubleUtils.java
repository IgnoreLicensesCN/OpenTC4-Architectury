...
public class BaubleUtils {
    ...
    public static void forEachBaubleAndArmor(Player player, Consumer<ItemStack> consumer){
        player.getArmorSlots().forEach(consumer);
        forEachBauble(player,(_ignored1,stack,_ignored2) -> {
