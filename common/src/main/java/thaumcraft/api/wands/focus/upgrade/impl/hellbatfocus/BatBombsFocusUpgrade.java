...
public class BatBombsFocusUpgrade extends FocusUpgradeType {
    public static final BatBombsFocusUpgrade INSTANCE = new BatBombsFocusUpgrade();
    protected BatBombsFocusUpgrade(FocusUpgradeTypeResourceLocation id, AspectList<Aspect> aspects) {
        super(id, aspects);
    }
    protected BatBombsFocusUpgrade() {
        this(
    ...
    public boolean canApplyTo(ItemStack focusStack, IWandFocusItem<? extends Aspect> focusItem) {
        return easyIncompatibleCheck(focusStack,focusItem,this,DevilBatsFocusUpgrade.INSTANCE);
    }
}
