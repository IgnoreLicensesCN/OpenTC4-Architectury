 ...
 *
 */
@Deprecated(forRemoval = true,since = "see WandCastingItem and all it's interfaces related for help(you can also read those already-made wand rod classes)")
...
//
//	/**
//	 * The amount fromAspectVisList vis that can be stored - this number is actually multiplied
