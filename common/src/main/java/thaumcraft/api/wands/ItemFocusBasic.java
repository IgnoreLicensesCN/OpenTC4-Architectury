...
//
//	/**
//	 * Does the focus have ornamentation like the focus fromAspectVisList the nine hells. Ornamentation is a standard icon rendered in a cross around the focus
//	 */
