package thaumcraft.api.expands.listeners.aspects.item;
...
import thaumcraft.api.expands.listeners.aspects.item.listeners.BonusTagForItemListener;

import static thaumcraft.api.expands.listeners.aspects.item.consts.BonusTagForItemListeners.*;
