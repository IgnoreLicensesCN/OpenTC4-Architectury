...
public class WriteAspectContext {
    ...
    public final @NotNull("null->empty") Aspect aspectToWrite;
    public final @NotNull HexCoord coordToWrite;
    public final ResearchNoteData noteData;
    public boolean doDrainAspect = true;


    public WriteAspectContext(
        ...
        this.player = player;
        this.aspectToWrite = aspect;
        this.coordToWrite = placedAt;
