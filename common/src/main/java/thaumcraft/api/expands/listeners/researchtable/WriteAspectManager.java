...
import thaumcraft.api.expands.listeners.researchtable.consts.RemoveAspectAfterListenerEnums;
import thaumcraft.api.expands.listeners.researchtable.consts.RemoveAspectBeforeListenerEnums;
import thaumcraft.api.expands.listeners.researchtable.consts.WriteAspectAfterListenerEnums;
import thaumcraft.api.expands.listeners.researchtable.consts.WriteAspectBeforeListenerEnums;
import thaumcraft.api.expands.listeners.researchtable.listeners.RemoveAspectAfterListener;
import thaumcraft.api.expands.listeners.researchtable.listeners.RemoveAspectBeforeListener;
import thaumcraft.api.expands.listeners.researchtable.listeners.WriteAspectAfterListener;
import thaumcraft.api.expands.listeners.researchtable.listeners.WriteAspectBeforeListener;
