...
import thaumcraft.api.research.impl.alchemy.BathSaltsResearch;
...
public class ThaumcraftResearches {
    ...
    public static final CrimsonResearch CRIMSON = new CrimsonResearch();
    ...
    public static final BathSaltsResearch BATH_SALTS = new BathSaltsResearch();
