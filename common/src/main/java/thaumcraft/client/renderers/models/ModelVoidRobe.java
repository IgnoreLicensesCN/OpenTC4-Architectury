...
public class ModelVoidRobe extends ModelBiped {
   ModelRenderer Hood1;
   ModelRenderer Hood2;
   ModelRenderer Hood3;
   ModelRenderer Hood4;
   ...
   public ModelVoidRobe(float f) {
      ...
      this.setRotation(this.SideclothR3, 0.0F, 0.0F, ((float)Math.PI / 6F));
      ...
      this.setRotation(this.SideclothL3, 0.0F, 0.0F, (-(float)Math.PI / 6F));
