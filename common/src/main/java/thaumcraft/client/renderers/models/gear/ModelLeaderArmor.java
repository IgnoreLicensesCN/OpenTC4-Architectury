...
public class ModelLeaderArmor extends ModelBiped {
   ...
   public ModelLeaderArmor(float f) {
      ...
      this.setRotation(this.ShoulderL5, 0.0F, 0.0F, (-(float)Math.PI / 4F));
      this.ShoulderL4 = new ModelRenderer(this, 18, 4);
      this.ShoulderL4.addBox(1.3F, -1.5F, -4.0F, 1, 6, 1);
      this.setRotation(this.ShoulderL4, 0.0F, 0.0F, (-(float)Math.PI / 4F));
