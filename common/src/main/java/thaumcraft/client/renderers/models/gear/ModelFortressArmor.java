...
public class ModelFortressArmor extends ModelBiped {
   ...
   public ModelFortressArmor(float f) {
      ...
      this.setRotation(this.HelmetR, 0.0F, 0.0F, ((float)Math.PI / 6F));
      ...
      this.setRotation(this.HelmetL, 0.0F, 0.0F, (-(float)Math.PI / 6F));
      ...
      this.setRotation(this.HelmetB, ((float)Math.PI / 6F), 0.0F, 0.0F);
      ...
      this.setRotation(this.flapR, 0.0F, (-(float)Math.PI / 6F), ((float)Math.PI / 6F));
      ...
      this.setRotation(this.flapL, 0.0F, ((float)Math.PI / 6F), (-(float)Math.PI / 6F));
   ...
   public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      int set = hasSet.containsKey(entity.getEntityId()) ? (Integer)hasSet.get(entity.getEntityId()) : -1;
      int mask = hasMask.containsKey(entity.getEntityId()) ? (Integer)hasMask.get(entity.getEntityId()) : -1;
