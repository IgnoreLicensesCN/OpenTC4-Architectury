...
//
//   public FXBeamPower(Level par1World, double px, double py, double pz, double tx, double ty, double tz, float red, float green, float blue, int age) {
...
//      if (v instanceof Player && ((Player)v).inventory.armorItemInSlot(3) != null && ((Player)v).inventory.armorItemInSlot(3).getItem() instanceof IRevealer) {
//         opmod = 1.0F;
//      }
//
//      for(int t = 0; t < 2; ++t) {
