...
//   public int impact;
//
//   public FXBeamWand(Level par1World, Player player, double tx, double ty, double tz, float red, float green, float blue, int age) {
...
//      this.rotYaw = (float) (Math.atan2(xd, zd) * (double) 180.0F / Math.PI);
//
//      for (this.rotPitch = (float) (Math.atan2(
//              yd,
//              var7
//      ) * (double) 180.0F / Math.PI); this.rotPitch - this.prevPitch < -180.0F; this.prevPitch -= 360.0F) {
//      }
//
...
//              var13 - f1 * var12 - f4 * var12, var14 - f2 * var12, var15 - f3 * var12 - f5 * var12, var9, var11);
//      tessellator.addVertexWithUV(
//              var13 - f1 * var12 + f4 * var12, var14 + f2 * var12, var15 - f3 * var12 + f5 * var12, var9, var10);
//      tessellator.addVertexWithUV(
//              var13 + f1 * var12 + f4 * var12, var14 + f2 * var12, var15 + f3 * var12 + f5 * var12, var8, var10);
//      tessellator.addVertexWithUV(
//              var13 + f1 * var12 - f4 * var12, var14 - f2 * var12, var15 + f3 * var12 - f5 * var12, var8, var11);
//      tessellator.draw();
//      GL11.glDisable(GL11.GL_BLEND);
//      GL11.glDepthMask(true);
//      GL11.glPopMatrix();
