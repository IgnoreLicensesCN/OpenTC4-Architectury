...
//
//   public FXBubbleAlt(Level par1World, double par2, double par4, double par6, double par8, double par10, double par12, int age) {
...
//      this.prevPosZ = this.posZ;
//
//      this.motionX += (this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.001F;
//      this.motionZ += (this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.001F;
//
