...
//      float r1 = (float)this.start + 720.0F * (((float)this.age + f) / (float)this.lifetime);
//      float r2 = 90.0F - 180.0F * (((float)this.age + f) / (float)this.lifetime);
...
//      float var13 = (float)(this.x + (double)mX - interpPosX);
//      float var14 = (float)(Math.max(this.y + (double)mY, (float)this.miny + 0.1F) - interpPosY);
//      float var15 = (float)(this.z + (double)mZ - interpPosZ);
//      float var16 = 1.0F;
