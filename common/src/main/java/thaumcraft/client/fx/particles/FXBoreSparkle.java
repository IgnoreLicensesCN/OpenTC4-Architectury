...
//
//   public FXBoreSparkle(Level par1World,
...
//      && (MathHelper.floor_double(this.posX) != MathHelper.floor_double(this.targetX)
//      || MathHelper.floor_double(this.posY) != MathHelper.floor_double(this.targetY)
//      || MathHelper.floor_double(this.posZ) != MathHelper.floor_double(this.targetZ)
//      )) {
//         if (!this.noClip) {
