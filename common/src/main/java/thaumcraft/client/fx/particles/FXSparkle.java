...
//      switch (type) {
//         case 0:
//            this.particleRed = 0.75F + world.getRandom().nextFloat() * 0.25F;
//            this.particleGreen = 0.25F + world.getRandom().nextFloat() * 0.25F;
//            this.particleBlue = 0.75F + world.getRandom().nextFloat() * 0.25F;
//            break;
//         case 1:
//            this.particleRed = 0.5F + world.getRandom().nextFloat() * 0.3F;
//            this.particleGreen = 0.5F + world.getRandom().nextFloat() * 0.3F;
//            this.particleBlue = 0.2F;
//            break;
//         case 2:
//            this.particleRed = 0.2F;
//            this.particleGreen = 0.2F;
//            this.particleBlue = 0.7F + world.getRandom().nextFloat() * 0.3F;
//            break;
//         case 3:
//            this.particleRed = 0.2F;
//            this.particleGreen = 0.7F + world.getRandom().nextFloat() * 0.3F;
//            this.particleBlue = 0.2F;
//            break;
//         case 4:
//            this.particleRed = 0.7F + world.getRandom().nextFloat() * 0.3F;
//            this.particleGreen = 0.2F;
//            this.particleBlue = 0.2F;
//            break;
//         case 5:
//            this.blendmode = 771;
//            this.particleRed = world.getRandom().nextFloat() * 0.1F;
//            this.particleGreen = world.getRandom().nextFloat() * 0.1F;
//            this.particleBlue = world.getRandom().nextFloat() * 0.1F;
//            break;
//         case 6:
//            this.particleRed = 0.8F + world.getRandom().nextFloat() * 0.2F;
//            this.particleGreen = 0.8F + world.getRandom().nextFloat() * 0.2F;
//            this.particleBlue = 0.8F + world.getRandom().nextFloat() * 0.2F;
//            break;
//         case 7:
//            this.particleRed = 0.2F;
//            this.particleGreen = 0.5F + world.getRandom().nextFloat() * 0.3F;
//            this.particleBlue = 0.6F + world.getRandom().nextFloat() * 0.3F;
//      }
//
//   }
//
...
//      this.prevPosY = this.posY;
//      this.prevPosZ = this.posZ;
//      if (this.particleAge == 0 && this.tinkle && this.level().rand.nextInt(10) == 0) {
//         this.level().playSoundAtEntity(this, "random.orb", 0.02F, 0.7F * ((this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.6F + 2.0F));
//      }
//
...
//         FXSparkle fx = new FXSparkle(this.level(), this.prevPosX + (double)((this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.1F), this.prevPosY + (double)((this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.1F), this.prevPosZ + (double)((this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.1F), 1.0F, this.currentColor, 3 + this.level().rand.nextInt(3));
//         fx.noClip = true;
...
//      if (!this.level().isAirBlock(var7, var8, var9)) {
//         boolean var16 = !this.level().isBlockNormalCubeDefault(var7 - 1, var8, var9, true);
//         boolean var17 = !this.level().isBlockNormalCubeDefault(var7 + 1, var8, var9, true);
//         boolean var18 = !this.level().isBlockNormalCubeDefault(var7, var8 - 1, var9, true);
//         boolean var19 = !this.level().isBlockNormalCubeDefault(var7, var8 + 1, var9, true);
//         boolean var20 = !this.level().isBlockNormalCubeDefault(var7, var8, var9 - 1, true);
//         boolean var21 = !this.level().isBlockNormalCubeDefault(var7, var8, var9 + 1, true);
//         byte var22 = -1;
