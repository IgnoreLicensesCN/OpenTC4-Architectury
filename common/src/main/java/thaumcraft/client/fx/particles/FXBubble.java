...
//   public FXBubble(Level par1World, double par2, double par4, double par6, double par8, double par10, double par12, int age) {
...
//         this.motionX += (this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.01F;
//         this.motionZ += (this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.01F;
//      }
//
...
//      float var13 = (float)(this.prevPosX + (this.posX - this.prevPosX) * (double)partialTicks - interpPosX);
//      float var14 = (float)(this.prevPosY + (this.posY - this.prevPosY) * (double)partialTicks - interpPosY);
//      float var15 = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * (double)partialTicks - interpPosZ);
//      float var16 = 1.0F;
