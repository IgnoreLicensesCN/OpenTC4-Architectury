...
//   public FXDrop(Level par1World, double par2, double par4, double par6, float r, float g, float b) {
...
//      }
//
//      Material material = this.level().getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)).getMaterial();
//      if (material != Material.glass && (material.isLiquid() || material.isSolid())) {
//         double d0 = (float)(MathHelper.floor_double(this.posY) + 1) - BlockLiquid.getLiquidHeightPercent(this.level().getBlockMetadata(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)));
//         if (this.posY < d0) {
//            this.setDead();
//         }
//      }
...
//      if (!this.noClip && this.level().getBlock(x, y, z) != ConfigBlocks.blockJar) {
...
//            Block j1 = this.level().getBlock(l, k, i1);
//            if (j1.isAir(this.level(), l, k, i1)) {
//               int k1 = this.level().getBlock(l, k - 1, i1).getRenderType();
//               if (k1 == 11 || k1 == 32 || k1 == 21) {
//                  j1 = this.level().getBlock(l, k - 1, i1);
//               }
//            }
//
//            if (j1 != Blocks.ladder) {
...
//         y = MathHelper.floor_double(this.posY);
//         if (this.level().getBlock(x, y + 1, z) == ConfigBlocks.blockJar) {
