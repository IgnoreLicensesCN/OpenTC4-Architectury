...
//         case 7:
//            this.particleRed = 0.7F + world.getRandom().nextFloat() * 0.3F;
//            this.particleGreen = 0.5F + world.getRandom().nextFloat() * 0.2F;
//            this.particleBlue = 0.3F + world.getRandom().nextFloat() * 0.1F;
//      }
//
//   }
//
...
//      this.prevPosY = this.posY;
//      this.prevPosZ = this.posZ;
//      if (this.particleAge == 0 && this.tinkle && this.level().rand.nextInt(3) == 0) {
//         this.level().playSoundAtEntity(this, "random.orb", 0.02F, 0.5F * ((this.level().rand.nextFloat() - this.level().rand.nextFloat()) * 0.6F + 2.0F));
//      }
//
...
//      if (!this.level().isAirBlock(var7, var8, var9) && this.level().isBlockNormalCubeDefault(var7, var8, var9, true) && !this.level().isAnyLiquid(this.boundingBox)) {
