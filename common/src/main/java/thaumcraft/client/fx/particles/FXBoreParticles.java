...
//
//   public FXBoreParticles(Level par1World, double par2, double par4, double par6, double tx, double ty, double tz, Block par14Block, int par15, int par16) {
...
//      float f3 = 0.01F;
//      this.motionX = (float)this.level().rand.nextGaussian() * f3;
//      this.motionY = (float)this.level().rand.nextGaussian() * f3;
//      this.motionZ = (float)this.level().rand.nextGaussian() * f3;
...
//   }
//
//   public FXBoreParticles(Level par1World, double par2, double par4, double par6, double tx, double ty, double tz, Item item, int par15, int par16) {
//      super(par1World, par2, par4, par6, 0.0F, 0.0F, 0.0F);
...
//      if (this.blockInstance != null && this.level().getBlock(par1, par2, par3) == this.blockInstance) {
//          if (this.blockInstance != Blocks.grass || this.side == 1) {
//              try {
//                  int var4 = this.blockInstance.colorMultiplier(this.level(), par1, par2, par3);
...
//      if (!this.level().isAirBlock(var7, var8, var9) && !this.level().isAnyLiquid(this.boundingBox)) {
