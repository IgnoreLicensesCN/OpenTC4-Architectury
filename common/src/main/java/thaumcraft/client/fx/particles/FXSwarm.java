...
//      }
//
//      if (buzzcount.size() < 3 && this.rand.nextInt(50) == 0 && this.level().getClosestPlayerToEntity(this, 8.0F) != null) {
//         this.level().playSound(this.posX, this.posY, this.posZ, "thaumcraft:fly", 0.03F, 0.5F + this.rand.nextFloat() * 0.4F, false);
...
//      if (this.level().getBlock(var7, var8, var9) != ConfigBlocks.blockTaintFibres && !this.level().isAirBlock(var7, var8, var9) && !this.level().isAnyLiquid(this.boundingBox)) {
