...
public class ConfigAspects {
   ...
   private static void registerItemAspects() {
      ...
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.AMBER_GEM()), (new LinkedHashAspectList<>()).addAll(Aspects.TRAP, 2).addAll(
              Aspects.CRYSTAL, 2));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.KNOWLEDGE_FRAGMENT()), (new LinkedHashAspectList<>()).addAll(
              Aspects.MIND, 8));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.TAINTED_GOO(),1), (new LinkedHashAspectList<>()).addAll(Aspects.TAINT, 3).addAll(
              Aspects.SLIME, 1));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.TAINT_TENDRIL(),1), (new LinkedHashAspectList<>()).addAll(Aspects.TAINT, 2).addAll(
              Aspects.GREED, 1).addAll(Aspects.HUNGER, 1));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.GOLD_COIN()), (new LinkedHashAspectList<>()).addAll(Aspects.GREED, 1));
      ...
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.SALIS_MUNDUS(), 1), (new AspectList(new ItemStack(ConfigItems.itemShard, 1, 6))).addAll(
      ...
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.ELDRITCH_EYE()), (new LinkedHashAspectList<>()).addAll(Aspects.ELDRITCH, 5).addAll(
              Aspects.AURA, 3).addAll(Aspects.MAGIC, 3).addAll(Aspects.SENSES, 3).addAll(
              Aspects.SOUL, 3));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.CRIMSON_RITES()), (new LinkedHashAspectList<>()).addAll(Aspects.MIND, 5).addAll(
              Aspects.MAGIC, 3).addAll(
              Aspects.ELDRITCH, 3).addAll(Aspects.SOUL, 3));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.RUNED_TABLET()), (new LinkedHashAspectList<>()).addAll(Aspects.TRAP, 4).addAll(
              Aspects.MIND, 4).addAll(Aspects.MECHANISM, 4));
      ItemBasicAspectRegistration.registerItemBasicAspects(new ItemStack(ThaumcraftItemInstances.PRIME_PEARL()), (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 16).addAll(
