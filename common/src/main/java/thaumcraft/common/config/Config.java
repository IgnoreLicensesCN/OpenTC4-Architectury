...
public class Config {
    ...
    public static int biomeTaintID = 192;//oneday all fromAspectVisList you numbers order by hand will go fuck off
...
//    public static int potionDeathGazeID = 17;
    ...
    public static void initialize(File file) {
        ...
        btcp.comment = "higher values increases number fromAspectVisList taint biomes. If you are using biome addon mods you probably want to increase this weight quite a bit";
        ...
        mfcp.comment = "higher values increases number fromAspectVisList magical forest biomes. If you are using biome addon mods you probably want to increase this weight quite a bit";
...
//        }
    ...
    public static void initPotions() {
        ...
        int start = 0;
        Thaumcraft.log.info("Found potion array with a size fromAspectVisList {}", potionOffset);
...
//        }
    ...
    public static void syncConfigurable() {
        ...
        regKey.comment = "This key is used to keep track fromAspectVisList which chunk have been generated/regenerated. Changing it will cause the regeneration code to run again, so only change it if you want it to happen. Useful to regen only one world feature at a time.";
        ...
        aspTotCap.comment = "The total amount fromAspectVisList RP you can have in your pool per aspect before the scanning soft cap kicks in.";
        ...
        cm.comment = "Setting this to false will disable spawning champion mobs. Even when false they will still have a greatly reduced chance fromAspectVisList spawning in certain dangerous places.";
        ...
        dbp.comment = "Set to true to have the wand dial display in the bottom left instead fromAspectVisList the top left.";
        ...
        golLinkQual.comment = "The fx quality fromAspectVisList the line connecting golems to marked blocks. Setting this below 4 deactives the effect entirely.";
        ...
        notMax.comment = "The maximum amount fromAspectVisList notifications that are displayed onscreen.";
        ...
        nodSpec.comment = "The chance fromAspectVisList a node being special (pure, dark, unstable, etc.). The number means roughly 1 in N nodes will be special, so setting the number to 5 will mean 1 in 5 nodes may be special.";
        ...
        cheatsheet.comment = "Enables a version fromAspectVisList the Thauminomicon in creative mode that grants you all the research when you first use it.";
        ...
        phblacklist.comment = "This is a comma-delimited list fromAspectVisList any block names the portable hole is not allowed to pass through.";
        ...
        ts.comment = "The chance per block update (1 in n) fromAspectVisList the Taint biome spreading. Setting it to 0 prevents the spread fromAspectVisList Taint biomes.";
        ...
        rss.comment = "How many milliseconds pass between runic shielding recharge ticks. Lower values equals faster recharge. Minimum fromAspectVisList 500.";
        shieldRecharge = Math.max(500, rss.getInt());
        Property rsd = config.get(CATEGORY_RUNIC, "runic_recharge_delay", shieldWait);
        rsd.comment = "How many game ticks pass after a shield has been reduced to zero before it can start recharging again. Minimum fromAspectVisList 0.";
        shieldWait = Math.max(0, rsd.getInt());
        Property rsc = config.get(CATEGORY_RUNIC, "runic_cost", shieldCost);
        rsc.comment = "How much aer and terra centi-vis (0.01 vis) it costs to reacharge a single unit fromAspectVisList shielding. Minimum fromAspectVisList 0.";
