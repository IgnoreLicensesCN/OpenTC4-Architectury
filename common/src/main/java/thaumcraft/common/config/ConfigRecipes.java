...
public class ConfigRecipes {
   ...
   private static void initializeArcaneRecipes() {
      for(int a = 0; a < 16; ++a) {
         ...
         ConfigResearch.recipes.put("Banner_" + a, ThaumcraftApi.addArcaneCraftingRecipe("BANNERS", banner, (new AspectList()).addAll(
                 Aspects.WATER, 5).addAll(Aspects.EARTH, 5), "WS", "WS", "WB", 'W', new ItemStack(Blocks.wool, 1, a), 'S', "stickWood", 'B', "slabWood"));
      }

      ConfigResearch.recipes.put("PrimalCharm", ThaumcraftApi.addArcaneCraftingRecipe("BASICARTIFACE", new ItemStack(ThaumcraftItems.PRIMAL_CHARM, 1), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneDoor", ThaumcraftApi.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigItems.itemArcaneDoor), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WardedGlass", ThaumcraftApi.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigBlocks.blockCosmeticOpaque, 8, 2), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("IronKey", ThaumcraftApi.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigItems.itemKey, 2, 0), (new AspectList()).addAll(
              Aspects.WATER, 5).addAll(Aspects.ORDER, 5), "NNI", "N  ", 'I', Items.iron_ingot, 'N', "nuggetIron"));
      ConfigResearch.recipes.put("FluxScrubber", ThaumcraftApi.addArcaneCraftingRecipe("FLUXSCRUB", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 14), (new AspectList()).addAll(
      ...
      if (Config.wardedStone) {
         ConfigResearch.recipes.put("GoldKey", ThaumcraftApi.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigItems.itemKey, 2, 1), (new AspectList()).addAll(
                 Aspects.WATER, 5).addAll(Aspects.ORDER, 5), "NNI", "N  ", 'I', Items.gold_ingot, 'N', Items.gold_nugget));
         ConfigResearch.recipes.put("ArcanePressurePlate", ThaumcraftApi.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 2), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("NodeStabilizer", ThaumcraftApi.addArcaneCraftingRecipe("NODESTABILIZER", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 9), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("NodeTransducer", ThaumcraftApi.addArcaneCraftingRecipe("VISPOWER", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 11), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("NodeRelay", ThaumcraftApi.addArcaneCraftingRecipe("VISPOWER", new ItemStack(ConfigBlocks.blockMetalDevice, 2, 14), (new AspectList()).addAll(
              Aspects.FIRE, 8).addAll(Aspects.ORDER, 8), " I ", "ISI", " I ", 'I', new ItemStack(Items.iron_ingot), 'S', new ItemStack(ConfigItems.itemShard, 1, 6)));
      ConfigResearch.recipes.put("NodeChargeRelay", ThaumcraftApi.addArcaneCraftingRecipe("VISCHARGERELAY", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 2), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocalManipulator", ThaumcraftApi.addArcaneCraftingRecipe("FOCALMANIPULATION", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 13), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("GolemFetter", ThaumcraftApi.addArcaneCraftingRecipe("GOLEMFETTER", new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 9), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneStone1", ThaumcraftApi.addArcaneCraftingRecipe("ARCANESTONE", new ItemStack(ConfigBlocks.blockCosmeticSolid, 9, 6), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("PaveTravel", ThaumcraftApi.addArcaneCraftingRecipe("PAVETRAVEL", new ItemStack(ConfigBlocks.blockCosmeticSolid, 4, 2), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneLamp", ThaumcraftApi.addArcaneCraftingRecipe("ARCANELAMP", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 7), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneSpa", ThaumcraftApi.addArcaneCraftingRecipe("ARCANESPA", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 12), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("PaveWard", ThaumcraftApi.addArcaneCraftingRecipe("PAVEWARD", new ItemStack(ConfigBlocks.blockCosmeticSolid, 4, 3), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Levitator", ThaumcraftApi.addArcaneCraftingRecipe("LEVITATOR", new ItemStack(ConfigBlocks.blockLifter), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneEar", ThaumcraftApi.addArcaneCraftingRecipe("ARCANEEAR", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 1), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("MirrorGlass", ThaumcraftApi.addShapelessArcaneCraftingRecipe("BASICARTIFACE", new ItemStack(ThaumcraftItems.MIRRORED_GLASS, 1), (new AspectList()).addAll(
      ...
      for(int a = 0; a < 6; ++a) {
         ConfigResearch.recipes.put("PrimalArrow_" + a, ThaumcraftApi.addArcaneCraftingRecipe("PRIMALARROW", new ItemStack(ConfigItems.itemPrimalArrow, 8, a), (new AspectList()).addAll(pa[a], 8), "AAA", "ASA", "AAA", 'A', Items.arrow, 'S', new ItemStack(ConfigItems.itemShard, 1, a)));
      }

      ConfigResearch.recipes.put("InfusionMatrix", ThaumcraftApi.addArcaneCraftingRecipe("INFUSION", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 2), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcanePedestal", ThaumcraftApi.addArcaneCraftingRecipe("INFUSION", new ItemStack(ConfigBlocks.blockStoneDevice, 2, 1), (new AspectList()).addAll(
              Aspects.AIR, 5), "SSS", " S ", "SSS", 'S', new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 6)));
      ConfigResearch.recipes.put("WardedJar", ThaumcraftApi.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockJar, 1, 0), (new AspectList()).addAll(
              Aspects.WATER, 1), "GWG", "G G", "GGG", 'W', "slabWood", 'G', Blocks.glass_pane));
      ConfigResearch.recipes.put("JarVoid", ThaumcraftApi.addArcaneCraftingRecipe("JARVOID", new ItemStack(ConfigBlocks.blockJar, 1, 3), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapGold", ThaumcraftApi.addArcaneCraftingRecipe("CAP_gold", new ItemStack(ConfigItems.itemWandCap, 1, 1), (new AspectList()).addAll(
      ...
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("WandCapCopper", ThaumcraftApi.addArcaneCraftingRecipe("CAP_copper", new ItemStack(ConfigItems.itemWandCap, 1, 3), (new AspectList()).addAll(
      ...
      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("WandCapSilverInert", ThaumcraftApi.addArcaneCraftingRecipe("CAP_silver", new ItemStack(ConfigItems.itemWandCap, 1, 5), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapThaumiumInert", ThaumcraftApi.addArcaneCraftingRecipe("CAP_thaumium", new ItemStack(ConfigItems.itemWandCap, 1, 6), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapVoidInert", ThaumcraftApi.addArcaneCraftingRecipe("CAP_void", new ItemStack(ConfigItems.itemWandCap, 1, 8), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodGreatwood", ThaumcraftApi.addArcaneCraftingRecipe("ROD_greatwood", new ItemStack(ConfigItems.itemWandRod, 1, 0), (new AspectList()).addAll(
              Aspects.ENTROPY, WandRod.rods.get("greatwood").getCraftCost()), " G", "G ", 'G', new ItemStack(ConfigBlocks.blockMagicalLog, 1, 0)));
      ConfigResearch.recipes.put("WandRodGreatwoodStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_greatwood_staff", new ItemStack(ConfigItems.itemWandRod, 1, 50), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodObsidianStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_obsidian_staff", new ItemStack(ConfigItems.itemWandRod, 1, 51), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodSilverwoodStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_silverwood_staff", new ItemStack(ConfigItems.itemWandRod, 1, 52), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodIceStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_ice_staff", new ItemStack(ConfigItems.itemWandRod, 1, 53), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodQuartzStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_quartz_staff", new ItemStack(ConfigItems.itemWandRod, 1, 54), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodReedStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_reed_staff", new ItemStack(ConfigItems.itemWandRod, 1, 55), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBlazeStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_blaze_staff", new ItemStack(ConfigItems.itemWandRod, 1, 56), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBoneStaff", ThaumcraftApi.addArcaneCraftingRecipe("ROD_bone_staff", new ItemStack(ConfigItems.itemWandRod, 1, 57), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusFire", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSFIRE", new ItemStack(ConfigItems.itemFocusFire), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusFrost", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSFROST", new ItemStack(ConfigItems.itemFocusFrost), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusShock", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSSHOCK", new ItemStack(ConfigItems.itemFocusShock), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusTrade", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSTRADE", new ItemStack(ConfigItems.itemFocusTrade), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusExcavation", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSEXCAVATION", new ItemStack(ConfigItems.itemFocusExcavation), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusPrimal", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSPRIMAL", new ItemStack(ConfigItems.itemFocusPrimal), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusPouch", ThaumcraftApi.addArcaneCraftingRecipe("FOCUSPOUCH", new ItemStack(ConfigItems.itemFocusPouch), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Deconstructor", ThaumcraftApi.addArcaneCraftingRecipe("DECONSTRUCTOR", new ItemStack(ConfigBlocks.blockTable, 1, 14), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneBoreBase", ThaumcraftApi.addArcaneCraftingRecipe("ARCANEBORE", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 4), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("EnchantedFabric", ThaumcraftApi.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RobeChest", ThaumcraftApi.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ConfigItems.itemChestRobe, 1), (new AspectList()).addAll(
              Aspects.AIR, 5), "I I", "III", "III", 'I', new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC)));
      ConfigResearch.recipes.put("RobeLegs", ThaumcraftApi.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ConfigItems.itemLegsRobe, 1), (new AspectList()).addAll(
              Aspects.WATER, 5), "III", "I I", "I I", 'I', new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC)));
      ConfigResearch.recipes.put("RobeBoots", ThaumcraftApi.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ConfigItems.itemBootsRobe, 1), (new AspectList()).addAll(
              Aspects.EARTH, 3), "I I", "I I", 'I', new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC)));
      GameRegistry.addRecipe(new RecipesRobeArmorDyes());
      ConfigResearch.recipes.put("Goggles", ThaumcraftApi.addArcaneCraftingRecipe("GOGGLES", new ItemStack(ConfigItems.itemGoggles), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("HungryChest", ThaumcraftApi.addArcaneCraftingRecipe("HUNGRYCHEST", new ItemStack(ConfigBlocks.blockChestHungry), (new AspectList()).addAll(
              Aspects.AIR, 5).addAll(Aspects.ORDER, 3).addAll(Aspects.ENTROPY, 3), "WTW", "W W", "WWW", 'W', "plankWood", 'T', Blocks.trapdoor));
      ConfigResearch.recipes.put("GolemBell", ThaumcraftApi.addArcaneCraftingRecipe("GOLEMBELL", new ItemStack(ConfigItems.itemGolemBell), (new AspectList()).addAll(
              Aspects.ORDER, 5), " QQ", " QQ", "S  ", 'S', "stickWood", 'Q', Items.quartz));
      ConfigResearch.recipes.put("CoreBlank", ThaumcraftApi.addArcaneCraftingRecipe("COREGATHER", new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList()).addAll(
              Aspects.ORDER, 5).addAll(Aspects.FIRE, 5), " C ", "CNC", " C ", 'C', Items.brick, 'N', new ItemStack(ThaumcraftItems.NITOR)));
      ConfigResearch.recipes.put("UpgradeAir", ThaumcraftApi.addArcaneCraftingRecipe("UPGRADEAIR", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 0), (new AspectList()).addAll(
              Aspects.AIR, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 0)));
      ConfigResearch.recipes.put("UpgradeEarth", ThaumcraftApi.addArcaneCraftingRecipe("UPGRADEEARTH", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 1), (new AspectList()).addAll(
              Aspects.EARTH, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 3)));
      ConfigResearch.recipes.put("UpgradeFire", ThaumcraftApi.addArcaneCraftingRecipe("UPGRADEFIRE", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 2), (new AspectList()).addAll(
              Aspects.FIRE, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 1)));
      ConfigResearch.recipes.put("UpgradeWater", ThaumcraftApi.addArcaneCraftingRecipe("UPGRADEWATER", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 3), (new AspectList()).addAll(
              Aspects.WATER, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 2)));
      ConfigResearch.recipes.put("UpgradeOrder", ThaumcraftApi.addArcaneCraftingRecipe("UPGRADEORDER", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 4), (new AspectList()).addAll(
              Aspects.ORDER, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 4)));
      ConfigResearch.recipes.put("UpgradeEntropy", ThaumcraftApi.addArcaneCraftingRecipe("UPGRADEENTROPY", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 5), (new AspectList()).addAll(
              Aspects.ENTROPY, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 5)));
      ConfigResearch.recipes.put("TinyHat", ThaumcraftApi.addArcaneCraftingRecipe("TINYHAT", new ItemStack(ConfigItems.itemGolemDecoration, 1, 0), (new AspectList()).addAll(
              Aspects.ORDER, 8).addAll(Aspects.FIRE, 8), " C ", " G ", "CCC", 'C', new ItemStack(Blocks.wool, 1, 15), 'G', Items.gold_ingot));
      ConfigResearch.recipes.put("TinyFez", ThaumcraftApi.addArcaneCraftingRecipe("TINYFEZ", new ItemStack(ConfigItems.itemGolemDecoration, 1, 3), (new AspectList()).addAll(
              Aspects.WATER, 4).addAll(Aspects.EARTH, 4), "CCS", "CCS", "  S", 'C', new ItemStack(Blocks.wool, 1, 14), 'S', Items.string));
      ConfigResearch.recipes.put("TinyBowtie", ThaumcraftApi.addArcaneCraftingRecipe("TINYBOWTIE", new ItemStack(ConfigItems.itemGolemDecoration, 1, 2), (new AspectList()).addAll(
              Aspects.AIR, 4).addAll(Aspects.ORDER, 4), "CSC", "C C", 'C', new ItemStack(Blocks.wool, 1, 15), 'S', Items.string));
      ConfigResearch.recipes.put("TinyGlasses", ThaumcraftApi.addArcaneCraftingRecipe("TINYGLASSES", new ItemStack(ConfigItems.itemGolemDecoration, 1, 1), (new AspectList()).addAll(
              Aspects.AIR, 4).addAll(Aspects.WATER, 4), "GIG", 'G', Blocks.glass, 'I', Items.iron_ingot));
      ConfigResearch.recipes.put("TinyDart", ThaumcraftApi.addArcaneCraftingRecipe("TINYDART", new ItemStack(ConfigItems.itemGolemDecoration, 1, 4), (new AspectList()).addAll(
              Aspects.AIR, 4).addAll(Aspects.FIRE, 4), "AIA", "ADA", "AIA", 'I', Items.iron_ingot, 'D', Blocks.dispenser, 'A', Items.arrow));
      ConfigResearch.recipes.put("TinyVisor", ThaumcraftApi.addArcaneCraftingRecipe("TINYVISOR", new ItemStack(ConfigItems.itemGolemDecoration, 1, 5), (new AspectList()).addAll(
              Aspects.EARTH, 4).addAll(Aspects.WATER, 4), "IHI", 'I', Items.iron_ingot, 'H', new ItemStack(Items.iron_helmet, 1, 32767)));
      ConfigResearch.recipes.put("TinyArmor", ThaumcraftApi.addArcaneCraftingRecipe("TINYARMOR", new ItemStack(ConfigItems.itemGolemDecoration, 1, 6), (new AspectList()).addAll(
              Aspects.EARTH, 8), "I I", "IAI", 'I', Items.iron_ingot, 'A', new ItemStack(Items.iron_chestplate, 1, 32767)));
      ConfigResearch.recipes.put("TinyHammer", ThaumcraftApi.addArcaneCraftingRecipe("TINYHAMMER", new ItemStack(ConfigItems.itemGolemDecoration, 1, 7), (new AspectList()).addAll(
              Aspects.EARTH, 4).addAll(Aspects.FIRE, 4), "III", "III", " I ", 'I', Items.iron_ingot));
      ConfigResearch.recipes.put("Filter", ThaumcraftApi.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ThaumcraftItems.VIS_FILTER, 2), (new AspectList()).addAll(
              Aspects.ORDER, 5).addAll(Aspects.WATER, 5), "GWG", 'G', Items.gold_ingot, 'W', new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 7)));
      ConfigResearch.recipes.put("AlchemyFurnace", ThaumcraftApi.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 0), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Alembic", ThaumcraftApi.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 1), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Bellows", ThaumcraftApi.addArcaneCraftingRecipe("BELLOWS", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 0), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Tube", ThaumcraftApi.addArcaneCraftingRecipe("TUBES", new ItemStack(ConfigBlocks.blockTube, 8, 0), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Resonator", ThaumcraftApi.addArcaneCraftingRecipe("TUBES", new ItemStack(ConfigItems.itemResonator), (new AspectList()).addAll(
              Aspects.WATER, 5).addAll(Aspects.AIR, 5), "I I", "INI", " S ", 'I', Items.iron_ingot, 'N', Items.quartz, 'S', "stickWood"));
      ConfigResearch.recipes.put("TubeValve", ThaumcraftApi.addShapelessArcaneCraftingRecipe("TUBES", new ItemStack(ConfigBlocks.blockTube, 1, 1), (new AspectList()).addAll(
              Aspects.WATER, 5).addAll(Aspects.ORDER, 5), new ItemStack(ConfigBlocks.blockTube, 1, 0), new ItemStack(Blocks.lever)));
      ConfigResearch.recipes.put("TubeFilter", ThaumcraftApi.addShapelessArcaneCraftingRecipe("TUBEFILTER", new ItemStack(ConfigBlocks.blockTube, 1, 3), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("TubeRestrict", ThaumcraftApi.addShapelessArcaneCraftingRecipe("TUBEFILTER", new ItemStack(ConfigBlocks.blockTube, 1, 5), (new AspectList()).addAll(
              Aspects.WATER, 5).addAll(Aspects.EARTH, 16), new ItemStack(ConfigBlocks.blockTube, 1, 0), "stone"));
      ConfigResearch.recipes.put("TubeOneway", ThaumcraftApi.addShapelessArcaneCraftingRecipe("TUBEFILTER", new ItemStack(ConfigBlocks.blockTube, 1, 6), (new AspectList()).addAll(
              Aspects.WATER, 5).addAll(Aspects.ORDER, 8).addAll(Aspects.ENTROPY, 8), new ItemStack(ConfigBlocks.blockTube, 1, 0), "dyeBlue"));
      ConfigResearch.recipes.put("TubeBuffer", ThaumcraftApi.addArcaneCraftingRecipe("CENTRIFUGE", new ItemStack(ConfigBlocks.blockTube, 1, 4), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("AlchemicalConstruct", ThaumcraftApi.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 9), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("AdvAlchemyConstruct", ThaumcraftApi.addArcaneCraftingRecipe("ADVALCHEMYFURNACE", new ItemStack(ConfigBlocks.blockMetalDevice, 4, 3), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("Centrifuge", ThaumcraftApi.addArcaneCraftingRecipe("CENTRIFUGE", new ItemStack(ConfigBlocks.blockTube, 1, 2), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("EssentiaCrystalizer", ThaumcraftApi.addArcaneCraftingRecipe("ESSENTIACRYSTAL", new ItemStack(ConfigBlocks.blockTube, 1, 7), (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("MnemonicMatrix", ThaumcraftApi.addArcaneCraftingRecipe("THAUMATORIUM", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 12), (new AspectList()).addAll(
   ...
   private static void initializeInfusionEnchantmentRecipes() {
      ConfigResearch.recipes.put("InfEnchRepair", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.enchantmentsList[ThaumcraftApi.enchantRepair], 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnchHaste", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.enchantmentsList[ThaumcraftApi.enchantHaste], 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch0", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.protection, 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch1", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.fireProtection, 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch2", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.blastProtection, 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch3", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.projectileProtection, 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch4", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.featherFalling, 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch5", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.respiration, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch6", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.aquaAffinity, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch7", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.thorns, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch8", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.sharpness, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch9", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.smite, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch10", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.baneOfArthropods, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch11", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.knockback, 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch12", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.fireAspect, 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch13", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.looting, 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch14", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.efficiency, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch15", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.silkTouch, 5, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch16", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.unbreaking, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch17", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.fortune, 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch18", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.power, 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch19", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.punch, 2, (new AspectList()).addAll(
              Aspects.MAGIC, 4).addAll(Aspects.WEAPON, 3).addAll(Aspects.MOTION, 3), new ItemStack[]{new ItemStack(Blocks.piston), new ItemStack(ThaumcraftItems.SALIS_MUNDUS, 1)}));
      ConfigResearch.recipes.put("InfEnch20", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.flame, 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch21", ThaumcraftApi.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.infinity, 5, (new AspectList()).addAll(
   ...
   private static void initializeInfusionRecipes() {
      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("WandCapSilver", ThaumcraftApi.addInfusionCraftingRecipe("CAP_silver", new ItemStack(ConfigItems.itemWandCap, 1, 4), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapThaumium", ThaumcraftApi.addInfusionCraftingRecipe("CAP_thaumium", new ItemStack(ConfigItems.itemWandCap, 1, 2), 5, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapVoid", ThaumcraftApi.addInfusionCraftingRecipe("CAP_void", new ItemStack(ConfigItems.itemWandCap, 1, 7), 8, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodObsidian", ThaumcraftApi.addInfusionCraftingRecipe("ROD_obsidian", new ItemStack(ConfigItems.itemWandRod, 1, 1), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodIce", ThaumcraftApi.addInfusionCraftingRecipe("ROD_ice", new ItemStack(ConfigItems.itemWandRod, 1, 3), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodQuartz", ThaumcraftApi.addInfusionCraftingRecipe("ROD_quartz", new ItemStack(ConfigItems.itemWandRod, 1, 4), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodReed", ThaumcraftApi.addInfusionCraftingRecipe("ROD_reed", new ItemStack(ConfigItems.itemWandRod, 1, 5), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBlaze", ThaumcraftApi.addInfusionCraftingRecipe("ROD_blaze", new ItemStack(ConfigItems.itemWandRod, 1, 6), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBone", ThaumcraftApi.addInfusionCraftingRecipe("ROD_bone", new ItemStack(ConfigItems.itemWandRod, 1, 7), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodSilverwood", ThaumcraftApi.addInfusionCraftingRecipe("ROD_silverwood", new ItemStack(ConfigItems.itemWandRod, 1, 2), 5, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodPrimalStaff", ThaumcraftApi.addInfusionCraftingRecipe("ROD_primal_staff", new ItemStack(ConfigItems.itemWandRod, 1, 100), 8, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusHellbat", ThaumcraftApi.addInfusionCraftingRecipe("FOCUSHELLBAT", new ItemStack(ConfigItems.itemFocusHellbat), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusPortableHole", ThaumcraftApi.addInfusionCraftingRecipe("FOCUSPORTABLEHOLE", new ItemStack(ConfigItems.itemFocusPortableHole), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("FocusWarding", ThaumcraftApi.addInfusionCraftingRecipe("FOCUSWARDING", new ItemStack(ConfigItems.itemFocusWarding), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandPed", ThaumcraftApi.addInfusionCraftingRecipe("WANDPED", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 5), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("WandPedFocus", ThaumcraftApi.addInfusionCraftingRecipe("WANDPEDFOC", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 8), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("NodeStabilizerAdv", ThaumcraftApi.addInfusionCraftingRecipe("NODESTABILIZERADV", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 10), 10, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("JarBrain", ThaumcraftApi.addInfusionCraftingRecipe("JARBRAIN", new ItemStack(ConfigBlocks.blockJar, 1, 1), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("AdvancedGolem", ThaumcraftApi.addInfusionCraftingRecipe("ADVANCEDGOLEM", new Object[]{"advanced", new NBTTagByte((byte)1)}, 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("HoverHarness", ThaumcraftApi.addInfusionCraftingRecipe("HOVERHARNESS", new ItemStack(ConfigItems.itemHoverHarness), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("HoverGirdle", ThaumcraftApi.addInfusionCraftingRecipe("HOVERGIRDLE", new ItemStack(ConfigItems.itemGirdleHover), 8, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("VisAmulet", ThaumcraftApi.addInfusionCraftingRecipe("VISAMULET", new ItemStack(ConfigItems.itemAmuletVis, 1, 1), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RunicAmulet", ThaumcraftApi.addInfusionCraftingRecipe("RUNICARMOR", new ItemStack(ConfigItems.itemAmuletRunic, 1, 0), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RunicAmuletEmergency", ThaumcraftApi.addInfusionCraftingRecipe("RUNICEMERGENCY", new ItemStack(ConfigItems.itemAmuletRunic, 1, 1), 7, (new AspectList()).addAll(
              Aspects.ARMOR, 20).addAll(Aspects.MAGIC, 35).addAll(
      ...
      ConfigResearch.recipes.put("RunicRing", ThaumcraftApi.addInfusionCraftingRecipe("RUNICARMOR", new ItemStack(ConfigItems.itemRingRunic, 1, 1), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RunicRingCharged", ThaumcraftApi.addInfusionCraftingRecipe("RUNICCHARGED", new ItemStack(ConfigItems.itemRingRunic, 1, 2), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RunicRingHealing", ThaumcraftApi.addInfusionCraftingRecipe("RUNICHEALING", new ItemStack(ConfigItems.itemRingRunic, 1, 3), 6, (new AspectList()).addAll(
              Aspects.ARMOR, 16).addAll(Aspects.MAGIC, 16).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdle", ThaumcraftApi.addInfusionCraftingRecipe("RUNICARMOR", new ItemStack(ConfigItems.itemGirdleRunic, 1, 0), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdleKinetic", ThaumcraftApi.addInfusionCraftingRecipe("RUNICKINETIC", new ItemStack(ConfigItems.itemGirdleRunic, 1, 1), 7, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdleKinetic_2", ThaumcraftApi.addInfusionCraftingRecipe("RUNICKINETIC", new ItemStack(ConfigItems.itemGirdleRunic, 1, 1), 7, (new AspectList()).addAll(
              Aspects.ARMOR, 33).addAll(Aspects.MAGIC, 55).addAll(
      ...
      if (Config.allowMirrors) {
         ConfigResearch.recipes.put("Mirror", ThaumcraftApi.addInfusionCraftingRecipe("MIRROR", new ItemStack(ConfigBlocks.blockMirror, 1, 0), 1, (new AspectList()).addAll(
         ...
         ConfigResearch.recipes.put("MirrorHand", ThaumcraftApi.addInfusionCraftingRecipe("MIRRORHAND", new ItemStack(ConfigItems.itemHandMirror), 5, (new AspectList()).addAll(
         ...
         ConfigResearch.recipes.put("MirrorEssentia", ThaumcraftApi.addInfusionCraftingRecipe("MIRRORESSENTIA", new ItemStack(ConfigBlocks.blockMirror, 1, 6), 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalAxe", ThaumcraftApi.addInfusionCraftingRecipe("ELEMENTALAXE", new ItemStack(ConfigItems.itemAxeElemental), 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalPick", ThaumcraftApi.addInfusionCraftingRecipe("ELEMENTALPICK", new ItemStack(ConfigItems.itemPickElemental), 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalSword", ThaumcraftApi.addInfusionCraftingRecipe("ELEMENTALSWORD", new ItemStack(ConfigItems.itemSwordElemental), 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalShovel", ThaumcraftApi.addInfusionCraftingRecipe("ELEMENTALSHOVEL", new ItemStack(ConfigItems.itemShovelElemental), 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalHoe", ThaumcraftApi.addInfusionCraftingRecipe("ELEMENTALHOE", new ItemStack(ConfigItems.itemHoeElemental), 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("BootsTraveller", ThaumcraftApi.addInfusionCraftingRecipe("BOOTSTRAVELLER", new ItemStack(ConfigItems.itemBootsTraveller), 1, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("CoreAlchemy", ThaumcraftApi.addInfusionCraftingRecipe("COREALCHEMY", new ItemStack(ConfigItems.itemGolemCore, 1, 6), 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("CoreSorting", ThaumcraftApi.addInfusionCraftingRecipe("CORESORTING", new ItemStack(ConfigItems.itemGolemCore, 1, 10), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("CoreLumber", ThaumcraftApi.addInfusionCraftingRecipe("CORELUMBER", new ItemStack(ConfigItems.itemGolemCore, 1, 7), 2, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("CoreFishing", ThaumcraftApi.addInfusionCraftingRecipe("COREFISHING", new ItemStack(ConfigItems.itemGolemCore, 1, 11), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("CoreUse", ThaumcraftApi.addInfusionCraftingRecipe("COREUSE", new ItemStack(ConfigItems.itemGolemCore, 1, 8), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneBore", ThaumcraftApi.addInfusionCraftingRecipe("ARCANEBORE", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 5), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("TravelTrunk", ThaumcraftApi.addInfusionCraftingRecipe("TRAVELTRUNK", new ItemStack(ConfigItems.itemTrunkSpawner), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("LampGrowth", ThaumcraftApi.addInfusionCraftingRecipe("LAMPGROWTH", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 8), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("LampFertility", ThaumcraftApi.addInfusionCraftingRecipe("LAMPFERTILITY", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 13), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ThaumiumFortressHelm", ThaumcraftApi.addInfusionCraftingRecipe("ARMORFORTRESS", new ItemStack(ConfigItems.itemHelmetFortress), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ThaumiumFortressChest", ThaumcraftApi.addInfusionCraftingRecipe("ARMORFORTRESS", new ItemStack(ConfigItems.itemChestFortress), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("ThaumiumFortressLegs", ThaumcraftApi.addInfusionCraftingRecipe("ARMORFORTRESS", new ItemStack(ConfigItems.itemLegsFortress), 3, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("VoidRobeHelm", ThaumcraftApi.addInfusionCraftingRecipe("ARMORVOIDFORTRESS", new ItemStack(ConfigItems.itemHelmetVoidRobe), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("VoidRobeChest", ThaumcraftApi.addInfusionCraftingRecipe("ARMORVOIDFORTRESS", new ItemStack(ConfigItems.itemChestVoidRobe), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("VoidRobeLegs", ThaumcraftApi.addInfusionCraftingRecipe("ARMORVOIDFORTRESS", new ItemStack(ConfigItems.itemLegsVoidRobe), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("HelmGoggles", ThaumcraftApi.addInfusionCraftingRecipe("HELMGOGGLES", new Object[]{"goggles", new NBTTagByte((byte)1)}, 5, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("MaskGrinningDevil", ThaumcraftApi.addInfusionCraftingRecipe("MASKGRINNINGDEVIL", new Object[]{"mask", new NBTTagInt(0)}, 8, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("MaskAngryGhost", ThaumcraftApi.addInfusionCraftingRecipe("MASKANGRYGHOST", new Object[]{"mask", new NBTTagInt(1)}, 8, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("MaskSippingFiend", ThaumcraftApi.addInfusionCraftingRecipe("MASKSIPPINGFIEND", new Object[]{"mask", new NBTTagInt(2)}, 8, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("SanityCheck", ThaumcraftApi.addInfusionCraftingRecipe("SANITYCHECK", new ItemStack(ConfigItems.itemSanityChecker), 4, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("EssentiaReservoir", ThaumcraftApi.addInfusionCraftingRecipe("ESSENTIARESERVOIR", new ItemStack(ConfigBlocks.blockEssentiaReservoir), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("SinStone", ThaumcraftApi.addInfusionCraftingRecipe("SINSTONE", new ItemStack(ConfigItems.itemCompassStone), 5, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("PrimalCrusher", ThaumcraftApi.addInfusionCraftingRecipe("PRIMALCRUSHER", new ItemStack(ConfigItems.itemPrimalCrusher), 6, (new AspectList()).addAll(
      ...
      ConfigResearch.recipes.put("EldritchEye", ThaumcraftApi.addInfusionCraftingRecipe("OCULUS", new ItemStack(ThaumcraftItems.ELDRITCH_EYE), 5, (new AspectList()).addAll(
   ...
   private static void initializeSmelting() {
      ...
      ThaumcraftApi.addSmeltingBonus(new ItemStack(Items.fish, 1, 32767), new ItemStack(ConfigItems.itemNuggetFish));
   }
