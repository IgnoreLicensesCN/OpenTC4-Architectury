...
public class ConfigRecipes {
   ...
   private static void initializeAlchemyRecipes() {
      ...
      ConfigResearch.recipes.put("Alumentum", CrucibleRecipe.registerCrucibleRecipe("ALUMENTUM", new ItemStack(ThaumcraftItems.ALUMENTUM), new ItemStack(Items.coal, 1, 32767), (new AspectList<>()).mergeWithHighest(
              Aspects.ENERGY, 3).mergeWithHighest(Aspects.FIRE, 3).mergeWithHighest(Aspects.ENTROPY, 3)));
      ConfigResearch.recipes.put("Nitor", CrucibleRecipe.registerCrucibleRecipe("NITOR", new ItemStack(ThaumcraftItems.NITOR), "dustGlowstone", (new AspectList<>()).mergeWithHighest(
              Aspects.ENERGY, 3).mergeWithHighest(Aspects.FIRE, 3).mergeWithHighest(Aspects.LIGHT, 3)));
      ConfigResearch.recipes.put("Thaumium", CrucibleRecipe.registerCrucibleRecipe("THAUMIUM", new ItemStack(ThaumcraftItems.THAUMIUM_INGOT), new ItemStack(Items.iron_ingot), (new AspectList<>()).mergeWithHighest(
              Aspects.MAGIC, 4)));
      ConfigResearch.recipes.put("VoidMetal", CrucibleRecipe.registerCrucibleRecipe("VOIDMETAL", new ItemStack(ThaumcraftItems.VOID_INGOT,1), new ItemStack(ThaumcraftItems.VOID_SEED, 1), (new AspectList<>()).mergeWithHighest(
              Aspects.METAL, 8)));
      ConfigResearch.recipes.put("VoidSeed", CrucibleRecipe.registerCrucibleRecipe("VOIDMETAL", new ItemStack(ThaumcraftItems.VOID_SEED, 1), new ItemStack(Items.wheat_seeds), (new AspectList<>()).mergeWithHighest(
              Aspects.DARKNESS, 8).mergeWithHighest(Aspects.VOID, 8).mergeWithHighest(Aspects.ELDRITCH, 2)));
      ConfigResearch.recipes.put("Tallow", CrucibleRecipe.registerCrucibleRecipe("TALLOW", new ItemStack(ThaumcraftItems.MAGIC_TALLOW), new ItemStack(Items.rotten_flesh), (new AspectList<>()).mergeWithHighest(
              Aspects.MAGIC, 2)));
      ConfigResearch.recipes.put("AltGunpowder", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.gunpowder, 2, 0), new ItemStack(Items.gunpowder), (new AspectList<>()).mergeWithHighest(
              Aspects.FIRE, 4).mergeWithHighest(Aspects.ENTROPY, 4)));
      ConfigResearch.recipes.put("AltSlime", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.slime_ball, 2, 0), new ItemStack(Items.slime_ball), (new AspectList<>()).mergeWithHighest(
              Aspects.WATER, 2).mergeWithHighest(Aspects.LIFE, 2)));
      ConfigResearch.recipes.put("AltClay", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.clay_ball, 2, 0), new ItemStack(Items.clay_ball), (new AspectList<>()).mergeWithHighest(
              Aspects.WATER, 1).mergeWithHighest(Aspects.EARTH, 2)));
      ConfigResearch.recipes.put("AltGlowstone", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.glowstone_dust, 2, 0), "dustGlowstone", (new AspectList<>()).mergeWithHighest(
              Aspects.LIGHT, 3).mergeWithHighest(Aspects.SENSES, 1)));
      ConfigResearch.recipes.put("AltInk", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.dye, 2, 0), new ItemStack(Items.dye, 1, 0), (new AspectList<>()).mergeWithHighest(
              Aspects.WATER, 2).mergeWithHighest(Aspects.SENSES, 2)));
      ConfigResearch.recipes.put("AltWeb", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.web), new ItemStack(Items.string), (new AspectList<>()).mergeWithHighest(
              Aspects.TRAP, 2).mergeWithHighest(Aspects.CLOTH, 2)));
      ConfigResearch.recipes.put("AltMossyCobble", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.mossy_cobblestone), new ItemStack(Blocks.cobblestone), (new AspectList<>()).mergeWithHighest(
              Aspects.PLANT, 2).mergeWithHighest(
              Aspects.MAGIC, 1)));
      ConfigResearch.recipes.put("AltIce", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.ice), new ItemStack(Blocks.snow), (new AspectList<>()).mergeWithHighest(
              Aspects.ORDER, 1).mergeWithHighest(Aspects.COLD, 1)));
      ConfigResearch.recipes.put("AltCrackedBrick", CrucibleRecipe.registerCrucibleRecipe("ENTROPICPROCESSING", new ItemStack(Blocks.stonebrick, 1, 2), new ItemStack(Blocks.stonebrick), (new AspectList<>()).mergeWithHighest(
              Aspects.ENTROPY, 2)));
      ConfigResearch.recipes.put("AltBonemeal", CrucibleRecipe.registerCrucibleRecipe("ENTROPICPROCESSING", new ItemStack(Items.dye, 4, 15), new ItemStack(Items.bone), (new AspectList<>()).mergeWithHighest(
              Aspects.ENTROPY, 1)));
      ConfigResearch.recipes.put("PureIron", CrucibleRecipe.registerCrucibleRecipe("PUREIRON", new ItemStack(ConfigItems.itemNugget, 1, 16), "oreIron", (new AspectList<>()).mergeWithHighest(
              Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      ConfigResearch.recipes.put("PureGold", CrucibleRecipe.registerCrucibleRecipe("PUREGOLD", new ItemStack(ConfigItems.itemNugget, 1, 31), "oreGold", (new AspectList<>()).mergeWithHighest(
              Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("PureCopper", CrucibleRecipe.registerCrucibleRecipe("PURECOPPER", new ItemStack(ConfigItems.itemNugget, 1, 17), "oreCopper", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundTinIngot) {
         ConfigResearch.recipes.put("PureTin", CrucibleRecipe.registerCrucibleRecipe("PURETIN", new ItemStack(ConfigItems.itemNugget, 1, 18), "oreTin", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("PureSilver", CrucibleRecipe.registerCrucibleRecipe("PURESILVER", new ItemStack(ConfigItems.itemNugget, 1, 19), "oreSilver", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundLeadIngot) {
         ConfigResearch.recipes.put("PureLead", CrucibleRecipe.registerCrucibleRecipe("PURELEAD", new ItemStack(ConfigItems.itemNugget, 1, 20), "oreLead", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      ConfigResearch.recipes.put("TransIron", CrucibleRecipe.registerCrucibleRecipe("TRANSIRON", new ItemStack(ConfigItems.itemNugget, 3, 0), "nuggetIron", (new AspectList<>()).mergeWithHighest(
              Aspects.METAL, 2)));
      ConfigResearch.recipes.put("TransGold", CrucibleRecipe.registerCrucibleRecipe("TRANSGOLD", new ItemStack(Items.gold_nugget, 3, 0), new ItemStack(Items.gold_nugget), (new AspectList<>()).mergeWithHighest(
              Aspects.METAL, 2).mergeWithHighest(Aspects.GREED, 1)));
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("TransCopper", CrucibleRecipe.registerCrucibleRecipe("TRANSCOPPER", new ItemStack(ConfigItems.itemNugget, 3, 1), "nuggetCopper", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.EXCHANGE, 1)));
      }

      if (Config.foundTinIngot) {
         ConfigResearch.recipes.put("TransTin", CrucibleRecipe.registerCrucibleRecipe("TRANSTIN", new ItemStack(ConfigItems.itemNugget, 3, 2), "nuggetTin", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.CRYSTAL, 1)));
      }

      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("TransSilver", CrucibleRecipe.registerCrucibleRecipe("TRANSSILVER", new ItemStack(ConfigItems.itemNugget, 3, 3), "nuggetSilver", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.GREED, 1)));
      }

      if (Config.foundLeadIngot) {
         ConfigResearch.recipes.put("TransLead", CrucibleRecipe.registerCrucibleRecipe("TRANSLEAD", new ItemStack(ConfigItems.itemNugget, 3, 4), "nuggetLead", (new AspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.ORDER, 1)));
      }

      ConfigResearch.recipes.put("EtherealBloom", CrucibleRecipe.registerCrucibleRecipe("ETHEREALBLOOM", new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4), new ItemStack(ConfigBlocks.blockCustomPlant, 1, 2), (new AspectList<>()).addAll(
              Aspects.MAGIC, 16).addAll(Aspects.PLANT, 16).addAll(Aspects.HEAL, 16).addAll(Aspects.TAINT, 8)));
      ConfigResearch.recipes.put("LiquidDeath", CrucibleRecipe.registerCrucibleRecipe("LIQUIDDEATH", new ItemStack(ConfigItems.itemBucketDeath), new ItemStack(Items.bucket), (new AspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("BottleTaint", CrucibleRecipe.registerCrucibleRecipe("BOTTLETAINT", new ItemStack(ConfigItems.itemBottleTaint), bt, (new AspectList<>()).addAll(
              Aspects.TAINT, 8).addAll(
              Aspects.MAGIC, 8)));
      ConfigResearch.recipes.put("GolemStraw", CrucibleRecipe.registerCrucibleRecipe("GOLEMSTRAW", new ItemStack(ConfigItems.itemGolemPlacer, 1, 0), new ItemStack(Blocks.hay_block), (new AspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemWood", CrucibleRecipe.registerCrucibleRecipe("GOLEMWOOD", new ItemStack(ConfigItems.itemGolemPlacer, 1, 1), new ItemStack(ConfigBlocks.blockMagicalLog, 1, 0), (new AspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemTallow", CrucibleRecipe.registerCrucibleRecipe("GOLEMTALLOW", new ItemStack(ConfigItems.itemGolemPlacer, 1, 2), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 5), (new AspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("GolemClay", CrucibleRecipe.registerCrucibleRecipe("GOLEMCLAY", new ItemStack(ConfigItems.itemGolemPlacer, 1, 3), new ItemStack(Blocks.brick_block), (new AspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemFlesh", CrucibleRecipe.registerCrucibleRecipe("GOLEMFLESH", new ItemStack(ConfigItems.itemGolemPlacer, 1, 4), new ItemStack(ConfigBlocks.blockTaint, 1, 2), (new AspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("GolemStone", CrucibleRecipe.registerCrucibleRecipe("GOLEMSTONE", new ItemStack(ConfigItems.itemGolemPlacer, 1, 5), new ItemStack(Blocks.stonebrick), (new AspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemIron", CrucibleRecipe.registerCrucibleRecipe("GOLEMIRON", new ItemStack(ConfigItems.itemGolemPlacer, 1, 6), new ItemStack(Blocks.iron_block), (new AspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemThaumium", CrucibleRecipe.registerCrucibleRecipe("GOLEMTHAUMIUM", new ItemStack(ConfigItems.itemGolemPlacer, 1, 7), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 4), (new AspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("CoreGather", CrucibleRecipe.registerCrucibleRecipe("COREGATHER", new ItemStack(ConfigItems.itemGolemCore, 1, 2), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList<>()).addAll(
              Aspects.GREED, 5).addAll(
              Aspects.EARTH, 5)));
      ConfigResearch.recipes.put("CoreFill", CrucibleRecipe.registerCrucibleRecipe("COREFILL", new ItemStack(ConfigItems.itemGolemCore, 1, 0), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList<>()).addAll(
              Aspects.HUNGER, 5).addAll(
              Aspects.VOID, 5)));
      ConfigResearch.recipes.put("CoreEmpty", CrucibleRecipe.registerCrucibleRecipe("COREEMPTY", new ItemStack(ConfigItems.itemGolemCore, 1, 1), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList<>()).addAll(
              Aspects.GREED, 5).addAll(
              Aspects.VOID, 5)));
      ConfigResearch.recipes.put("CoreHarvest", CrucibleRecipe.registerCrucibleRecipe("COREHARVEST", new ItemStack(ConfigItems.itemGolemCore, 1, 3), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList<>()).addAll(
              Aspects.HARVEST, 5).addAll(Aspects.CROP, 5)));
      ConfigResearch.recipes.put("CoreGuard", CrucibleRecipe.registerCrucibleRecipe("COREGUARD", new ItemStack(ConfigItems.itemGolemCore, 1, 4), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList<>()).addAll(
              Aspects.WEAPON, 5).addAll(Aspects.TRAP, 5)));
      ConfigResearch.recipes.put("CoreButcher", CrucibleRecipe.registerCrucibleRecipe("COREBUTCHER", new ItemStack(ConfigItems.itemGolemCore, 1, 9), new ItemStack(ConfigItems.itemGolemCore, 1, 4), (new AspectList<>()).addAll(
              Aspects.FLESH, 5).addAll(Aspects.BEAST, 5)));
      ConfigResearch.recipes.put("CoreLiquid", CrucibleRecipe.registerCrucibleRecipe("CORELIQUID", new ItemStack(ConfigItems.itemGolemCore, 1, 5), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new AspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.VOID, 5)));
      ConfigResearch.recipes.put("BathSalts", CrucibleRecipe.registerCrucibleRecipe("BATHSALTS", new ItemStack(ConfigItems.itemBathSalts), new ItemStack(ThaumcraftItems.SALIS_MUNDUS, 1), (new AspectList<>()).addAll(
              Aspects.MIND, 6).addAll(Aspects.AURA, 6).addAll(
              Aspects.ORDER, 6).addAll(Aspects.HEAL, 6)));
      ConfigResearch.recipes.put("SaneSoap", CrucibleRecipe.registerCrucibleRecipe("SANESOAP", new ItemStack(ConfigItems.itemSanitySoap), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 5), (new AspectList<>()).addAll(
