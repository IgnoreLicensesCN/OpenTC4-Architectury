...
public class ConfigRecipes {
   ...
   private static void initializeCompoundRecipes() {
      ...
      ConfigResearch.recipes.put("Thaumonomicon", Arrays.asList(new LinkedTreeAspectList<>(), 1, 2, 1, Arrays.asList(basicWand, new ItemStack(Blocks.bookshelf))));
      WandTriggerRegistry.registerWandBlockTrigger(Thaumcraft.proxy.wandManager, 0, Blocks.bookshelf, 0, "Thaumcraft");
      ConfigResearch.recipes.put("ArcTable", Arrays.asList(new LinkedTreeAspectList<>(), 1, 2, 1, Arrays.asList(basicWand, new ItemStack(ConfigBlocks.blockTable))));
      ConfigResearch.recipes.put("ResTable", Arrays.asList(new LinkedTreeAspectList<>(), 1, 2, 2, Arrays.asList(null, new ItemStack(ConfigItems.itemInkwell), new ItemStack(ConfigBlocks.blockTable), new ItemStack(ConfigBlocks.blockTable))));
      ConfigResearch.recipes.put("Crucible", Arrays.asList(new LinkedTreeAspectList<>(), 1, 2, 1, Arrays.asList(basicWand, new ItemStack(Items.cauldron))));
      WandTriggerRegistry.registerWandBlockTrigger(Thaumcraft.proxy.wandManager, 1, Blocks.cauldron, -1, "Thaumcraft");
      ConfigResearch.recipes.put("InfernalFurnace", Arrays.asList((new LinkedTreeAspectList<>()).addAll(Aspects.FIRE, 50).addAll(
      ...
      ConfigResearch.recipes.put("InfusionAltar", Arrays.asList((new LinkedTreeAspectList<>()).addAll(Aspects.FIRE, 25).addAll(
      ...
      ConfigResearch.recipes.put("NodeJar", Arrays.asList((new LinkedTreeAspectList<>()).addAll(Aspects.FIRE, 70).addAll(Aspects.EARTH, 70).addAll(
      ...
      ConfigResearch.recipes.put("Thaumatorium", Arrays.asList((new LinkedTreeAspectList<>()).addAll(Aspects.FIRE, 15).addAll(
      ...
      ConfigResearch.recipes.put("AdvAlchemyFurnace", Arrays.asList((new LinkedTreeAspectList<>()).addAll(Aspects.FIRE, 50).addAll(
   ...
   private static void initializeAlchemyRecipes() {
      ...
      ConfigResearch.recipes.put("Alumentum", CrucibleRecipe.registerCrucibleRecipe("ALUMENTUM", new ItemStack(ThaumcraftItems.ALUMENTUM), new ItemStack(Items.coal, 1, 32767), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.ENERGY, 3).mergeWithHighest(Aspects.FIRE, 3).mergeWithHighest(Aspects.ENTROPY, 3)));
      ConfigResearch.recipes.put("Nitor", CrucibleRecipe.registerCrucibleRecipe("NITOR", new ItemStack(ThaumcraftItems.NITOR), "dustGlowstone", (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.ENERGY, 3).mergeWithHighest(Aspects.FIRE, 3).mergeWithHighest(Aspects.LIGHT, 3)));
      ConfigResearch.recipes.put("Thaumium", CrucibleRecipe.registerCrucibleRecipe("THAUMIUM", new ItemStack(ThaumcraftItems.THAUMIUM_INGOT), new ItemStack(Items.iron_ingot), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.MAGIC, 4)));
      ConfigResearch.recipes.put("VoidMetal", CrucibleRecipe.registerCrucibleRecipe("VOIDMETAL", new ItemStack(ThaumcraftItems.VOID_INGOT,1), new ItemStack(ThaumcraftItems.VOID_SEED, 1), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.METAL, 8)));
      ConfigResearch.recipes.put("VoidSeed", CrucibleRecipe.registerCrucibleRecipe("VOIDMETAL", new ItemStack(ThaumcraftItems.VOID_SEED, 1), new ItemStack(Items.wheat_seeds), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.DARKNESS, 8).mergeWithHighest(Aspects.VOID, 8).mergeWithHighest(Aspects.ELDRITCH, 2)));
      ConfigResearch.recipes.put("Tallow", CrucibleRecipe.registerCrucibleRecipe("TALLOW", new ItemStack(ThaumcraftItems.MAGIC_TALLOW), new ItemStack(Items.rotten_flesh), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.MAGIC, 2)));
      ConfigResearch.recipes.put("AltGunpowder", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.gunpowder, 2, 0), new ItemStack(Items.gunpowder), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.FIRE, 4).mergeWithHighest(Aspects.ENTROPY, 4)));
      ConfigResearch.recipes.put("AltSlime", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.slime_ball, 2, 0), new ItemStack(Items.slime_ball), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.WATER, 2).mergeWithHighest(Aspects.LIFE, 2)));
      ConfigResearch.recipes.put("AltClay", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.clay_ball, 2, 0), new ItemStack(Items.clay_ball), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.WATER, 1).mergeWithHighest(Aspects.EARTH, 2)));
      ConfigResearch.recipes.put("AltGlowstone", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.glowstone_dust, 2, 0), "dustGlowstone", (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.LIGHT, 3).mergeWithHighest(Aspects.SENSES, 1)));
      ConfigResearch.recipes.put("AltInk", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.dye, 2, 0), new ItemStack(Items.dye, 1, 0), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.WATER, 2).mergeWithHighest(Aspects.SENSES, 2)));
      ConfigResearch.recipes.put("AltWeb", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.web), new ItemStack(Items.string), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.TRAP, 2).mergeWithHighest(Aspects.CLOTH, 2)));
      ConfigResearch.recipes.put("AltMossyCobble", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.mossy_cobblestone), new ItemStack(Blocks.cobblestone), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.PLANT, 2).mergeWithHighest(
              Aspects.MAGIC, 1)));
      ConfigResearch.recipes.put("AltIce", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.ice), new ItemStack(Blocks.snow), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.ORDER, 1).mergeWithHighest(Aspects.COLD, 1)));
      ConfigResearch.recipes.put("AltCrackedBrick", CrucibleRecipe.registerCrucibleRecipe("ENTROPICPROCESSING", new ItemStack(Blocks.stonebrick, 1, 2), new ItemStack(Blocks.stonebrick), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.ENTROPY, 2)));
      ConfigResearch.recipes.put("AltBonemeal", CrucibleRecipe.registerCrucibleRecipe("ENTROPICPROCESSING", new ItemStack(Items.dye, 4, 15), new ItemStack(Items.bone), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.ENTROPY, 1)));
      ConfigResearch.recipes.put("PureIron", CrucibleRecipe.registerCrucibleRecipe("PUREIRON", new ItemStack(ConfigItems.itemNugget, 1, 16), "oreIron", (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      ConfigResearch.recipes.put("PureGold", CrucibleRecipe.registerCrucibleRecipe("PUREGOLD", new ItemStack(ConfigItems.itemNugget, 1, 31), "oreGold", (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("PureCopper", CrucibleRecipe.registerCrucibleRecipe("PURECOPPER", new ItemStack(ConfigItems.itemNugget, 1, 17), "oreCopper", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundTinIngot) {
         ConfigResearch.recipes.put("PureTin", CrucibleRecipe.registerCrucibleRecipe("PURETIN", new ItemStack(ConfigItems.itemNugget, 1, 18), "oreTin", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("PureSilver", CrucibleRecipe.registerCrucibleRecipe("PURESILVER", new ItemStack(ConfigItems.itemNugget, 1, 19), "oreSilver", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundLeadIngot) {
         ConfigResearch.recipes.put("PureLead", CrucibleRecipe.registerCrucibleRecipe("PURELEAD", new ItemStack(ConfigItems.itemNugget, 1, 20), "oreLead", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      ConfigResearch.recipes.put("TransIron", CrucibleRecipe.registerCrucibleRecipe("TRANSIRON", new ItemStack(ConfigItems.itemNugget, 3, 0), "nuggetIron", (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.METAL, 2)));
      ConfigResearch.recipes.put("TransGold", CrucibleRecipe.registerCrucibleRecipe("TRANSGOLD", new ItemStack(Items.gold_nugget, 3, 0), new ItemStack(Items.gold_nugget), (new LinkedTreeAspectList<>()).mergeWithHighest(
              Aspects.METAL, 2).mergeWithHighest(Aspects.GREED, 1)));
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("TransCopper", CrucibleRecipe.registerCrucibleRecipe("TRANSCOPPER", new ItemStack(ConfigItems.itemNugget, 3, 1), "nuggetCopper", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.EXCHANGE, 1)));
      }

      if (Config.foundTinIngot) {
         ConfigResearch.recipes.put("TransTin", CrucibleRecipe.registerCrucibleRecipe("TRANSTIN", new ItemStack(ConfigItems.itemNugget, 3, 2), "nuggetTin", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.CRYSTAL, 1)));
      }

      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("TransSilver", CrucibleRecipe.registerCrucibleRecipe("TRANSSILVER", new ItemStack(ConfigItems.itemNugget, 3, 3), "nuggetSilver", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.GREED, 1)));
      }

      if (Config.foundLeadIngot) {
         ConfigResearch.recipes.put("TransLead", CrucibleRecipe.registerCrucibleRecipe("TRANSLEAD", new ItemStack(ConfigItems.itemNugget, 3, 4), "nuggetLead", (new LinkedTreeAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.ORDER, 1)));
      }

      ConfigResearch.recipes.put("EtherealBloom", CrucibleRecipe.registerCrucibleRecipe("ETHEREALBLOOM", new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4), new ItemStack(ConfigBlocks.blockCustomPlant, 1, 2), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAGIC, 16).addAll(Aspects.PLANT, 16).addAll(Aspects.HEAL, 16).addAll(Aspects.TAINT, 8)));
      ConfigResearch.recipes.put("LiquidDeath", CrucibleRecipe.registerCrucibleRecipe("LIQUIDDEATH", new ItemStack(ConfigItems.itemBucketDeath), new ItemStack(Items.bucket), (new LinkedTreeAspectList<>()).addAll(
      ...
      ((IEssentiaContainerItem) bt.getItem()).setAspects(bt, (new LinkedTreeAspectList<>()).addAll(Aspects.TAINT, 8));
      ConfigResearch.recipes.put("BottleTaint", CrucibleRecipe.registerCrucibleRecipe("BOTTLETAINT", new ItemStack(ConfigItems.itemBottleTaint), bt, (new LinkedTreeAspectList<>()).addAll(
              Aspects.TAINT, 8).addAll(
              Aspects.MAGIC, 8)));
      ConfigResearch.recipes.put("GolemStraw", CrucibleRecipe.registerCrucibleRecipe("GOLEMSTRAW", new ItemStack(ConfigItems.itemGolemPlacer, 1, 0), new ItemStack(Blocks.hay_block), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemWood", CrucibleRecipe.registerCrucibleRecipe("GOLEMWOOD", new ItemStack(ConfigItems.itemGolemPlacer, 1, 1), new ItemStack(ConfigBlocks.blockMagicalLog, 1, 0), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemTallow", CrucibleRecipe.registerCrucibleRecipe("GOLEMTALLOW", new ItemStack(ConfigItems.itemGolemPlacer, 1, 2), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 5), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("GolemClay", CrucibleRecipe.registerCrucibleRecipe("GOLEMCLAY", new ItemStack(ConfigItems.itemGolemPlacer, 1, 3), new ItemStack(Blocks.brick_block), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemFlesh", CrucibleRecipe.registerCrucibleRecipe("GOLEMFLESH", new ItemStack(ConfigItems.itemGolemPlacer, 1, 4), new ItemStack(ConfigBlocks.blockTaint, 1, 2), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("GolemStone", CrucibleRecipe.registerCrucibleRecipe("GOLEMSTONE", new ItemStack(ConfigItems.itemGolemPlacer, 1, 5), new ItemStack(Blocks.stonebrick), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemIron", CrucibleRecipe.registerCrucibleRecipe("GOLEMIRON", new ItemStack(ConfigItems.itemGolemPlacer, 1, 6), new ItemStack(Blocks.iron_block), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemThaumium", CrucibleRecipe.registerCrucibleRecipe("GOLEMTHAUMIUM", new ItemStack(ConfigItems.itemGolemPlacer, 1, 7), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 4), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("CoreGather", CrucibleRecipe.registerCrucibleRecipe("COREGATHER", new ItemStack(ConfigItems.itemGolemCore, 1, 2), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.GREED, 5).addAll(
              Aspects.EARTH, 5)));
      ConfigResearch.recipes.put("CoreFill", CrucibleRecipe.registerCrucibleRecipe("COREFILL", new ItemStack(ConfigItems.itemGolemCore, 1, 0), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.HUNGER, 5).addAll(
              Aspects.VOID, 5)));
      ConfigResearch.recipes.put("CoreEmpty", CrucibleRecipe.registerCrucibleRecipe("COREEMPTY", new ItemStack(ConfigItems.itemGolemCore, 1, 1), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.GREED, 5).addAll(
              Aspects.VOID, 5)));
      ConfigResearch.recipes.put("CoreHarvest", CrucibleRecipe.registerCrucibleRecipe("COREHARVEST", new ItemStack(ConfigItems.itemGolemCore, 1, 3), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.HARVEST, 5).addAll(Aspects.CROP, 5)));
      ConfigResearch.recipes.put("CoreGuard", CrucibleRecipe.registerCrucibleRecipe("COREGUARD", new ItemStack(ConfigItems.itemGolemCore, 1, 4), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WEAPON, 5).addAll(Aspects.TRAP, 5)));
      ConfigResearch.recipes.put("CoreButcher", CrucibleRecipe.registerCrucibleRecipe("COREBUTCHER", new ItemStack(ConfigItems.itemGolemCore, 1, 9), new ItemStack(ConfigItems.itemGolemCore, 1, 4), (new LinkedTreeAspectList<>()).addAll(
              Aspects.FLESH, 5).addAll(Aspects.BEAST, 5)));
      ConfigResearch.recipes.put("CoreLiquid", CrucibleRecipe.registerCrucibleRecipe("CORELIQUID", new ItemStack(ConfigItems.itemGolemCore, 1, 5), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.VOID, 5)));
      ConfigResearch.recipes.put("BathSalts", CrucibleRecipe.registerCrucibleRecipe("BATHSALTS", new ItemStack(ConfigItems.itemBathSalts), new ItemStack(ThaumcraftItems.SALIS_MUNDUS, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.MIND, 6).addAll(Aspects.AURA, 6).addAll(
              Aspects.ORDER, 6).addAll(Aspects.HEAL, 6)));
      ConfigResearch.recipes.put("SaneSoap", CrucibleRecipe.registerCrucibleRecipe("SANESOAP", new ItemStack(ConfigItems.itemSanitySoap), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 5), (new LinkedTreeAspectList<>()).addAll(
   ...
   private static void initializeArcaneRecipes() {
      for(int a = 0; a < 16; ++a) {
         ...
         ConfigResearch.recipes.put("Banner_" + a, IArcaneRecipe.addArcaneCraftingRecipe("BANNERS", banner, (new LinkedTreeAspectList<>()).addAll(
                 Aspects.WATER, 5).addAll(Aspects.EARTH, 5), "WS", "WS", "WB", 'W', new ItemStack(Blocks.wool, 1, a), 'S', "stickWood", 'B', "slabWood"));
      }

      ConfigResearch.recipes.put("PrimalCharm", IArcaneRecipe.addArcaneCraftingRecipe("BASICARTIFACE", new ItemStack(ThaumcraftItems.PRIMAL_CHARM, 1), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneDoor", IArcaneRecipe.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigItems.itemArcaneDoor), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WardedGlass", IArcaneRecipe.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigBlocks.blockCosmeticOpaque, 8, 2), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("IronKey", IArcaneRecipe.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigItems.itemKey, 2, 0), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.ORDER, 5), "NNI", "N  ", 'I', Items.iron_ingot, 'N', "nuggetIron"));
      ConfigResearch.recipes.put("FluxScrubber", IArcaneRecipe.addArcaneCraftingRecipe("FLUXSCRUB", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 14), (new LinkedTreeAspectList<>()).addAll(
      ...
      if (Config.wardedStone) {
         ConfigResearch.recipes.put("GoldKey", IArcaneRecipe.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigItems.itemKey, 2, 1), (new LinkedTreeAspectList<>()).addAll(
                 Aspects.WATER, 5).addAll(Aspects.ORDER, 5), "NNI", "N  ", 'I', Items.gold_ingot, 'N', Items.gold_nugget));
         ConfigResearch.recipes.put("ArcanePressurePlate", IArcaneRecipe.addArcaneCraftingRecipe("WARDEDARCANA", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 2), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("NodeStabilizerBlock", IArcaneRecipe.addArcaneCraftingRecipe("NODESTABILIZER", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 9), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("NodeTransducer", IArcaneRecipe.addArcaneCraftingRecipe("VISPOWER", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 11), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("NodeRelay", IArcaneRecipe.addArcaneCraftingRecipe("VISPOWER", new ItemStack(ConfigBlocks.blockMetalDevice, 2, 14), (new LinkedTreeAspectList<>()).addAll(
              Aspects.FIRE, 8).addAll(Aspects.ORDER, 8), " I ", "ISI", " I ", 'I', new ItemStack(Items.iron_ingot), 'S', new ItemStack(ConfigItems.itemShard, 1, 6)));
      ConfigResearch.recipes.put("NodeChargeRelay", IArcaneRecipe.addArcaneCraftingRecipe("VISCHARGERELAY", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 2), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocalManipulator", IArcaneRecipe.addArcaneCraftingRecipe("FOCALMANIPULATION", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 13), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("GolemFetter", IArcaneRecipe.addArcaneCraftingRecipe("GOLEMFETTER", new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 9), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneStone1", IArcaneRecipe.addArcaneCraftingRecipe("ARCANESTONE", new ItemStack(ConfigBlocks.blockCosmeticSolid, 9, 6), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("PaveTravel", IArcaneRecipe.addArcaneCraftingRecipe("PAVETRAVEL", new ItemStack(ConfigBlocks.blockCosmeticSolid, 4, 2), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneLamp", IArcaneRecipe.addArcaneCraftingRecipe("ARCANELAMP", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 7), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneSpa", IArcaneRecipe.addArcaneCraftingRecipe("ARCANESPA", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 12), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("PaveWard", IArcaneRecipe.addArcaneCraftingRecipe("PAVEWARD", new ItemStack(ConfigBlocks.blockCosmeticSolid, 4, 3), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Levitator", IArcaneRecipe.addArcaneCraftingRecipe("LEVITATOR", new ItemStack(ConfigBlocks.blockLifter), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneEar", IArcaneRecipe.addArcaneCraftingRecipe("ARCANEEAR", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 1), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MirrorGlass", IArcaneRecipe.addShapelessArcaneCraftingRecipe("BASICARTIFACE", new ItemStack(ThaumcraftItems.MIRRORED_GLASS, 1), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("BoneBow",
              IArcaneRecipe.addArcaneCraftingRecipe(
                      "BONEBOW",
                      new ItemStack(ConfigItems.itemBowBone), (new LinkedTreeAspectList<>()).addAll(Aspects.AIR, 16).addAll(Aspects.ENTROPY, 32), "SB ", "SEB", "SB ", 'E', new ItemStack(ConfigItems.itemShard, 1, 5), 'B', Items.bone, 'S', Items.string));
      Aspect[] pa = new Aspect[]{Aspects.AIR, Aspects.FIRE, Aspects.WATER, Aspects.EARTH, Aspects.ORDER, Aspects.ENTROPY};

      for(int a = 0; a < 6; ++a) {
         ConfigResearch.recipes.put("PrimalArrow_" + a, IArcaneRecipe.addArcaneCraftingRecipe("PRIMALARROW", new ItemStack(ConfigItems.itemPrimalArrow, 8, a), (new LinkedTreeAspectList<>()).addAll(pa[a], 8), "AAA", "ASA", "AAA", 'A', Items.arrow, 'S', new ItemStack(ConfigItems.itemShard, 1, a)));
      }

      ConfigResearch.recipes.put("InfusionMatrix", IArcaneRecipe.addArcaneCraftingRecipe("INFUSION", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 2), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcanePedestal", IArcaneRecipe.addArcaneCraftingRecipe("INFUSION", new ItemStack(ConfigBlocks.blockStoneDevice, 2, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 5), "SSS", " S ", "SSS", 'S', new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 6)));
      ConfigResearch.recipes.put("WardedJar", IArcaneRecipe.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockJar, 1, 0), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 1), "GWG", "G G", "GGG", 'W', "slabWood", 'G', Blocks.glass_pane));
      ConfigResearch.recipes.put("JarVoid", IArcaneRecipe.addArcaneCraftingRecipe("JARVOID", new ItemStack(ConfigBlocks.blockJar, 1, 3), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapGold", IArcaneRecipe.addArcaneCraftingRecipe("CAP_gold", new ItemStack(ConfigItems.itemWandCap, 1, 1), (new LinkedTreeAspectList<>()).addAll(
      ...
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("WandCapCopper", IArcaneRecipe.addArcaneCraftingRecipe("CAP_copper", new ItemStack(ConfigItems.itemWandCap, 1, 3), (new LinkedTreeAspectList<>()).addAll(
      ...
      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("WandCapSilverInert", IArcaneRecipe.addArcaneCraftingRecipe("CAP_silver", new ItemStack(ConfigItems.itemWandCap, 1, 5), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapThaumiumInert", IArcaneRecipe.addArcaneCraftingRecipe("CAP_thaumium", new ItemStack(ConfigItems.itemWandCap, 1, 6), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapVoidInert", IArcaneRecipe.addArcaneCraftingRecipe("CAP_void", new ItemStack(ConfigItems.itemWandCap, 1, 8), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodGreatwood", IArcaneRecipe.addArcaneCraftingRecipe("ROD_greatwood", new ItemStack(ConfigItems.itemWandRod, 1, 0), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ENTROPY, WandRod.rods.get("greatwood").getCraftCost()), " G", "G ", 'G', new ItemStack(ConfigBlocks.blockMagicalLog, 1, 0)));
      ConfigResearch.recipes.put("WandRodGreatwoodStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_greatwood_staff", new ItemStack(ConfigItems.itemWandRod, 1, 50), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodObsidianStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_obsidian_staff", new ItemStack(ConfigItems.itemWandRod, 1, 51), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodSilverwoodStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_silverwood_staff", new ItemStack(ConfigItems.itemWandRod, 1, 52), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodIceStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_ice_staff", new ItemStack(ConfigItems.itemWandRod, 1, 53), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodQuartzStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_quartz_staff", new ItemStack(ConfigItems.itemWandRod, 1, 54), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodReedStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_reed_staff", new ItemStack(ConfigItems.itemWandRod, 1, 55), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBlazeStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_blaze_staff", new ItemStack(ConfigItems.itemWandRod, 1, 56), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBoneStaff", IArcaneRecipe.addArcaneCraftingRecipe("ROD_bone_staff", new ItemStack(ConfigItems.itemWandRod, 1, 57), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusFire", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSFIRE", new ItemStack(ConfigItems.itemFocusFire), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusFrost", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSFROST", new ItemStack(ConfigItems.itemFocusFrost), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusShock", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSSHOCK", new ItemStack(ConfigItems.itemFocusShock), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusTrade", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSTRADE", new ItemStack(ConfigItems.itemFocusTrade), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusExcavation", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSEXCAVATION", new ItemStack(ConfigItems.itemFocusExcavation), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusPrimal", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSPRIMAL", new ItemStack(ConfigItems.itemFocusPrimal), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusPouch", IArcaneRecipe.addArcaneCraftingRecipe("FOCUSPOUCH", new ItemStack(ConfigItems.itemFocusPouch), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Deconstructor", IArcaneRecipe.addArcaneCraftingRecipe("DECONSTRUCTOR", new ItemStack(ConfigBlocks.blockTable, 1, 14), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneBoreBase", IArcaneRecipe.addArcaneCraftingRecipe("ARCANEBORE", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 4), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("EnchantedFabric", IArcaneRecipe.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RobeChest", IArcaneRecipe.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ConfigItems.itemChestRobe, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 5), "I I", "III", "III", 'I', new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC)));
      ConfigResearch.recipes.put("RobeLegs", IArcaneRecipe.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ConfigItems.itemLegsRobe, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5), "III", "I I", "I I", 'I', new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC)));
      ConfigResearch.recipes.put("RobeBoots", IArcaneRecipe.addArcaneCraftingRecipe("ENCHFABRIC", new ItemStack(ConfigItems.itemBootsRobe, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.EARTH, 3), "I I", "I I", 'I', new ItemStack(ThaumcraftItems.ENCHANTED_FABRIC)));
      GameRegistry.addRecipe(new RecipesRobeArmorDyes());
      ConfigResearch.recipes.put("Goggles", IArcaneRecipe.addArcaneCraftingRecipe("GOGGLES", new ItemStack(ConfigItems.itemGoggles), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("HungryChest", IArcaneRecipe.addArcaneCraftingRecipe("HUNGRYCHEST", new ItemStack(ConfigBlocks.blockChestHungry), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 5).addAll(Aspects.ORDER, 3).addAll(Aspects.ENTROPY, 3), "WTW", "W W", "WWW", 'W', "plankWood", 'T', Blocks.trapdoor));
      ConfigResearch.recipes.put("GolemBell", IArcaneRecipe.addArcaneCraftingRecipe("GOLEMBELL", new ItemStack(ConfigItems.itemGolemBell), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ORDER, 5), " QQ", " QQ", "S  ", 'S', "stickWood", 'Q', Items.quartz));
      ConfigResearch.recipes.put("CoreBlank", IArcaneRecipe.addArcaneCraftingRecipe("COREGATHER", new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ORDER, 5).addAll(Aspects.FIRE, 5), " C ", "CNC", " C ", 'C', Items.brick, 'N', new ItemStack(ThaumcraftItems.NITOR)));
      ConfigResearch.recipes.put("UpgradeAir", IArcaneRecipe.addArcaneCraftingRecipe("UPGRADEAIR", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 0), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 0)));
      ConfigResearch.recipes.put("UpgradeEarth", IArcaneRecipe.addArcaneCraftingRecipe("UPGRADEEARTH", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.EARTH, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 3)));
      ConfigResearch.recipes.put("UpgradeFire", IArcaneRecipe.addArcaneCraftingRecipe("UPGRADEFIRE", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 2), (new LinkedTreeAspectList<>()).addAll(
              Aspects.FIRE, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 1)));
      ConfigResearch.recipes.put("UpgradeWater", IArcaneRecipe.addArcaneCraftingRecipe("UPGRADEWATER", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 3), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 2)));
      ConfigResearch.recipes.put("UpgradeOrder", IArcaneRecipe.addArcaneCraftingRecipe("UPGRADEORDER", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 4), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ORDER, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 4)));
      ConfigResearch.recipes.put("UpgradeEntropy", IArcaneRecipe.addArcaneCraftingRecipe("UPGRADEENTROPY", new ItemStack(ConfigItems.itemGolemUpgrade, 1, 5), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ENTROPY, 10), "NNN", "NCN", "NNN", 'N', Items.gold_nugget, 'C', new ItemStack(ConfigItems.itemShard, 1, 5)));
      ConfigResearch.recipes.put("TinyHat", IArcaneRecipe.addArcaneCraftingRecipe("TINYHAT", new ItemStack(ConfigItems.itemGolemDecoration, 1, 0), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ORDER, 8).addAll(Aspects.FIRE, 8), " C ", " G ", "CCC", 'C', new ItemStack(Blocks.wool, 1, 15), 'G', Items.gold_ingot));
      ConfigResearch.recipes.put("TinyFez", IArcaneRecipe.addArcaneCraftingRecipe("TINYFEZ", new ItemStack(ConfigItems.itemGolemDecoration, 1, 3), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 4).addAll(Aspects.EARTH, 4), "CCS", "CCS", "  S", 'C', new ItemStack(Blocks.wool, 1, 14), 'S', Items.string));
      ConfigResearch.recipes.put("TinyBowtie", IArcaneRecipe.addArcaneCraftingRecipe("TINYBOWTIE", new ItemStack(ConfigItems.itemGolemDecoration, 1, 2), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 4).addAll(Aspects.ORDER, 4), "CSC", "C C", 'C', new ItemStack(Blocks.wool, 1, 15), 'S', Items.string));
      ConfigResearch.recipes.put("TinyGlasses", IArcaneRecipe.addArcaneCraftingRecipe("TINYGLASSES", new ItemStack(ConfigItems.itemGolemDecoration, 1, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 4).addAll(Aspects.WATER, 4), "GIG", 'G', Blocks.glass, 'I', Items.iron_ingot));
      ConfigResearch.recipes.put("TinyDart", IArcaneRecipe.addArcaneCraftingRecipe("TINYDART", new ItemStack(ConfigItems.itemGolemDecoration, 1, 4), (new LinkedTreeAspectList<>()).addAll(
              Aspects.AIR, 4).addAll(Aspects.FIRE, 4), "AIA", "ADA", "AIA", 'I', Items.iron_ingot, 'D', Blocks.dispenser, 'A', Items.arrow));
      ConfigResearch.recipes.put("TinyVisor", IArcaneRecipe.addArcaneCraftingRecipe("TINYVISOR", new ItemStack(ConfigItems.itemGolemDecoration, 1, 5), (new LinkedTreeAspectList<>()).addAll(
              Aspects.EARTH, 4).addAll(Aspects.WATER, 4), "IHI", 'I', Items.iron_ingot, 'H', new ItemStack(Items.iron_helmet, 1, 32767)));
      ConfigResearch.recipes.put("TinyArmor", IArcaneRecipe.addArcaneCraftingRecipe("TINYARMOR", new ItemStack(ConfigItems.itemGolemDecoration, 1, 6), (new LinkedTreeAspectList<>()).addAll(
              Aspects.EARTH, 8), "I I", "IAI", 'I', Items.iron_ingot, 'A', new ItemStack(Items.iron_chestplate, 1, 32767)));
      ConfigResearch.recipes.put("TinyHammer", IArcaneRecipe.addArcaneCraftingRecipe("TINYHAMMER", new ItemStack(ConfigItems.itemGolemDecoration, 1, 7), (new LinkedTreeAspectList<>()).addAll(
              Aspects.EARTH, 4).addAll(Aspects.FIRE, 4), "III", "III", " I ", 'I', Items.iron_ingot));
      ConfigResearch.recipes.put("Filter", IArcaneRecipe.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ThaumcraftItems.VIS_FILTER, 2), (new LinkedTreeAspectList<>()).addAll(
              Aspects.ORDER, 5).addAll(Aspects.WATER, 5), "GWG", 'G', Items.gold_ingot, 'W', new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 7)));
      ConfigResearch.recipes.put("AlchemyFurnace", IArcaneRecipe.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 0), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Alembic", IArcaneRecipe.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 1), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Bellows", IArcaneRecipe.addArcaneCraftingRecipe("BELLOWS", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 0), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Tube", IArcaneRecipe.addArcaneCraftingRecipe("TUBES", new ItemStack(ConfigBlocks.blockTube, 8, 0), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Resonator", IArcaneRecipe.addArcaneCraftingRecipe("TUBES", new ItemStack(ConfigItems.itemResonator), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.AIR, 5), "I I", "INI", " S ", 'I', Items.iron_ingot, 'N', Items.quartz, 'S', "stickWood"));
      ConfigResearch.recipes.put("TubeValve", IArcaneRecipe.addShapelessArcaneCraftingRecipe("TUBES", new ItemStack(ConfigBlocks.blockTube, 1, 1), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.ORDER, 5), new ItemStack(ConfigBlocks.blockTube, 1, 0), new ItemStack(Blocks.lever)));
      ConfigResearch.recipes.put("TubeFilter", IArcaneRecipe.addShapelessArcaneCraftingRecipe("TUBEFILTER", new ItemStack(ConfigBlocks.blockTube, 1, 3), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("TubeRestrict", IArcaneRecipe.addShapelessArcaneCraftingRecipe("TUBEFILTER", new ItemStack(ConfigBlocks.blockTube, 1, 5), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.EARTH, 16), new ItemStack(ConfigBlocks.blockTube, 1, 0), "stone"));
      ConfigResearch.recipes.put("TubeOneway", IArcaneRecipe.addShapelessArcaneCraftingRecipe("TUBEFILTER", new ItemStack(ConfigBlocks.blockTube, 1, 6), (new LinkedTreeAspectList<>()).addAll(
              Aspects.WATER, 5).addAll(Aspects.ORDER, 8).addAll(Aspects.ENTROPY, 8), new ItemStack(ConfigBlocks.blockTube, 1, 0), "dyeBlue"));
      ConfigResearch.recipes.put("TubeBuffer", IArcaneRecipe.addArcaneCraftingRecipe("CENTRIFUGE", new ItemStack(ConfigBlocks.blockTube, 1, 4), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("AlchemicalConstruct", IArcaneRecipe.addArcaneCraftingRecipe("DISTILESSENTIA", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 9), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("AdvAlchemyConstruct", IArcaneRecipe.addArcaneCraftingRecipe("ADVALCHEMYFURNACE", new ItemStack(ConfigBlocks.blockMetalDevice, 4, 3), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("Centrifuge", IArcaneRecipe.addArcaneCraftingRecipe("CENTRIFUGE", new ItemStack(ConfigBlocks.blockTube, 1, 2), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("EssentiaCrystalizer", IArcaneRecipe.addArcaneCraftingRecipe("ESSENTIACRYSTAL", new ItemStack(ConfigBlocks.blockTube, 1, 7), (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MnemonicMatrix", IArcaneRecipe.addArcaneCraftingRecipe("THAUMATORIUM", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 12), (new LinkedTreeAspectList<>()).addAll(
   ...
   private static void initializeInfusionEnchantmentRecipes() {
      ConfigResearch.recipes.put("InfEnchRepair", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.enchantmentsList[ThaumcraftApi.enchantRepair], 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnchHaste", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.enchantmentsList[ThaumcraftApi.enchantHaste], 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch0", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.protection, 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch1", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.fireProtection, 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch2", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.blastProtection, 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch3", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.projectileProtection, 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch4", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.featherFalling, 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch5", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.respiration, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch6", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.aquaAffinity, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch7", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.thorns, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch8", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.sharpness, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch9", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.smite, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch10", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.baneOfArthropods, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch11", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.knockback, 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch12", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.fireAspect, 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch13", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.looting, 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch14", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.efficiency, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch15", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.silkTouch, 5, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch16", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.unbreaking, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch17", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.fortune, 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch18", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.power, 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch19", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.punch, 2, (new LinkedTreeAspectList<>()).addAll(
              Aspects.MAGIC, 4).addAll(Aspects.WEAPON, 3).addAll(Aspects.MOTION, 3), new ItemStack[]{new ItemStack(Blocks.piston), new ItemStack(ThaumcraftItems.SALIS_MUNDUS, 1)}));
      ConfigResearch.recipes.put("InfEnch20", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.flame, 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("InfEnch21", InfusionRecipe.addInfusionEnchantmentRecipe("INFUSIONENCHANTMENT", Enchantment.infinity, 5, (new LinkedTreeAspectList<>()).addAll(
   ...
   private static void initializeInfusionRecipes() {
      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("WandCapSilver", InfusionRecipe.addInfusionCraftingRecipe("CAP_silver", new ItemStack(ConfigItems.itemWandCap, 1, 4), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapThaumium", InfusionRecipe.addInfusionCraftingRecipe("CAP_thaumium", new ItemStack(ConfigItems.itemWandCap, 1, 2), 5, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandCapVoid", InfusionRecipe.addInfusionCraftingRecipe("CAP_void", new ItemStack(ConfigItems.itemWandCap, 1, 7), 8, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodObsidian", InfusionRecipe.addInfusionCraftingRecipe("ROD_obsidian", new ItemStack(ConfigItems.itemWandRod, 1, 1), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodIce", InfusionRecipe.addInfusionCraftingRecipe("ROD_ice", new ItemStack(ConfigItems.itemWandRod, 1, 3), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodQuartz", InfusionRecipe.addInfusionCraftingRecipe("ROD_quartz", new ItemStack(ConfigItems.itemWandRod, 1, 4), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodReed", InfusionRecipe.addInfusionCraftingRecipe("ROD_reed", new ItemStack(ConfigItems.itemWandRod, 1, 5), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBlaze", InfusionRecipe.addInfusionCraftingRecipe("ROD_blaze", new ItemStack(ConfigItems.itemWandRod, 1, 6), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBone", InfusionRecipe.addInfusionCraftingRecipe("ROD_bone", new ItemStack(ConfigItems.itemWandRod, 1, 7), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodSilverwood", InfusionRecipe.addInfusionCraftingRecipe("ROD_silverwood", new ItemStack(ConfigItems.itemWandRod, 1, 2), 5, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodPrimalStaff", InfusionRecipe.addInfusionCraftingRecipe("ROD_primal_staff", new ItemStack(ConfigItems.itemWandRod, 1, 100), 8, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusHellbat", InfusionRecipe.addInfusionCraftingRecipe("FOCUSHELLBAT", new ItemStack(ConfigItems.itemFocusHellbat), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusPortableHole", InfusionRecipe.addInfusionCraftingRecipe("FOCUSPORTABLEHOLE", new ItemStack(ConfigItems.itemFocusPortableHole), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusWarding", InfusionRecipe.addInfusionCraftingRecipe("FOCUSWARDING", new ItemStack(ConfigItems.itemFocusWarding), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandPed", InfusionRecipe.addInfusionCraftingRecipe("WANDPED", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 5), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandPedFocus", InfusionRecipe.addInfusionCraftingRecipe("WANDPEDFOC", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 8), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("NodeStabilizerAdv", InfusionRecipe.addInfusionCraftingRecipe("NODESTABILIZERADV", new ItemStack(ConfigBlocks.blockStoneDevice, 1, 10), 10, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("JarBrain", InfusionRecipe.addInfusionCraftingRecipe("JARBRAIN", new ItemStack(ConfigBlocks.blockJar, 1, 1), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("AdvancedGolem", InfusionRecipe.addInfusionCraftingRecipe("ADVANCEDGOLEM", new Object[]{"advanced", new NBTTagByte((byte)1)}, 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("HoverHarness", InfusionRecipe.addInfusionCraftingRecipe("HOVERHARNESS", new ItemStack(ConfigItems.itemHoverHarness), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("HoverGirdle", InfusionRecipe.addInfusionCraftingRecipe("HOVERGIRDLE", new ItemStack(ConfigItems.itemGirdleHover), 8, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("VisAmulet", InfusionRecipe.addInfusionCraftingRecipe("VISAMULET", new ItemStack(ConfigItems.itemAmuletVis, 1, 1), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicAmulet", InfusionRecipe.addInfusionCraftingRecipe("RUNICARMOR", new ItemStack(ConfigItems.itemAmuletRunic, 1, 0), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicAmuletEmergency", InfusionRecipe.addInfusionCraftingRecipe("RUNICEMERGENCY", new ItemStack(ConfigItems.itemAmuletRunic, 1, 1), 7, (new LinkedTreeAspectList<>()).addAll(
              Aspects.ARMOR, 20).addAll(Aspects.MAGIC, 35).addAll(
      ...
      ConfigResearch.recipes.put("RunicRing", InfusionRecipe.addInfusionCraftingRecipe("RUNICARMOR", new ItemStack(ConfigItems.itemRingRunic, 1, 1), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicRingCharged", InfusionRecipe.addInfusionCraftingRecipe("RUNICCHARGED", new ItemStack(ConfigItems.itemRingRunic, 1, 2), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicRingHealing", InfusionRecipe.addInfusionCraftingRecipe("RUNICHEALING", new ItemStack(ConfigItems.itemRingRunic, 1, 3), 6, (new LinkedTreeAspectList<>()).addAll(
              Aspects.ARMOR, 16).addAll(Aspects.MAGIC, 16).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdle", InfusionRecipe.addInfusionCraftingRecipe("RUNICARMOR", new ItemStack(ConfigItems.itemGirdleRunic, 1, 0), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdleKinetic", InfusionRecipe.addInfusionCraftingRecipe("RUNICKINETIC", new ItemStack(ConfigItems.itemGirdleRunic, 1, 1), 7, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdleKinetic_2", InfusionRecipe.addInfusionCraftingRecipe("RUNICKINETIC", new ItemStack(ConfigItems.itemGirdleRunic, 1, 1), 7, (new LinkedTreeAspectList<>()).addAll(
              Aspects.ARMOR, 33).addAll(Aspects.MAGIC, 55).addAll(
      ...
      if (Config.allowMirrors) {
         ConfigResearch.recipes.put("Mirror", InfusionRecipe.addInfusionCraftingRecipe("MIRROR", new ItemStack(ConfigBlocks.blockMirror, 1, 0), 1, (new LinkedTreeAspectList<>()).addAll(
         ...
         ConfigResearch.recipes.put("MirrorHand", InfusionRecipe.addInfusionCraftingRecipe("MIRRORHAND", new ItemStack(ConfigItems.itemHandMirror), 5, (new LinkedTreeAspectList<>()).addAll(
         ...
         ConfigResearch.recipes.put("MirrorEssentia", InfusionRecipe.addInfusionCraftingRecipe("MIRRORESSENTIA", new ItemStack(ConfigBlocks.blockMirror, 1, 6), 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalAxe", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALAXE", new ItemStack(ConfigItems.itemAxeElemental), 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalPick", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALPICK", new ItemStack(ConfigItems.itemPickElemental), 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalSword", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALSWORD", new ItemStack(ConfigItems.itemSwordElemental), 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalShovel", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALSHOVEL", new ItemStack(ConfigItems.itemShovelElemental), 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalHoe", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALHOE", new ItemStack(ConfigItems.itemHoeElemental), 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("BootsTraveller", InfusionRecipe.addInfusionCraftingRecipe("BOOTSTRAVELLER", new ItemStack(ConfigItems.itemBootsTraveller), 1, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreAlchemy", InfusionRecipe.addInfusionCraftingRecipe("COREALCHEMY", new ItemStack(ConfigItems.itemGolemCore, 1, 6), 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreSorting", InfusionRecipe.addInfusionCraftingRecipe("CORESORTING", new ItemStack(ConfigItems.itemGolemCore, 1, 10), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreLumber", InfusionRecipe.addInfusionCraftingRecipe("CORELUMBER", new ItemStack(ConfigItems.itemGolemCore, 1, 7), 2, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreFishing", InfusionRecipe.addInfusionCraftingRecipe("COREFISHING", new ItemStack(ConfigItems.itemGolemCore, 1, 11), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreUse", InfusionRecipe.addInfusionCraftingRecipe("COREUSE", new ItemStack(ConfigItems.itemGolemCore, 1, 8), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneBore", InfusionRecipe.addInfusionCraftingRecipe("ARCANEBORE", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 5), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("TravelTrunk", InfusionRecipe.addInfusionCraftingRecipe("TRAVELTRUNK", new ItemStack(ConfigItems.itemTrunkSpawner), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("LampGrowth", InfusionRecipe.addInfusionCraftingRecipe("LAMPGROWTH", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 8), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("LampFertility", InfusionRecipe.addInfusionCraftingRecipe("LAMPFERTILITY", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 13), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ThaumiumFortressHelm", InfusionRecipe.addInfusionCraftingRecipe("ARMORFORTRESS", new ItemStack(ConfigItems.itemHelmetFortress), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ThaumiumFortressChest", InfusionRecipe.addInfusionCraftingRecipe("ARMORFORTRESS", new ItemStack(ConfigItems.itemChestFortress), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ThaumiumFortressLegs", InfusionRecipe.addInfusionCraftingRecipe("ARMORFORTRESS", new ItemStack(ConfigItems.itemLegsFortress), 3, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("VoidRobeHelm", InfusionRecipe.addInfusionCraftingRecipe("ARMORVOIDFORTRESS", new ItemStack(ConfigItems.itemHelmetVoidRobe), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("VoidRobeChest", InfusionRecipe.addInfusionCraftingRecipe("ARMORVOIDFORTRESS", new ItemStack(ConfigItems.itemChestVoidRobe), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("VoidRobeLegs", InfusionRecipe.addInfusionCraftingRecipe("ARMORVOIDFORTRESS", new ItemStack(ConfigItems.itemLegsVoidRobe), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("HelmGoggles", InfusionRecipe.addInfusionCraftingRecipe("HELMGOGGLES", new Object[]{"goggles", new NBTTagByte((byte)1)}, 5, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MaskGrinningDevil", InfusionRecipe.addInfusionCraftingRecipe("MASKGRINNINGDEVIL", new Object[]{"mask", new NBTTagInt(0)}, 8, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MaskAngryGhost", InfusionRecipe.addInfusionCraftingRecipe("MASKANGRYGHOST", new Object[]{"mask", new NBTTagInt(1)}, 8, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MaskSippingFiend", InfusionRecipe.addInfusionCraftingRecipe("MASKSIPPINGFIEND", new Object[]{"mask", new NBTTagInt(2)}, 8, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("SanityCheck", InfusionRecipe.addInfusionCraftingRecipe("SANITYCHECK", new ItemStack(ConfigItems.itemSanityChecker), 4, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("EssentiaReservoir", InfusionRecipe.addInfusionCraftingRecipe("ESSENTIARESERVOIR", new ItemStack(ConfigBlocks.blockEssentiaReservoir), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("SinStone", InfusionRecipe.addInfusionCraftingRecipe("SINSTONE", new ItemStack(ConfigItems.itemCompassStone), 5, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("PrimalCrusher", InfusionRecipe.addInfusionCraftingRecipe("PRIMALCRUSHER", new ItemStack(ConfigItems.itemPrimalCrusher), 6, (new LinkedTreeAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("EldritchEye", InfusionRecipe.addInfusionCraftingRecipe("OCULUS", new ItemStack(ThaumcraftItems.ELDRITCH_EYE), 5, (new LinkedTreeAspectList<>()).addAll(
   ...
   private static void initializeNormalRecipes() {
      ...
      for(Aspect aspect : Aspects.ALL_ASPECTS.values()) {
         ...
         ((IEssentiaContainerItem) essence.getItem()).setAspects(essence, (new LinkedTreeAspectList<>()).addAll(aspect, 8));
         ItemStack output = new ItemStack(ThaumcraftItems.JAR_LABEL, 1);
         ((IEssentiaContainerItem) output.getItem()).setAspects(output, (new LinkedTreeAspectList<>()).addAll(aspect, 0));
      ...
      ((IEssentiaContainerItem) input.getItem()).setAspects(input, (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 1));
