...
public class ConfigRecipes {
   ...
   private static void initializeCompoundRecipes() {
      ...
      ConfigResearch.recipes.put("Thaumonomicon", Arrays.asList(new LinkedHashAspectList<>(), 1, 2, 1, Arrays.asList(basicWand, new ItemStack(Blocks.bookshelf))));
      WandTriggerRegistry.registerWandBlockTrigger(Thaumcraft.proxy.wandManager, 0, Blocks.bookshelf, 0, "Thaumcraft");
      ConfigResearch.recipes.put("ArcTable", Arrays.asList(new LinkedHashAspectList<>(), 1, 2, 1, Arrays.asList(basicWand, new ItemStack(ConfigBlocks.blockTable))));
      ConfigResearch.recipes.put("ResTable", Arrays.asList(new LinkedHashAspectList<>(), 1, 2, 2, Arrays.asList(null, new ItemStack(ConfigItems.itemInkwell), new ItemStack(ConfigBlocks.blockTable), new ItemStack(ConfigBlocks.blockTable))));
      ConfigResearch.recipes.put("Crucible", Arrays.asList(new LinkedHashAspectList<>(), 1, 2, 1, Arrays.asList(basicWand, new ItemStack(Items.cauldron))));
      WandTriggerRegistry.registerWandBlockTrigger(Thaumcraft.proxy.wandManager, 1, Blocks.cauldron, -1, "Thaumcraft");
      ConfigResearch.recipes.put("InfernalFurnace", Arrays.asList((new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 50).addAll(
      ...
      ConfigResearch.recipes.put("InfusionAltar", Arrays.asList((new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 25).addAll(
      ...
      ConfigResearch.recipes.put("NodeJar", Arrays.asList((new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 70).addAll(Aspects.EARTH, 70).addAll(
      ...
      ConfigResearch.recipes.put("Thaumatorium", Arrays.asList((new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 15).addAll(
      ...
      ConfigResearch.recipes.put("AdvAlchemyFurnace", Arrays.asList((new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 50).addAll(
   ...
   private static void initializeAlchemyRecipes() {
      ...
      ConfigResearch.recipes.put("Alumentum", CrucibleRecipe.registerCrucibleRecipe("ALUMENTUM", new ItemStack(ThaumcraftItems.ALUMENTUM), new ItemStack(Items.coal, 1, 32767), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.ENERGY, 3).mergeWithHighest(Aspects.FIRE, 3).mergeWithHighest(Aspects.ENTROPY, 3)));
      ConfigResearch.recipes.put("Nitor", CrucibleRecipe.registerCrucibleRecipe("NITOR", new ItemStack(ThaumcraftItems.NITOR), "dustGlowstone", (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.ENERGY, 3).mergeWithHighest(Aspects.FIRE, 3).mergeWithHighest(Aspects.LIGHT, 3)));
      ConfigResearch.recipes.put("Thaumium", CrucibleRecipe.registerCrucibleRecipe("THAUMIUM", new ItemStack(ThaumcraftItems.THAUMIUM_INGOT), new ItemStack(Items.iron_ingot), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.MAGIC, 4)));
      ConfigResearch.recipes.put("VoidMetal", CrucibleRecipe.registerCrucibleRecipe("VOIDMETAL", new ItemStack(ThaumcraftItems.VOID_INGOT,1), new ItemStack(ThaumcraftItems.VOID_SEED, 1), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.METAL, 8)));
      ConfigResearch.recipes.put("VoidSeed", CrucibleRecipe.registerCrucibleRecipe("VOIDMETAL", new ItemStack(ThaumcraftItems.VOID_SEED, 1), new ItemStack(Items.wheat_seeds), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.DARKNESS, 8).mergeWithHighest(Aspects.VOID, 8).mergeWithHighest(Aspects.ELDRITCH, 2)));
      ConfigResearch.recipes.put("Tallow", CrucibleRecipe.registerCrucibleRecipe("TALLOW", new ItemStack(ThaumcraftItems.MAGIC_TALLOW), new ItemStack(Items.rotten_flesh), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.MAGIC, 2)));
      ...
      ConfigResearch.recipes.put("AltSlime", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.slime_ball, 2, 0), new ItemStack(Items.slime_ball), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.WATER, 2).mergeWithHighest(Aspects.LIFE, 2)));
      ConfigResearch.recipes.put("AltClay", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.clay_ball, 2, 0), new ItemStack(Items.clay_ball), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.WATER, 1).mergeWithHighest(Aspects.EARTH, 2)));
      ConfigResearch.recipes.put("AltGlowstone", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.glowstone_dust, 2, 0), "dustGlowstone", (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.LIGHT, 3).mergeWithHighest(Aspects.SENSES, 1)));
      ConfigResearch.recipes.put("AltInk", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALDUPLICATION", new ItemStack(Items.dye, 2, 0), new ItemStack(Items.dye, 1, 0), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.WATER, 2).mergeWithHighest(Aspects.SENSES, 2)));
      ConfigResearch.recipes.put("AltWeb", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.web), new ItemStack(Items.string), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.TRAP, 2).mergeWithHighest(Aspects.CLOTH, 2)));
      ConfigResearch.recipes.put("AltMossyCobble", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.mossy_cobblestone), new ItemStack(Blocks.cobblestone), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.PLANT, 2).mergeWithHighest(
              Aspects.MAGIC, 1)));
      ConfigResearch.recipes.put("AltIce", CrucibleRecipe.registerCrucibleRecipe("ALCHEMICALMANUFACTURE", new ItemStack(Blocks.ice), new ItemStack(Blocks.snow), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.ORDER, 1).mergeWithHighest(Aspects.COLD, 1)));
      ConfigResearch.recipes.put("AltCrackedBrick", CrucibleRecipe.registerCrucibleRecipe("ENTROPICPROCESSING", new ItemStack(Blocks.stonebrick, 1, 2), new ItemStack(Blocks.stonebrick), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.ENTROPY, 2)));
      ConfigResearch.recipes.put("AltBonemeal", CrucibleRecipe.registerCrucibleRecipe("ENTROPICPROCESSING", new ItemStack(Items.dye, 4, 15), new ItemStack(Items.bone), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.ENTROPY, 1)));
      ConfigResearch.recipes.put("PureIron", CrucibleRecipe.registerCrucibleRecipe("PUREIRON", new ItemStack(ConfigItems.itemNugget, 1, 16), "oreIron", (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      ConfigResearch.recipes.put("PureGold", CrucibleRecipe.registerCrucibleRecipe("PUREGOLD", new ItemStack(ConfigItems.itemNugget, 1, 31), "oreGold", (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("PureCopper", CrucibleRecipe.registerCrucibleRecipe("PURECOPPER", new ItemStack(ConfigItems.itemNugget, 1, 17), "oreCopper", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundTinIngot) {
         ConfigResearch.recipes.put("PureTin", CrucibleRecipe.registerCrucibleRecipe("PURETIN", new ItemStack(ConfigItems.itemNugget, 1, 18), "oreTin", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("PureSilver", CrucibleRecipe.registerCrucibleRecipe("PURESILVER", new ItemStack(ConfigItems.itemNugget, 1, 19), "oreSilver", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      if (Config.foundLeadIngot) {
         ConfigResearch.recipes.put("PureLead", CrucibleRecipe.registerCrucibleRecipe("PURELEAD", new ItemStack(ConfigItems.itemNugget, 1, 20), "oreLead", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 1).mergeWithHighest(Aspects.ORDER, 1)));
      }

      ConfigResearch.recipes.put("TransIron", CrucibleRecipe.registerCrucibleRecipe("TRANSIRON", new ItemStack(ConfigItems.itemNugget, 3, 0), "nuggetIron", (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.METAL, 2)));
      ConfigResearch.recipes.put("TransGold", CrucibleRecipe.registerCrucibleRecipe("TRANSGOLD", new ItemStack(Items.gold_nugget, 3, 0), new ItemStack(Items.gold_nugget), (new LinkedHashAspectList<>()).mergeWithHighest(
              Aspects.METAL, 2).mergeWithHighest(Aspects.GREED, 1)));
      if (Config.foundCopperIngot) {
         ConfigResearch.recipes.put("TransCopper", CrucibleRecipe.registerCrucibleRecipe("TRANSCOPPER", new ItemStack(ConfigItems.itemNugget, 3, 1), "nuggetCopper", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.EXCHANGE, 1)));
      }

      if (Config.foundTinIngot) {
         ConfigResearch.recipes.put("TransTin", CrucibleRecipe.registerCrucibleRecipe("TRANSTIN", new ItemStack(ConfigItems.itemNugget, 3, 2), "nuggetTin", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.CRYSTAL, 1)));
      }

      if (Config.foundSilverIngot) {
         ConfigResearch.recipes.put("TransSilver", CrucibleRecipe.registerCrucibleRecipe("TRANSSILVER", new ItemStack(ConfigItems.itemNugget, 3, 3), "nuggetSilver", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.GREED, 1)));
      }

      if (Config.foundLeadIngot) {
         ConfigResearch.recipes.put("TransLead", CrucibleRecipe.registerCrucibleRecipe("TRANSLEAD", new ItemStack(ConfigItems.itemNugget, 3, 4), "nuggetLead", (new LinkedHashAspectList<>()).mergeWithHighest(
                 Aspects.METAL, 2).mergeWithHighest(Aspects.ORDER, 1)));
      }

      ConfigResearch.recipes.put("EtherealBloom", CrucibleRecipe.registerCrucibleRecipe("ETHEREALBLOOM", new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4), new ItemStack(ConfigBlocks.blockCustomPlant, 1, 2), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAGIC, 16).addAll(Aspects.PLANT, 16).addAll(Aspects.HEAL, 16).addAll(Aspects.TAINT, 8)));
      ConfigResearch.recipes.put("LiquidDeath", CrucibleRecipe.registerCrucibleRecipe("LIQUIDDEATH", new ItemStack(ConfigItems.itemBucketDeath), new ItemStack(Items.bucket), (new LinkedHashAspectList<>()).addAll(
      ...
      ((IEssentiaContainerItem) bt.getItem()).setAspects(bt, (new LinkedHashAspectList<>()).addAll(Aspects.TAINT, 8));
      ConfigResearch.recipes.put("BottleTaint", CrucibleRecipe.registerCrucibleRecipe("BOTTLETAINT", new ItemStack(ConfigItems.itemBottleTaint), bt, (new LinkedHashAspectList<>()).addAll(
              Aspects.TAINT, 8).addAll(
              Aspects.MAGIC, 8)));
      ConfigResearch.recipes.put("GolemStraw", CrucibleRecipe.registerCrucibleRecipe("GOLEMSTRAW", new ItemStack(ConfigItems.itemGolemPlacer, 1, 0), new ItemStack(Blocks.hay_block), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemWood", CrucibleRecipe.registerCrucibleRecipe("GOLEMWOOD", new ItemStack(ConfigItems.itemGolemPlacer, 1, 1), new ItemStack(ConfigBlocks.blockMagicalLog, 1, 0), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemTallow", CrucibleRecipe.registerCrucibleRecipe("GOLEMTALLOW", new ItemStack(ConfigItems.itemGolemPlacer, 1, 2), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 5), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("GolemClay", CrucibleRecipe.registerCrucibleRecipe("GOLEMCLAY", new ItemStack(ConfigItems.itemGolemPlacer, 1, 3), new ItemStack(Blocks.brick_block), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemFlesh", CrucibleRecipe.registerCrucibleRecipe("GOLEMFLESH", new ItemStack(ConfigItems.itemGolemPlacer, 1, 4), new ItemStack(ConfigBlocks.blockTaint, 1, 2), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("GolemStone", CrucibleRecipe.registerCrucibleRecipe("GOLEMSTONE", new ItemStack(ConfigItems.itemGolemPlacer, 1, 5), new ItemStack(Blocks.stonebrick), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemIron", CrucibleRecipe.registerCrucibleRecipe("GOLEMIRON", new ItemStack(ConfigItems.itemGolemPlacer, 1, 6), new ItemStack(Blocks.iron_block), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 4).addAll(
              Aspects.MOTION, 4).addAll(Aspects.SOUL, 4)));
      ConfigResearch.recipes.put("GolemThaumium", CrucibleRecipe.registerCrucibleRecipe("GOLEMTHAUMIUM", new ItemStack(ConfigItems.itemGolemPlacer, 1, 7), new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 4), (new LinkedHashAspectList<>()).addAll(
              Aspects.MAN, 8).addAll(
              Aspects.MOTION, 8).addAll(Aspects.SOUL, 8)));
      ConfigResearch.recipes.put("CoreGather", CrucibleRecipe.registerCrucibleRecipe("COREGATHER", new ItemStack(ConfigItems.itemGolemCore, 1, 2), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedHashAspectList<>()).addAll(
              Aspects.GREED, 5).addAll(
              Aspects.EARTH, 5)));
      ConfigResearch.recipes.put("CoreFill", CrucibleRecipe.registerCrucibleRecipe("COREFILL", new ItemStack(ConfigItems.itemGolemCore, 1, 0), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedHashAspectList<>()).addAll(
              Aspects.HUNGER, 5).addAll(
              Aspects.VOID, 5)));
      ConfigResearch.recipes.put("CoreEmpty", CrucibleRecipe.registerCrucibleRecipe("COREEMPTY", new ItemStack(ConfigItems.itemGolemCore, 1, 1), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedHashAspectList<>()).addAll(
              Aspects.GREED, 5).addAll(
              Aspects.VOID, 5)));
      ConfigResearch.recipes.put("CoreHarvest", CrucibleRecipe.registerCrucibleRecipe("COREHARVEST", new ItemStack(ConfigItems.itemGolemCore, 1, 3), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedHashAspectList<>()).addAll(
              Aspects.HARVEST, 5).addAll(Aspects.CROP, 5)));
      ConfigResearch.recipes.put("CoreGuard", CrucibleRecipe.registerCrucibleRecipe("COREGUARD", new ItemStack(ConfigItems.itemGolemCore, 1, 4), new ItemStack(ConfigItems.itemGolemCore, 1, 100), (new LinkedHashAspectList<>()).addAll(
              Aspects.WEAPON, 5).addAll(Aspects.TRAP, 5)));
      ConfigResearch.recipes.put("CoreButcher", CrucibleRecipe.registerCrucibleRecipe("COREBUTCHER", new ItemStack(ConfigItems.itemGolemCore, 1, 9), new ItemStack(ConfigItems.itemGolemCore, 1, 4), (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("BathSalts", CrucibleRecipe.registerCrucibleRecipe("BATHSALTS", new ItemStack(ConfigItems.itemBathSalts), new ItemStack(ThaumcraftItems.SALIS_MUNDUS, 1), (new LinkedHashAspectList<>()).addAll(
   ...
   private static void initializeInfusionRecipes() {
      ...
      ConfigResearch.recipes.put("WandRodIce", InfusionRecipe.addInfusionCraftingRecipe("ROD_ice", new ItemStack(ConfigItems.itemWandRod, 1, 3), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodQuartz", InfusionRecipe.addInfusionCraftingRecipe("ROD_quartz", new ItemStack(ConfigItems.itemWandRod, 1, 4), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodReed", InfusionRecipe.addInfusionCraftingRecipe("ROD_reed", new ItemStack(ConfigItems.itemWandRod, 1, 5), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBlaze", InfusionRecipe.addInfusionCraftingRecipe("ROD_blaze", new ItemStack(ConfigItems.itemWandRod, 1, 6), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodBone", InfusionRecipe.addInfusionCraftingRecipe("ROD_bone", new ItemStack(ConfigItems.itemWandRod, 1, 7), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodSilverwood", InfusionRecipe.addInfusionCraftingRecipe("ROD_silverwood", new ItemStack(ConfigItems.itemWandRod, 1, 2), 5, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("WandRodPrimalStaff", InfusionRecipe.addInfusionCraftingRecipe("ROD_primal_staff", new ItemStack(ConfigItems.itemWandRod, 1, 100), 8, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("FocusWarding", InfusionRecipe.addInfusionCraftingRecipe("FOCUSWARDING", new ItemStack(ConfigItems.itemFocusWarding), 4, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("HoverHarness", InfusionRecipe.addInfusionCraftingRecipe("HOVERHARNESS", new ItemStack(ConfigItems.itemHoverHarness), 6, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("HoverGirdle", InfusionRecipe.addInfusionCraftingRecipe("HOVERGIRDLE", new ItemStack(ConfigItems.itemGirdleHover), 8, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("RunicRingHealing", InfusionRecipe.addInfusionCraftingRecipe("RUNICHEALING", new ItemStack(ConfigItems.itemRingRunic, 1, 3), 6, (new LinkedHashAspectList<>()).addAll(
              Aspects.ARMOR, 16).addAll(Aspects.MAGIC, 16).addAll(
      ...
      ConfigResearch.recipes.put("RunicGirdleKinetic_2", InfusionRecipe.addInfusionCraftingRecipe("RUNICKINETIC", new ItemStack(ConfigItems.itemGirdleRunic, 1, 1), 7, (new LinkedHashAspectList<>()).addAll(
              Aspects.ARMOR, 33).addAll(Aspects.MAGIC, 55).addAll(
      ...
      ConfigResearch.recipes.put("ElementalPick", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALPICK", new ItemStack(ConfigItems.itemPickElemental), 1, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalSword", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALSWORD", new ItemStack(ConfigItems.itemSwordElemental), 1, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalShovel", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALSHOVEL", new ItemStack(ConfigItems.itemShovelElemental), 1, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ElementalHoe", InfusionRecipe.addInfusionCraftingRecipe("ELEMENTALHOE", new ItemStack(ConfigItems.itemHoeElemental), 1, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreSorting", InfusionRecipe.addInfusionCraftingRecipe("CORESORTING", new ItemStack(ConfigItems.itemGolemCore, 1, 10), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreLumber", InfusionRecipe.addInfusionCraftingRecipe("CORELUMBER", new ItemStack(ConfigItems.itemGolemCore, 1, 7), 2, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreFishing", InfusionRecipe.addInfusionCraftingRecipe("COREFISHING", new ItemStack(ConfigItems.itemGolemCore, 1, 11), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("CoreUse", InfusionRecipe.addInfusionCraftingRecipe("COREUSE", new ItemStack(ConfigItems.itemGolemCore, 1, 8), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("ArcaneBore", InfusionRecipe.addInfusionCraftingRecipe("ARCANEBORE", new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 5), 4, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("TravelTrunk", InfusionRecipe.addInfusionCraftingRecipe("TRAVELTRUNK", new ItemStack(ConfigItems.itemTrunkSpawner), 3, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("LampGrowth", InfusionRecipe.addInfusionCraftingRecipe("LAMPGROWTH", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 8), 4, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("LampFertility", InfusionRecipe.addInfusionCraftingRecipe("LAMPFERTILITY", new ItemStack(ConfigBlocks.blockMetalDevice, 1, 13), 4, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MaskGrinningDevil", InfusionRecipe.addInfusionCraftingRecipe("MASKGRINNINGDEVIL", new Object[]{"mask", new NBTTagInt(0)}, 8, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MaskAngryGhost", InfusionRecipe.addInfusionCraftingRecipe("MASKANGRYGHOST", new Object[]{"mask", new NBTTagInt(1)}, 8, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("MaskSippingFiend", InfusionRecipe.addInfusionCraftingRecipe("MASKSIPPINGFIEND", new Object[]{"mask", new NBTTagInt(2)}, 8, (new LinkedHashAspectList<>()).addAll(
      ...
      ConfigResearch.recipes.put("EldritchEye", InfusionRecipe.addInfusionCraftingRecipe("OCULUS", new ItemStack(ThaumcraftItems.ELDRITCH_EYE), 5, (new LinkedHashAspectList<>()).addAll(
