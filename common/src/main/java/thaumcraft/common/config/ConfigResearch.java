...
public class ConfigResearch {
   ...
   private static void initThaumaturgyResearch() {
      ...
      (new ResearchItem("FOCUSHELLBAT", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.BEAST, 6).addAll(
      ...
      (new ResearchItem("FOCUSEXCAVATION", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.EARTH, 3).addAll(Aspects.ENTROPY, 3).addAll(
      ...
      if (Config.wardedStone) {
         (new ResearchItem("FOCUSWARDING", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.EARTH, 6).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("FOCUSSHOCK", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AIR, 3).addAll(Aspects.ENERGY, 6).addAll(
      ...
      (new ResearchItem("FOCUSTRADE", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.EARTH, 3).addAll(Aspects.EXCHANGE, 6).addAll(
      ...
      (new ResearchItem("FOCUSPORTABLEHOLE", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.ENTROPY, 3).addAll(
      ...
      (new ResearchItem("FOCUSPOUCH", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.VOID, 6).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("CAP_gold", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.GREED, 3).addAll(
      ...
      (new ResearchItem("CAP_thaumium", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 6).addAll(Aspects.MAGIC, 6).addAll(
      ...
      if (Config.foundCopperIngot) {
         (new ResearchItem("CAP_copper", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      if (Config.foundSilverIngot) {
         (new ResearchItem("CAP_silver", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.GREED, 3).addAll(
      ...
      (new ResearchItem("ROD_greatwood", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.TREE, 6).addAll(
      ...
      (new ResearchItem("ROD_reed", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.AIR, 6).addAll(
      ...
      (new ResearchItem("ROD_blaze", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.FIRE, 6).addAll(
      ...
      (new ResearchItem("ROD_obsidian", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EARTH, 6).addAll(
      ...
      (new ResearchItem("ROD_ice", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.COLD, 6).addAll(
      ...
      (new ResearchItem("ROD_quartz", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ORDER, 6).addAll(
      ...
      (new ResearchItem("ROD_bone", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ENTROPY, 6).addAll(
      ...
      (new ResearchItem("ROD_silverwood", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.TREE, 6).addAll(
      ...
      AspectList<Aspect>al1 = new LinkedTreeAspectList<>();
      AspectList<Aspect>al2 = new LinkedTreeAspectList<>();
      AspectList<Aspect>al3 = new LinkedTreeAspectList<>();
      ...
      scer.add(r3);
      (new ResearchItem("SCEPTRE", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.CRAFT, 6).addAll(
      ...
      (new ResearchItem("ROD_greatwood_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.TREE, 6).addAll(
      ...
      (new ResearchItem("ROD_reed_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.AIR, 6).addAll(
              Aspects.PLANT, 3).addAll(
      ...
      (new ResearchItem("ROD_blaze_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.FIRE, 6).addAll(
      ...
      (new ResearchItem("ROD_obsidian_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EARTH, 6).addAll(
      ...
      (new ResearchItem("ROD_ice_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.COLD, 6).addAll(
      ...
      (new ResearchItem("ROD_quartz_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ORDER, 6).addAll(
      ...
      (new ResearchItem("ROD_bone_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ENTROPY, 6).addAll(
              Aspects.UNDEAD, 3).addAll(
      ...
      (new ResearchItem("ROD_silverwood_staff", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 6).addAll(
              Aspects.TREE, 6).addAll(
      ...
      (new ResearchItem("WANDPED", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("VISAMULET", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.MAGIC, 6).addAll(
      ...
      (new ResearchItem("WANDPEDFOC", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.MAGIC, 6).addAll(
      ...
      (new ResearchItem("NODESTABILIZER", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 4).addAll(Aspects.ORDER, 4).addAll(
              Aspects.ENERGY, 4), -7, -4, 1, new ItemStack(ConfigBlocks.blockStoneDevice, 1, 9))).setPages(new ResearchPage("tc.research_page.NODESTABILIZER.1"), new ResearchPage((IArcaneRecipe)recipes.get("NodeStabilizerBlock")), new ResearchPage("tc.research_page.NODESTABILIZER.2")).setParents("NODEPRESERVE").registerResearchItem();
      (new ResearchItem("NODESTABILIZERADV", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 9).addAll(Aspects.MAGIC, 6).addAll(
      ...
      (new ResearchItem("VISPOWER", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.MECHANISM, 3).addAll(
      ...
      (new ResearchItem("VISCHARGERELAY", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.AURA, 3).addAll(
      ...
      (new ResearchItem("FOCALMANIPULATION", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 8).addAll(Aspects.TOOL, 8).addAll(
      ...
      (new ResearchItem("VAMPBAT", "THAUMATURGY", (new LinkedTreeAspectList<>()).addAll(Aspects.HUNGER, 5).addAll(Aspects.LIFE, 5).addAll(
   ...
   private static void initArtificeResearch() {
      (new ResearchItem("BASICARTIFACE", "ARTIFICE", new LinkedTreeAspectList<>(), 0, 1, 0, new ItemStack(ThaumcraftItems.PRIMAL_CHARM, 1))).setPages(new ResearchPage("tc.research_page.BASICARTIFACE.1"), new ResearchPage((IArcaneRecipe)recipes.get("PrimalCharm")), new ResearchPage((IRecipe)recipes.get("MundaneAmulet")), new ResearchPage((IRecipe)recipes.get("MundaneRing")), new ResearchPage((IRecipe)recipes.get("MundaneBelt")), new ResearchPage((IArcaneRecipe)recipes.get("MirrorGlass"))).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("ARCANESTONE", "ARTIFICE", new LinkedTreeAspectList<>(), 5, -2, 0, new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 6))).setPages(new ResearchPage("tc.research_page.ARCANESTONE.1"), new ResearchPage((IArcaneRecipe)recipes.get("ArcaneStone1")), new ResearchPage((IRecipe)recipes.get("ArcaneStone2")), new ResearchPage((IRecipe)recipes.get("ArcaneStone3")), new ResearchPage((IRecipe)recipes.get("ArcaneStone4"))).setStub().setAutoUnlock().setRound().registerResearchItem();
      (new ResearchItem("GRATE", "ARTIFICE", new LinkedTreeAspectList<>(), 2, -1, 0, new ItemStack(ConfigBlocks.blockMetalDevice, 1, 5))).setPages(new ResearchPage("tc.research_page.GRATE.1"), new ResearchPage((IRecipe)recipes.get("Grate"))).setStub().setAutoUnlock().setRound().registerResearchItem();
      (new ResearchItem("TABLE", "ARTIFICE", new LinkedTreeAspectList<>(), 0, -1, 0, new ItemStack(ConfigBlocks.blockTable))).setPages(new ResearchPage("tc.research_page.TABLE.1"), new ResearchPage((IRecipe)recipes.get("Table"))).setStub().setAutoUnlock().setRound().registerResearchItem();
      (new ResearchItem("ARCTABLE", "ARTIFICE", new LinkedTreeAspectList<>(), -1, -3, 0, new ItemStack(ConfigBlocks.blockTable, 1, 15))).setPages(new ResearchPage("tc.research_page.ARCTABLE.1"), new ResearchPage((List)recipes.get("ArcTable"))).setStub().setAutoUnlock().setRound().setParents("TABLE").registerResearchItem();
      (new ResearchItem("RESTABLE", "ARTIFICE", new LinkedTreeAspectList<>(), 1, -3, 0, new ItemStack(ConfigBlocks.blockTable, 1, 1))).setPages(new ResearchPage("tc.research_page.RESTABLE.1"), new ResearchPage((List)recipes.get("ResTable"))).setStub().setAutoUnlock().setRound().setParents("TABLE").registerResearchItem();
      (new ResearchItem("THAUMOMETER", "ARTIFICE", new LinkedTreeAspectList<>(), 2, 1, 0, new ItemStack(ThaumcraftItems.THAUMOMETER))).setStub().setAutoUnlock().setRound().setPages(new ResearchPage("tc.research_page.THAUMOMETER.1"), new ResearchPage((IRecipe)recipes.get("Thaumometer"))).registerResearchItem();
      (new ResearchItem("PAVETRAVEL", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.EARTH, 3).addAll(
      ...
      (new ResearchItem("PAVEWARD", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MOTION, 3).addAll(Aspects.TRAP, 3).addAll(
      ...
      (new ResearchItem("GOGGLES", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.AURA, 3).addAll(
      ...
      (new ResearchItem("ARCANEEAR", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.ENERGY, 3).addAll(
      ...
      (new ResearchItem("SINSTONE", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.DARKNESS, 3).addAll(
      ...
      (new ResearchItem("LEVITATOR", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MOTION, 3).addAll(Aspects.FLIGHT, 3).addAll(
      ...
      (new ResearchItem("INFERNALFURNACE", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.FIRE, 6).addAll(Aspects.METAL, 3).addAll(
      ...
      (new ResearchItem("BELLOWS", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.AIR, 6).addAll(Aspects.MECHANISM, 3).addAll(
      ...
      (new ResearchItem("FLUXSCRUB", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.TRAP, 3).addAll(
      ...
      (new ResearchItem("RUNICARMOR", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.ARMOR, 6).addAll(Aspects.AIR, 3).addAll(
      ...
      (new ResearchItem("RUNICCHARGED", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("RUNICHEALING", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("RUNICKINETIC", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("RUNICEMERGENCY", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("BANNERS", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.CLOTH, 3).addAll(
      ...
      (new ResearchItem("RUNICAUGMENTATION", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("BOOTSTRAVELLER", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.EARTH, 3).addAll(
      ...
      (new ResearchItem("HOVERHARNESS", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.FLIGHT, 6).addAll(Aspects.TRAVEL, 6).addAll(
      ...
      (new ResearchItem("HOVERGIRDLE", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.FLIGHT, 6).addAll(Aspects.TRAVEL, 3).addAll(
      ...
      if (Config.allowMirrors) {
         (new ResearchItem("MIRROR", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TRAVEL, 6).addAll(Aspects.ELDRITCH, 3).addAll(
         ...
         (new ResearchItem("MIRRORHAND", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.ELDRITCH, 3).addAll(
         ...
         (new ResearchItem("MIRRORESSENTIA", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TRAVEL, 6).addAll(Aspects.ELDRITCH, 3).addAll(
      ...
      (new ResearchItem("ARCANEBORE", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MINE, 6).addAll(Aspects.MOTION, 3).addAll(
      ...
      (new ResearchItem("ARCANELAMP", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.LIGHT, 3).addAll(Aspects.SENSES, 3).addAll(
      ...
      (new ResearchItem("LAMPGROWTH", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.LIGHT, 3).addAll(Aspects.PLANT, 6).addAll(
      ...
      (new ResearchItem("LAMPFERTILITY", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.BEAST, 6).addAll(Aspects.LIFE, 6).addAll(
      ...
      (new ResearchItem("PRIMALARROW", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.AIR, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALAXE", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.WATER, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALPICK", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.FIRE, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALSWORD", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.AIR, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALSHOVEL", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EARTH, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALHOE", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.LIFE, 3).addAll(
      ...
      if (Config.wardedStone) {
         (new ResearchItem("WARDEDARCANA", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.MIND, 3).addAll(
      ...
      (new ResearchItem("JARBRAIN", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.HUNGER, 3).addAll(Aspects.MIND, 3).addAll(
      ...
      (new ResearchItem("INFUSIONENCHANTMENT", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 6).addAll(Aspects.MIND, 3).addAll(
              Aspects.WEAPON, 3).addAll(Aspects.ARMOR, 3).addAll(Aspects.TOOL, 3), -6, 11, 3, new ResourceLocation("thaumcraft", "textures/misc/r_enchant.png"))).setPages(new ResearchPage("tc.research_page.INFUSIONENCHANTMENT.1"), new ResearchPage("tc.research_page.INFUSIONENCHANTMENT.2"), new ResearchPage("tc.research_page.INFUSIONENCHANTMENT.3"), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnchRepair")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnchHaste")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch0")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch1")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch2")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch3")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch4")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch5")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch6")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch7")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch8")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch9")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch10")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch11")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch12")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch13")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch14")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch15")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch16")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch17")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch18")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch19")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch20")), new ResearchPage((ThaumcraftInfusionEnchantmentRecipe)recipes.get("InfEnch21"))).setConcealed().setParents("JARBRAIN").registerResearchItem();
      (new ResearchItem("ARMORFORTRESS", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ARMOR, 5).addAll(
      ...
      (new ResearchItem("HELMGOGGLES", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.SENSES, 5).addAll(Aspects.AURA, 3).addAll(
      ...
      (new ResearchItem("MASKGRINNINGDEVIL", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.HEAL, 5).addAll(Aspects.MIND, 5).addAll(
      ...
      (new ResearchItem("MASKANGRYGHOST", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.ENTROPY, 5).addAll(Aspects.DEATH, 5).addAll(
      ...
      (new ResearchItem("MASKSIPPINGFIEND", "ARTIFICE", (new LinkedTreeAspectList<>()).addAll(Aspects.UNDEAD, 5).addAll(Aspects.LIFE, 5).addAll(
   ...
   private static void initAlchemyResearch() {
      (new ResearchItem("PHIAL", "ALCHEMY", new LinkedTreeAspectList<>(), 0, -2, 0, new ItemStack(ConfigItems.itemEssence, 1, 0))).setPages(new ResearchPage("tc.research_page.PHIAL.1"), new ResearchPage((IRecipe)recipes.get("Phial"))).setStub().setRound().setAutoUnlock().registerResearchItem();
      ...
      (new ResearchItem("CRUCIBLE", "ALCHEMY", new LinkedTreeAspectList<>(), 0, 0, 0, new ItemStack(ConfigBlocks.blockMetalDevice, 1, 0))).setPages(new ResearchPage("tc.research_page.CRUCIBLE.1"), new ResearchPage("tc.research_page.CRUCIBLE.2"), new ResearchPage("tc.research_page.CRUCIBLE.3"), new ResearchPage((List)recipes.get("Crucible")), new ResearchPage("tc.research_page.CRUCIBLE.4"), new ResearchPage(cruc.toArray(new CrucibleRecipe[0])), new ResearchPage("tc.research_page.CRUCIBLE.5"), new ResearchPage(new ItemStack(ConfigItems.itemShard, 1, 6))).setStub().setAutoUnlock().registerResearchItem();
      (new ResearchItem("NITOR", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.LIGHT, 3).addAll(Aspects.FIRE, 1), 2, -1, 1, new ItemStack(ThaumcraftItems.NITOR))).setPages(new ResearchPage("tc.research_page.NITOR.1"), new ResearchPage((CrucibleRecipe)recipes.get("Nitor"))).setParents("CRUCIBLE").registerResearchItem();
      (new ResearchItem("ALUMENTUM", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.ENERGY, 3).addAll(Aspects.FIRE, 1), 2, 1, 1, new ItemStack(ThaumcraftItems.ALUMENTUM))).setPages(new ResearchPage("tc.research_page.ALUMENTUM.1"), new ResearchPage((CrucibleRecipe)recipes.get("Alumentum"))).setParents("CRUCIBLE").registerResearchItem();
      (new ResearchItem("ALCHEMICALDUPLICATION", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.GREED, 3).addAll(
      ...
      (new ResearchItem("ALCHEMICALMANUFACTURE", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("ENTROPICPROCESSING", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 1).addAll(Aspects.ENTROPY, 3).addAll(
      ...
      (new ResearchItem("LIQUIDDEATH", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.DEATH, 3).addAll(Aspects.POISON, 3).addAll(
      ...
      (new ResearchItem("BOTTLETAINT", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.TAINT, 5).addAll(Aspects.MAGIC, 3).addAll(
      ...
      if (Config.foundCopperOre && Config.foundCopperIngot) {
         (new ResearchItem("PURECOPPER", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ORDER, 2).addAll(
      ...
      if (Config.foundTinOre && Config.foundTinIngot) {
         (new ResearchItem("PURETIN", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ORDER, 2).addAll(
      ...
      if (Config.foundSilverOre && Config.foundSilverIngot) {
         (new ResearchItem("PURESILVER", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ORDER, 2).addAll(
      ...
      if (Config.foundSilverIngot) {
         (new ResearchItem("TRANSSILVER", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.EXCHANGE, 2).addAll(
      ...
      if (Config.foundLeadIngot) {
         (new ResearchItem("TRANSLEAD", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.EXCHANGE, 2).addAll(
      ...
      (new ResearchItem("BATHSALTS", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 3).addAll(Aspects.AURA, 3).addAll(
      ...
      (new ResearchItem("SANESOAP", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 5).addAll(Aspects.ORDER, 5).addAll(
      ...
      (new ResearchItem("ARCANESPA", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MECHANISM, 3).addAll(
      ...
      (new ResearchItem("DISTILESSENTIA", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.WATER, 3).addAll(
      ...
      (new ResearchItem("TUBES", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("TUBEFILTER", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("ESSENTIACRYSTAL", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 5).addAll(Aspects.CRYSTAL, 5).addAll(
      ...
      (new ResearchItem("CENTRIFUGE", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.ENTROPY, 3).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("THAUMATORIUM", "ALCHEMY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 6).addAll(
   ...
   private static void initGolemancyResearch() {
      ...
      (new ResearchItem("GOLEMSTRAW", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 3).addAll(Aspects.MOTION, 3).addAll(
      ...
      (new ResearchItem("GOLEMWOOD", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 4).addAll(Aspects.MOTION, 4).addAll(
              Aspects.TREE, 3).addAll(
      ...
      (new ResearchItem("GOLEMTALLOW", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 3).addAll(Aspects.MOTION, 3).addAll(
      ...
      (new ResearchItem("GOLEMCLAY", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 6).addAll(Aspects.MOTION, 6).addAll(
      ...
      (new ResearchItem("GOLEMFLESH", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 7).addAll(Aspects.MOTION, 7).addAll(
      ...
      (new ResearchItem("GOLEMSTONE", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 6).addAll(Aspects.MOTION, 6).addAll(
      ...
      (new ResearchItem("GOLEMIRON", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 9).addAll(Aspects.MOTION, 9).addAll(
      ...
      (new ResearchItem("GOLEMTHAUMIUM", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SOUL, 10).addAll(Aspects.MOTION, 10).addAll(
      ...
      (new ResearchItem("GOLEMBELL", "GOLEMANCY", new LinkedTreeAspectList<>(), 3, 0, 0, new ItemStack(ConfigItems.itemGolemBell))).setPages(new ResearchPage("tc.research_page.GOLEMBELL.1"), new ResearchPage("tc.research_page.GOLEMBELL.2"), new ResearchPage((IArcaneRecipe)recipes.get("GolemBell"))).setParents("GOLEMSTRAW").setStub().registerResearchItem();
      (new ResearchItem("COREGATHER", "GOLEMANCY", new LinkedTreeAspectList<>(), -3, 3, 1, new ItemStack(ConfigItems.itemGolemCore, 1, 2))).setPages(new ResearchPage("tc.research_page.COREGATHER.1"), new ResearchPage((IArcaneRecipe)recipes.get("CoreBlank")), new ResearchPage("tc.research_page.COREGATHER.2"), new ResearchPage((CrucibleRecipe)recipes.get("CoreGather"))).setConcealed().setParents("GOLEMSTRAW").setStub().registerResearchItem();
      (new ResearchItem("COREFILL", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.HUNGER, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREEMPTY", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.VOID, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("CORESORTING", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.VOID, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREUSE", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREHARVEST", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.HARVEST, 6).addAll(Aspects.CROP, 3).addAll(
      ...
      (new ResearchItem("COREFISHING", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.HARVEST, 3).addAll(
      ...
      (new ResearchItem("CORELUMBER", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.TREE, 6).addAll(Aspects.HARVEST, 3).addAll(
              Aspects.TOOL, 3).addAll(
      ...
      (new ResearchItem("COREGUARD", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.TRAP, 3).addAll(
      ...
      (new ResearchItem("COREBUTCHER", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.BEAST, 3).addAll(
      ...
      (new ResearchItem("CORELIQUID", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREALCHEMY", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.TRAVEL, 3).addAll(
              Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("TINYHAT", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.LIFE, 1).addAll(
      ...
      (new ResearchItem("TINYGLASSES", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.SENSES, 1).addAll(
              ...
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYBOWTIE", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.TRAVEL, 1).addAll(
              ...
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYFEZ", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.ENERGY, 1).addAll(
              ...
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYDART", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.FLIGHT, 1).addAll(Aspects.WEAPON, 2).addAll(
      ...
      (new ResearchItem("TINYVISOR", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.SENSES, 1).addAll(Aspects.ARMOR, 2).addAll(
              ...
              Aspects.ARMOR).registerResearchItem();
      (new ResearchItem("TINYARMOR", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 1).addAll(Aspects.ARMOR, 2).addAll(
              ...
              Aspects.ARMOR).registerResearchItem();
      (new ResearchItem("TINYHAMMER", "GOLEMANCY", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 1).addAll(Aspects.WEAPON, 2).addAll(
   ...
   private static void initBasicResearch() {
      (new ResearchItem("ASPECTS", "BASICS", new LinkedTreeAspectList<>(), 0, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_aspects.png"))).setPages(new ResearchPage("tc.research_page.ASPECTS.1"), new ResearchPage("tc.research_page.ASPECTS.2"), new ResearchPage("tc.research_page.ASPECTS.3")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("PECH", "BASICS", new LinkedTreeAspectList<>(), -4, -4, 0, new ResourceLocation("thaumcraft", "textures/misc/r_pech.png"))).setPages(new ResearchPage("tc.research_page.PECH.1"), new ResearchPage("tc.research_page.PECH.2")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("NODES", "BASICS", new LinkedTreeAspectList<>(), -2, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_nodes.png"))).setPages(new ResearchPage("tc.research_page.NODES.1"), new ResearchPage("tc.research_page.NODES.2"), new ResearchPage("tc.research_page.NODES.3")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("WARP", "BASICS", new LinkedTreeAspectList<>(), 0, 2, 0, new ResourceLocation("thaumcraft", "textures/misc/r_warp.png"))).setPages(new ResearchPage("tc.research_page.WARP.1"), new ResearchPage("tc.research_page.WARP.2"), new ResearchPage("tc.research_page.WARP.3")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("RESEARCH", "BASICS", new LinkedTreeAspectList<>(), 2, 0, 0, new ItemStack(ConfigItems.itemInkwell))).setPages(new ResearchPage("tc.research_page.RESEARCH.1"), new ResearchPage("tc.research_page.RESEARCH.2"), new ResearchPage((IRecipe)recipes.get("Thaumometer")), new ResearchPage("tc.research_page.RESEARCH.3"), new ResearchPage("tc.research_page.RESEARCH.4"), new ResearchPage((IRecipe)recipes.get("Scribe1")), new ResearchPage((IRecipe)recipes.get("Scribe2")), new ResearchPage((IRecipe)recipes.get("Scribe3")), new ResearchPage("tc.research_page.RESEARCH.5"), new ResearchPage("tc.research_page.RESEARCH.6"), new ResearchPage("tc.research_page.RESEARCH.7"), new ResearchPage("tc.research_page.RESEARCH.8"), new ResearchPage("tc.research_page.RESEARCH.9"), new ResearchPage("tc.research_page.RESEARCH.10"), new ResearchPage("tc.research_page.RESEARCH.11"), new ResearchPage("tc.research_page.RESEARCH.12")).setAutoUnlock().setStub().setRound().registerResearchItem();
      (new ResearchItem("KNOWFRAG", "BASICS", new LinkedTreeAspectList<>(), 3, -2, 0, new ItemStack(ThaumcraftItems.KNOWLEDGE_FRAGMENT))).setPages(new ResearchPage("tc.research_page.KNOWFRAG.1"), new ResearchPage((IRecipe)recipes.get("KnowFrag"))).setStub().setRound().setAutoUnlock().setParents("RESEARCH").registerResearchItem();
      (new ResearchItem("THAUMONOMICON", "BASICS", new LinkedTreeAspectList<>(), 1, -2, 0, new ItemStack(ConfigItems.itemThaumonomicon))).setPages(new ResearchPage("tc.research_page.THAUMONOMICON.1"), new ResearchPage((List)recipes.get("Thaumonomicon"))).setAutoUnlock().setStub().setRound().setParents("RESEARCH").registerResearchItem();
      ArrayList<IRecipe> rc = new ArrayList<>();
      ...
      (new ResearchItem("ORE", "BASICS", new LinkedTreeAspectList<>(), -2, -2, 0, new ItemStack(ConfigBlocks.blockCustomOre, 1, 32767))).setPages(new ResearchPage("tc.research_page.ORE.1"), new ResearchPage("tc.research_page.ORE.2"), new ResearchPage(rc.toArray(new IRecipe[0])), new ResearchPage("tc.research_page.ORE.3"), new ResearchPage("tc.research_page.ORE.4")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("PLANTS", "BASICS", new LinkedTreeAspectList<>(), -2, -4, 0, new ItemStack(ConfigBlocks.blockCustomPlant, 1, 0))).setPages(new ResearchPage("tc.research_page.PLANTS.1"), new ResearchPage((IRecipe)recipes.get("PlankGreatwood")), new ResearchPage("tc.research_page.PLANTS.2"), new ResearchPage((IRecipe)recipes.get("PlankSilverwood")), new ResearchPage("tc.research_page.PLANTS.3"), new ResearchPage("tc.research_page.PLANTS.4"), new ResearchPage("tc.research_page.PLANTS.5"), new ResearchPage("tc.research_page.PLANTS.6")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("ENCHANT", "BASICS", new LinkedTreeAspectList<>(), -4, -2, 0, new ResourceLocation("thaumcraft", "textures/misc/r_enchant.png"))).setPages(new ResearchPage("tc.research_page.ENCHANT.1"), new ResearchPage("tc.research_page.ENCHANT.2")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("NODETAPPER1", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("NODEPRESERVE", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.GREED, 3).addAll(
      ...
      ((ItemJarNode)jarIs.getItem()).setAspects(jarIs, (new LinkedTreeAspectList<>()).addAll(Aspects.AIR, 40).addAll(Aspects.FIRE, 40).addAll(
              Aspects.WATER, 40).addAll(Aspects.EARTH, 40));
      ((ItemJarNode)jarIs.getItem()).setNodeAttributes(jarIs, NodeType.NORMAL, null, "");
      (new ResearchItem("NODEJAR", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.GREED, 3).addAll(
      ...
      (new ResearchItem("NODETAPPER2", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("RESEARCHER1", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 3).addAll(Aspects.SENSES, 3).addAll(
      ...
      (new ResearchItem("DECONSTRUCTOR", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 3).addAll(Aspects.CRAFT, 3).addAll(
      ...
      (new ResearchItem("RESEARCHER2", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 6).addAll(Aspects.ORDER, 3).addAll(
      ...
      (new ResearchItem("RESEARCHDUPE", "BASICS", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 6).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("CRIMSON", "BASICS", new LinkedTreeAspectList<>(), 0, 4, 0, new ItemStack(ThaumcraftItems.CRIMSON_RITES))).setPages(new ResearchPage("tc.research_page.CRIMSON.1")).setStub().setHidden().setRound().setSpecial().registerResearchItem();
      ThaumcraftApi.addWarpToResearch("CRIMSON", 3);
   }

   private static void initEldritchResearch() {
      (new ResearchItem("ELDRITCHMINOR", "ELDRITCH", new LinkedTreeAspectList<>(), 1, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_eldritchminor.png"))).setPages(new ResearchPage("tc.research_page.ELDRITCHMINOR.1"), new ResearchPage((CrucibleRecipe)recipes.get("VoidSeed"))).setHidden().setRound().setSpecial().registerResearchItem();
      (new ResearchItem("ELDRITCHMAJOR", "ELDRITCH", new LinkedTreeAspectList<>(), -1, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_eldritchmajor.png"))).setPages(new ResearchPage("tc.research_page.ELDRITCHMAJOR.1"), new ResearchPage("tc.research_page.ELDRITCHMAJOR.2")).setStub().setHidden().setRound().setSpecial().registerResearchItem();
      new ResearchItem(
              "OCULUS",
              "ELDRITCH",
              new LinkedTreeAspectList<>()
      ...
      (new ResearchItem("ENTEROUTER", "ELDRITCH", new LinkedTreeAspectList<>(), -3, 4, 1, new ResourceLocation("thaumcraft", "textures/misc/r_outer.png"))).setPages(new ResearchPage("tc.research_page.ENTEROUTER.1")).setStub().setHidden().setRound().setParents("OCULUS").registerResearchItem();
      (new ResearchItem("OUTERREV", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.ELDRITCH, 4).addAll(Aspects.MIND, 4), -5, 3, 1, new ResourceLocation("thaumcraft", "textures/misc/r_outerrev.png"))).setPages(new ResearchPage("tc.research_page.OUTERREV.1")).setItemTriggers(new ItemStack(ConfigBlocks.blockEldritch, 1, 5), new ItemStack(ConfigBlocks.blockEldritch, 1, 10)).setLost().setSecondary().setSpecial().setParents("ENTEROUTER").registerResearchItem();
      (new ResearchItem("PRIMPEARL", "ELDRITCH",
              (new LinkedTreeAspectList<>()).addAll(Aspects.AIR, 8).addAll(Aspects.EARTH, 8).addAll(Aspects.FIRE, 8).addAll(Aspects.WATER, 8).addAll(
              ...
              .registerResearchItem();
      (new ResearchItem("PRIMNODE", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 1).addAll(Aspects.MAGIC, 1).addAll(
      ...
      (new ResearchItem("ADVALCHEMYFURNACE", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.AURA, 1).addAll(Aspects.MAGIC, 1).addAll(
      ...
      (new ResearchItem("PRIMALCRUSHER", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.MINE, 6).addAll(Aspects.TOOL, 6).addAll(
      ...
      (new ResearchItem("SANITYCHECK", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.MIND, 5).addAll(Aspects.ELDRITCH, 3).addAll(
      ...
      (new ResearchItem("VOIDMETAL", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ELDRITCH, 3).addAll(
      ...
      (new ResearchItem("ESSENTIARESERVOIR", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.WATER, 5).addAll(Aspects.VOID, 3).addAll(
      ...
      (new ResearchItem("CAP_void", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.VOID, 5).addAll(Aspects.ELDRITCH, 5).addAll(
      ...
      (new ResearchItem("ARMORVOIDFORTRESS", "ELDRITCH", (new LinkedTreeAspectList<>()).addAll(Aspects.ARMOR, 5).addAll(Aspects.ELDRITCH, 3).addAll(
      ...
      (new ResearchItem("FOCUSPRIMAL",
              "ELDRITCH", (new LinkedTreeAspectList<>())
      ...
      (new ResearchItem("ROD_primal_staff", "ELDRITCH",
              (new LinkedTreeAspectList<>()).addAll(Aspects.AIR, 9)
