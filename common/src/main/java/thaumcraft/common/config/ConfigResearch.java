...
public class ConfigResearch {
   ...
   private static void initThaumaturgyResearch() {
      (new ResearchItem("BASICTHAUMATURGY", "THAUMATURGY", new LinkedHashAspectList<>(), 0, 0, 0, wand)).setPages(new ResearchPage("tc.research_page.BASICTHAUMATURGY.1"), new ResearchPage("tc.research_page.BASICTHAUMATURGY.2"), new ResearchPage((IRecipe)recipes.get("WandCapIron")), new ResearchPage((IRecipe)recipes.get("WandBasic"))).setAutoUnlock().setStub().setRound().registerResearchItem();
      (new ResearchItem("FOCUSFIRE", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 3).addAll(Aspects.MAGIC, 3), 2, -2, 1, new ItemStack(ConfigItems.itemFocusFire))).setPages(new ResearchPage("tc.research_page.FOCUSFIRE.1"), new ResearchPage("tc.research_page.FOCUSFIRE.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FocusFire"))).setParents("BASICTHAUMATURGY").registerResearchItem();
      (new ResearchItem("FOCUSFROST", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 3).addAll(
              Aspects.COLD, 6), 1, -5, 1, new ItemStack(ConfigItems.itemFocusFrost))).setPages(new ResearchPage("tc.research_page.FOCUSFROST.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FocusFrost"))).setConcealed().setSecondary().setParents("FOCUSFIRE").registerResearchItem();
      (new ResearchItem("FOCUSHELLBAT", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.BEAST, 6).addAll(
      ...
      (new ResearchItem("FOCUSEXCAVATION", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.EARTH, 3).addAll(Aspects.ENTROPY, 3).addAll(
              Aspects.MAGIC, 3), 0, -3, 2, new ItemStack(ConfigItems.itemFocusExcavation))).setPages(new ResearchPage("tc.research_page.FOCUSEXCAVATION.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FocusExcavation"))).setConcealed().setParents("FOCUSFIRE").registerResearchItem();
      if (Config.wardedStone) {
         (new ResearchItem("FOCUSWARDING", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.EARTH, 6).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("FOCUSSHOCK", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 3).addAll(Aspects.ENERGY, 6).addAll(
              Aspects.MAGIC, 3), 3, -5, 1, new ItemStack(ConfigItems.itemFocusShock))).setPages(new ResearchPage("tc.research_page.FOCUSSHOCK.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FocusShock"))).setConcealed().setSecondary().setParents("FOCUSFIRE").registerResearchItem();
      (new ResearchItem("FOCUSTRADE", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.EARTH, 3).addAll(Aspects.EXCHANGE, 6).addAll(
              Aspects.MAGIC, 3), 4, -3, 2, new ItemStack(ConfigItems.itemFocusTrade))).setPages(new ResearchPage("tc.research_page.FOCUSTRADE.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FocusTrade"))).setConcealed().setParents("FOCUSFIRE").registerResearchItem();
      (new ResearchItem("FOCUSPORTABLEHOLE", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.ENTROPY, 3).addAll(
      ...
      (new ResearchItem("CAP_thaumium", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 6).addAll(Aspects.MAGIC, 6).addAll(
              Aspects.TOOL, 3).addAll(Aspects.AURA, 3), 5, 4, 2, new ItemStack(ConfigItems.itemWandCap, 1, 2))).setPages(new ResearchPage("tc.research_page.CAP_thaumium.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandCapThaumiumInert")), new ResearchPage((InfusionRecipe)recipes.get("WandCapThaumium"))).setParents("CAP_gold", "THAUMIUM", "INFUSION").registerResearchItem();
      if (Config.foundCopperIngot) {
         (new ResearchItem("CAP_copper", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.EXCHANGE, 3).addAll(
                 Aspects.TOOL, 3), 2, 0, 1, new ItemStack(ConfigItems.itemWandCap, 1, 3))).setPages(new ResearchPage("tc.research_page.CAP_copper.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandCapCopper"))).setParents("BASICTHAUMATURGY").registerResearchItem();
      }

      if (Config.foundSilverIngot) {
         (new ResearchItem("CAP_silver", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.GREED, 3).addAll(
      ...
      (new ResearchItem("ROD_blaze", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.FIRE, 6).addAll(
      ...
      (new ResearchItem("ROD_obsidian", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EARTH, 6).addAll(
      ...
      (new ResearchItem("ROD_ice", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.COLD, 6).addAll(
      ...
      (new ResearchItem("ROD_quartz", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ORDER, 6).addAll(
      ...
      (new ResearchItem("ROD_bone", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ENTROPY, 6).addAll(
      ...
      (new ResearchItem("ROD_silverwood", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.TREE, 6).addAll(
      ...
      ArrayList<AbstractArcaneRecipe> scer = new ArrayList<>();
      ...
      (new ResearchItem("SCEPTRE", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.CRAFT, 6).addAll(
              ...
              Aspects.MAGIC, 9), 0, 4, 3, sceptre3)).setPages(new ResearchPage("tc.research_page.SCEPTRE.1"), new ResearchPage(scer.toArray(new AbstractArcaneRecipe[0]))).setConcealed().setParents("ROD_silverwood").registerResearchItem();
      (new ResearchItem("ROD_greatwood_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.TREE, 6).addAll(
              Aspects.MAGIC, 3), -1, 7, 1, new ItemStack(ConfigItems.itemWandRod, 1, 50))).setPages(new ResearchPage("tc.research_page.ROD_greatwood_staff.1"), new ResearchPage("tc.research_page.ROD_greatwood_staff.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodGreatwoodStaff"))).setParents("ROD_silverwood").registerResearchItem();
      (new ResearchItem("ROD_reed_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.AIR, 6).addAll(
              Aspects.PLANT, 3).addAll(
              Aspects.MAGIC, 3), -5, -2, 2, new ItemStack(ConfigItems.itemWandRod, 1, 55))).setPages(new ResearchPage("tc.research_page.ROD_reed_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodReedStaff"))).setSecondary().setConcealed().setParents("ROD_reed").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      (new ResearchItem("ROD_blaze_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.FIRE, 6).addAll(
              Aspects.ENERGY, 3).addAll(Aspects.MAGIC, 3), -8, -1, 2, new ItemStack(ConfigItems.itemWandRod, 1, 56))).setPages(new ResearchPage("tc.research_page.ROD_blaze_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodBlazeStaff"))).setSecondary().setConcealed().setParents("ROD_blaze").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      (new ResearchItem("ROD_obsidian_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EARTH, 6).addAll(
              Aspects.FIRE, 3).addAll(Aspects.MAGIC, 3), -9, 2, 2, new ItemStack(ConfigItems.itemWandRod, 1, 51))).setPages(new ResearchPage("tc.research_page.ROD_obsidian_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodObsidianStaff"))).setSecondary().setConcealed().setParents("ROD_obsidian").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      (new ResearchItem("ROD_ice_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.COLD, 6).addAll(
              Aspects.WATER, 3).addAll(Aspects.MAGIC, 3), -8, 5, 2, new ItemStack(ConfigItems.itemWandRod, 1, 53))).setPages(new ResearchPage("tc.research_page.ROD_ice_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodIceStaff"))).setSecondary().setConcealed().setParents("ROD_ice").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      (new ResearchItem("ROD_quartz_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ORDER, 6).addAll(
              Aspects.CRYSTAL, 3).addAll(Aspects.MAGIC, 3), -4, 6, 2, new ItemStack(ConfigItems.itemWandRod, 1, 54))).setPages(new ResearchPage("tc.research_page.ROD_quartz_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodQuartzStaff"))).setSecondary().setConcealed().setParents("ROD_quartz").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      (new ResearchItem("ROD_bone_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.ENTROPY, 6).addAll(
              Aspects.UNDEAD, 3).addAll(
              Aspects.MAGIC, 3), -2, -1, 2, new ItemStack(ConfigItems.itemWandRod, 1, 57))).setPages(new ResearchPage("tc.research_page.ROD_bone_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodBoneStaff"))).setSecondary().setConcealed().setParents("ROD_bone").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      ThaumcraftApi.addWarpToResearch("ROD_bone_staff", 1);
      (new ResearchItem("ROD_silverwood_staff", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 6).addAll(
              Aspects.TREE, 6).addAll(
              Aspects.MAGIC, 9), -1, 5, 3, new ItemStack(ConfigItems.itemWandRod, 1, 52))).setPages(new ResearchPage("tc.research_page.ROD_silverwood_staff.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WandRodSilverwoodStaff"))).setSecondary().setConcealed().setParents("ROD_silverwood").setParentsHidden("ROD_greatwood_staff").registerResearchItem();
      (new ResearchItem("WANDPED", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("VISAMULET", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.MAGIC, 6).addAll(
      ...
      (new ResearchItem("WANDPEDFOC", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.MAGIC, 6).addAll(
      ...
      (new ResearchItem("NODESTABILIZER", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 4).addAll(Aspects.ORDER, 4).addAll(
              Aspects.ENERGY, 4), -7, -4, 1, new ItemStack(ConfigBlocks.blockStoneDevice, 1, 9))).setPages(new ResearchPage("tc.research_page.NODESTABILIZER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("NodeStabilizerBlock")), new ResearchPage("tc.research_page.NODESTABILIZER.2")).setParents("NODEPRESERVE").registerResearchItem();
      (new ResearchItem("NODESTABILIZERADV", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 9).addAll(Aspects.MAGIC, 6).addAll(
      ...
      (new ResearchItem("VISPOWER", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.MECHANISM, 3).addAll(
              Aspects.ENERGY, 6), -5, -6, 2, new ItemStack(ConfigBlocks.blockStoneDevice, 1, 11))).setPages(new ResearchPage("tc.research_page.VISPOWER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("NodeTransducer")), new ResearchPage("tc.research_page.VISPOWER.2"), new ResearchPage("tc.research_page.VISPOWER.3"), new ResearchPage((AbstractArcaneRecipe)recipes.get("NodeRelay")), new ResearchPage("tc.research_page.VISPOWER.4"), new ResearchPage("tc.research_page.VISPOWER.5")).setParents("NODESTABILIZER").setSpecial().registerResearchItem();
      (new ResearchItem("VISCHARGERELAY", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.AURA, 3).addAll(
              Aspects.MECHANISM, 3).addAll(
              Aspects.ENERGY, 6), -7, -6, 2, new ItemStack(ConfigBlocks.blockMetalDevice, 1, 2))).setPages(new ResearchPage("tc.research_page.VISCHARGERELAY.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("NodeChargeRelay"))).setParents("VISPOWER", "WANDPED").setParentsHidden("ROD_greatwood").setSecondary().setConcealed().registerResearchItem();
      (new ResearchItem("FOCALMANIPULATION", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 8).addAll(Aspects.TOOL, 8).addAll(
              Aspects.CRAFT, 5).addAll(
              Aspects.CRYSTAL, 5).addAll(Aspects.ENERGY, 5), -3, -8, 2, new ItemStack(ConfigBlocks.blockStoneDevice, 1, 13))).setPages(new ResearchPage("tc.research_page.FOCALMANIPULATION.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FocalManipulator")), new ResearchPage("tc.research_page.FOCALMANIPULATION.2")).setParentsHidden("INFUSION", "FOCUSFIRE").setParents("VISPOWER").registerResearchItem();
      (new ResearchItem("VAMPBAT", "THAUMATURGY", (new LinkedHashAspectList<>()).addAll(Aspects.HUNGER, 5).addAll(Aspects.LIFE, 5).addAll(
   ...
   private static void initArtificeResearch() {
      ...
      (new ResearchItem("THAUMOMETER", "ARTIFICE", new LinkedHashAspectList<>(), 2, 1, 0, new ItemStack(ThaumcraftItemInstances.THAUMOMETER()))).setStub().setAutoUnlock().setRound().setPages(new ResearchPage("tc.research_page.THAUMOMETER.1"), new ResearchPage((IRecipe)recipes.get("Thaumometer"))).registerResearchItem();
      ...
      (new ResearchItem("PAVEWARD", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MOTION, 3).addAll(Aspects.TRAP, 3).addAll(
              Aspects.BEAST, 3), 6, -4, 1, new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 3))).setPages(new ResearchPage("tc.research_page.PAVEWARD.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("PaveWard")), new ResearchPage("tc.research_page.PAVEWARD.2")).setParents("ARCANESTONE").setSecondary().registerResearchItem();
      (new ResearchItem("GOGGLES", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.AURA, 3).addAll(
              Aspects.MAGIC, 3), 4, 1, 1, new ItemStack(ConfigItems.itemGoggles))).setPages(new ResearchPage("tc.research_page.GOGGLES.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Goggles"))).setParents("THAUMOMETER").setConcealed().registerResearchItem();
      (new ResearchItem("ARCANEEAR", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.ENERGY, 3).addAll(
              Aspects.AIR, 3), 6, 0, 1, new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 1))).setPages(new ResearchPage("tc.research_page.ARCANEEAR.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("ArcaneEar"))).setParents("GOGGLES").setConcealed().registerResearchItem();
      (new ResearchItem("SINSTONE", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.DARKNESS, 3).addAll(
      ...
      (new ResearchItem("LEVITATOR", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MOTION, 3).addAll(Aspects.FLIGHT, 3).addAll(
              Aspects.AIR, 3), -3, -3, 1, new ItemStack(ConfigBlocks.blockLifter))).setPages(new ResearchPage("tc.research_page.LEVITATOR.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Levitator"))).setConcealed().setParents("NITOR").registerResearchItem();
      (new ResearchItem("INFERNALFURNACE", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 6).addAll(Aspects.METAL, 3).addAll(
      ...
      (new ResearchItem("FLUXSCRUB", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.TRAP, 3).addAll(
              Aspects.AIR, 3).addAll(Aspects.WATER, 3), -8, -3, 1, new ItemStack(ConfigBlocks.blockStoneDevice, 1, 14))).setPages(new ResearchPage("tc.research_page.FLUXSCRUB.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("FluxScrubber"))).setParentsHidden("INFUSION").setParents("VISPOWER", "BELLOWS", "TUBES").setSecondary().registerResearchItem();
      (new ResearchItem("RUNICARMOR", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.ARMOR, 6).addAll(Aspects.AIR, 3).addAll(
      ...
      (new ResearchItem("RUNICCHARGED", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("RUNICHEALING", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("RUNICKINETIC", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("RUNICEMERGENCY", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      ArrayList<AbstractArcaneRecipe> banners = new ArrayList<>();

      for(int a = 0; a < 16; ++a) {
         banners.add((AbstractArcaneRecipe)recipes.get("Banner_" + a));
      }

      ItemStack is = new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 8);
      is.setTagCompound(new NBTTagCompound());
      is.stackTagCompound.setByte("color", (byte)10);
      (new ResearchItem("BANNERS", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.SENSES, 3).addAll(Aspects.CLOTH, 3).addAll(
              Aspects.MAGIC, 1), 4, 8, 1, is)).setPages(new ResearchPage("tc.research_page.BANNERS.1"), new ResearchPage(banners.toArray(new AbstractArcaneRecipe[0]))).setHidden().setItemTriggers(new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 8)).setSecondary().registerResearchItem();
      ArrayList<InfusionRecipe> raug = new ArrayList<>();

      for(int a = 0; a <= 4; ++a) {
         ItemStack in = new ItemStack(ConfigItems.itemChestRobe);
         if (a > 0) {
            in.setTagInfo("RS.HARDEN", new NBTTagByte((byte)a));
         }

         raug.add(new InfusionRunicAugmentRecipe(in));
      }

      (new ResearchItem("RUNICAUGMENTATION", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.ARMOR, 3).addAll(
      ...
      (new ResearchItem("BOOTSTRAVELLER", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TRAVEL, 3).addAll(Aspects.EARTH, 3).addAll(
      ...
      (new ResearchItem("HOVERHARNESS", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.FLIGHT, 6).addAll(Aspects.TRAVEL, 6).addAll(
      ...
      (new ResearchItem("HOVERGIRDLE", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.FLIGHT, 6).addAll(Aspects.TRAVEL, 3).addAll(
      ...
      if (Config.allowMirrors) {
         (new ResearchItem("MIRROR", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TRAVEL, 6).addAll(Aspects.ELDRITCH, 3).addAll(
         ...
         (new ResearchItem("MIRRORHAND", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.ELDRITCH, 3).addAll(
         ...
         (new ResearchItem("MIRRORESSENTIA", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TRAVEL, 6).addAll(Aspects.ELDRITCH, 3).addAll(
      ...
      (new ResearchItem("ARCANEBORE", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MINE, 6).addAll(Aspects.MOTION, 3).addAll(
              Aspects.MECHANISM, 3).addAll(Aspects.TOOL, 3), -3, 8, 2, new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 5))).setPages(new ResearchPage("tc.research_page.ARCANEBORE.1"), new ResearchPage((InfusionRecipe)recipes.get("ArcaneBore")), new ResearchPage("tc.research_page.ARCANEBORE.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("ArcaneBoreBase")), new ResearchPage("tc.research_page.ARCANEBORE.3")).setConcealed().setParents("FOCUSEXCAVATION", "INFUSION").registerResearchItem();
      (new ResearchItem("ARCANELAMP", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.LIGHT, 3).addAll(Aspects.SENSES, 3).addAll(
              Aspects.DARKNESS, 3), -3, 1, 1, new ItemStack(ConfigBlocks.blockMetalDevice, 1, 7))).setPages(new ResearchPage("tc.research_page.ARCANELAMP.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("ArcaneLamp")), new ResearchPage("ARCANEBORE", "tc.research_page.ARCANELAMP.2")).setSecondary().setParents("NITOR").registerResearchItem();
      (new ResearchItem("LAMPGROWTH", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.LIGHT, 3).addAll(Aspects.PLANT, 6).addAll(
      ...
      (new ResearchItem("LAMPFERTILITY", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.BEAST, 6).addAll(Aspects.LIFE, 6).addAll(
      ...
      (new ResearchItem("BONEBOW",
              ...
              .setPages(new ResearchPage("tc.research_page.BONEBOW.1"),
                      new ResearchPage((AbstractArcaneRecipe)recipes.get("BoneBow")))
              .setHidden()
              .setItemTriggers(
              ...
              .registerResearchItem();
      ArrayList<AbstractArcaneRecipe> rcbb = new ArrayList<>();

      for(int a = 0; a < 6; ++a) {
         rcbb.add((AbstractArcaneRecipe)recipes.get("PrimalArrow_" + a));
      }

      (new ResearchItem("PRIMALARROW", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.AIR, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALAXE", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.WATER, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALPICK", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.FIRE, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALSWORD", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.AIR, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALSHOVEL", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EARTH, 3).addAll(
      ...
      (new ResearchItem("ELEMENTALHOE", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.LIFE, 3).addAll(
      ...
      if (Config.wardedStone) {
         (new ResearchItem("WARDEDARCANA", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 6).addAll(Aspects.MIND, 3).addAll(
                 Aspects.MECHANISM, 3).addAll(Aspects.ARMOR, 3), -5, -4, 2, new ItemStack(ConfigItems.itemArcaneDoor))).setPages(new ResearchPage("tc.research_page.WARDEDARCANA.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("ArcaneDoor")), new ResearchPage("tc.research_page.WARDEDARCANA.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("IronKey")), new ResearchPage((AbstractArcaneRecipe)recipes.get("GoldKey")), new ResearchPage("tc.research_page.WARDEDARCANA.3"), new ResearchPage((AbstractArcaneRecipe)recipes.get("ArcanePressurePlate")), new ResearchPage("tc.research_page.WARDEDARCANA.4"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WardedGlass"))).setParents("THAUMIUM").registerResearchItem();
      }

      (new ResearchItem("JARBRAIN", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.HUNGER, 3).addAll(Aspects.MIND, 3).addAll(
      ...
      (new ResearchItem("INFUSIONENCHANTMENT", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 6).addAll(Aspects.MIND, 3).addAll(
              Aspects.WEAPON, 3).addAll(Aspects.ARMOR, 3).addAll(Aspects.TOOL, 3), -6, 11, 3, new ResourceLocation("thaumcraft", "textures/misc/r_enchant.png"))).setPages(new ResearchPage("tc.research_page.INFUSIONENCHANTMENT.1"), new ResearchPage("tc.research_page.INFUSIONENCHANTMENT.2"), new ResearchPage("tc.research_page.INFUSIONENCHANTMENT.3"), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnchRepair")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnchHaste")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch0")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch1")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch2")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch3")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch4")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch5")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch6")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch7")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch8")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch9")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch10")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch11")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch12")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch13")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch14")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch15")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch16")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch17")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch18")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch19")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch20")), new ResearchPage((SimpleInfusionEnchantmentRecipe)recipes.get("InfEnch21"))).setConcealed().setParents("JARBRAIN").registerResearchItem();
      (new ResearchItem("ARMORFORTRESS", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ARMOR, 5).addAll(
      ...
      (new ResearchItem("HELMGOGGLES", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.SENSES, 5).addAll(Aspects.AURA, 3).addAll(
      ...
      (new ResearchItem("MASKGRINNINGDEVIL", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.HEAL, 5).addAll(Aspects.MIND, 5).addAll(
      ...
      (new ResearchItem("MASKANGRYGHOST", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.ENTROPY, 5).addAll(Aspects.DEATH, 5).addAll(
      ...
      (new ResearchItem("MASKSIPPINGFIEND", "ARTIFICE", (new LinkedHashAspectList<>()).addAll(Aspects.UNDEAD, 5).addAll(Aspects.LIFE, 5).addAll(
   ...
   private static void initAlchemyResearch() {
      (new ResearchItem("PHIAL", "ALCHEMY", new LinkedHashAspectList<>(), 0, -2, 0, new ItemStack(ConfigItems.itemEssence, 1, 0))).setPages(new ResearchPage("tc.research_page.PHIAL.1"), new ResearchPage((IRecipe)recipes.get("Phial"))).setStub().setRound().setAutoUnlock().registerResearchItem();
      ...
      (new ResearchItem("NITOR", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.LIGHT, 3).addAll(Aspects.FIRE, 1), 2, -1, 1, new ItemStack(ThaumcraftItemInstances.NITOR()))).setPages(new ResearchPage("tc.research_page.NITOR.1"), new ResearchPage((CrucibleRecipe)recipes.get("Nitor"))).setParents("CRUCIBLE").registerResearchItem();
      (new ResearchItem("ALUMENTUM", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.ENERGY, 3).addAll(Aspects.FIRE, 1), 2, 1, 1, new ItemStack(ThaumcraftItemInstances.ALUMENTUM()))).setPages(new ResearchPage("tc.research_page.ALUMENTUM.1"), new ResearchPage((CrucibleRecipe)recipes.get("Alumentum"))).setParents("CRUCIBLE").registerResearchItem();
      ...
      (new ResearchItem("ENTROPICPROCESSING", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 1).addAll(Aspects.ENTROPY, 3).addAll(
      ...
      (new ResearchItem("LIQUIDDEATH", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.DEATH, 3).addAll(Aspects.POISON, 3).addAll(
      ...
      (new ResearchItem("BOTTLETAINT", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.TAINT, 5).addAll(Aspects.MAGIC, 3).addAll(
      ...
      if (Config.foundCopperOre && Config.foundCopperIngot) {
         (new ResearchItem("PURECOPPER", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ORDER, 2).addAll(
      ...
      if (Config.foundTinOre && Config.foundTinIngot) {
         (new ResearchItem("PURETIN", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ORDER, 2).addAll(
      ...
      if (Config.foundSilverOre && Config.foundSilverIngot) {
         (new ResearchItem("PURESILVER", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.ORDER, 2).addAll(
      ...
      if (Config.foundSilverIngot) {
         (new ResearchItem("TRANSSILVER", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.EXCHANGE, 2).addAll(
      ...
      if (Config.foundLeadIngot) {
         (new ResearchItem("TRANSLEAD", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 3).addAll(Aspects.EXCHANGE, 2).addAll(
      ...
      (new ResearchItem("BATHSALTS", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.MIND, 3).addAll(Aspects.AURA, 3).addAll(
      ...
      (new ResearchItem("SANESOAP", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.MIND, 5).addAll(Aspects.ORDER, 5).addAll(
      ...
      (new ResearchItem("ARCANESPA", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MECHANISM, 3).addAll(
              Aspects.ORDER, 3), -6, -5, 1, new ItemStack(ConfigBlocks.blockStoneDevice, 1, 12))).setPages(new ResearchPage("tc.research_page.ARCANESPA.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("ArcaneSpa"))).setSecondary().setParents("BATHSALTS").registerResearchItem();
      (new ResearchItem("DISTILESSENTIA", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.MAGIC, 3).addAll(Aspects.WATER, 3).addAll(
              Aspects.SLIME, 3), 5, -1, 1, new ItemStack(ConfigBlocks.blockMetalDevice, 1, 1))).setPages(new ResearchPage("tc.research_page.DISTILESSENTIA.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("AlchemyFurnace")), new ResearchPage("tc.research_page.DISTILESSENTIA.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Filter")), new ResearchPage((AbstractArcaneRecipe)recipes.get("Alembic")), new ResearchPage((AbstractArcaneRecipe)recipes.get("AlchemicalConstruct"))).setSiblings("JARLABEL").setParents("NITOR", "ALUMENTUM").registerResearchItem();
      ArrayList<IRecipe> rc = new ArrayList<>();

      for(int a = 0; a < Aspects.ALL_ASPECTS.size(); ++a) {
         rc.add((IRecipe)recipes.get("JarLabel" + a));
      }

      (new ResearchItem("JARLABEL", "ALCHEMY", new LinkedHashAspectList<>(), 4, -3, 0, new ItemStack(ConfigBlocks.blockJar))).setPages(new ResearchPage("tc.research_page.JARLABEL.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("WardedJar")), new ResearchPage("tc.research_page.JARLABEL.2"), new ResearchPage((IRecipe)recipes.get("JarLabel")), new ResearchPage("tc.research_page.JARLABEL.3"), new ResearchPage(rc.toArray(new IRecipe[0])), new ResearchPage((IRecipe)recipes.get("JarLabelNull"))).setParents("DISTILESSENTIA").setStub().setRound().registerResearchItem();
      (new ResearchItem("JARVOID", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.ENTROPY, 3).addAll(
              Aspects.VOID, 6), 5, -5, 1, new ItemStack(ConfigBlocks.blockJar, 1, 3))).setPages(new ResearchPage("tc.research_page.JARVOID.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("JarVoid"))).setParents("JARLABEL").setSecondary().setConcealed().registerResearchItem();
      (new ResearchItem("TUBES", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 3).addAll(
              Aspects.EXCHANGE, 3), 7, 0, 1, new ItemStack(ConfigBlocks.blockTube, 1, 0))).setPages(new ResearchPage("tc.research_page.TUBES.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Tube")), new ResearchPage("tc.research_page.TUBES.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TubeValve")), new ResearchPage("tc.research_page.TUBES.3"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Resonator")), new ResearchPage("tc.research_page.TUBES.4")).setParents("DISTILESSENTIA").setSecondary().setConcealed().registerResearchItem();
      (new ResearchItem("TUBEFILTER", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 3).addAll(
              Aspects.EXCHANGE, 3).addAll(Aspects.ORDER, 3), 9, 1, 2, new ItemStack(ConfigBlocks.blockTube, 1, 3))).setPages(new ResearchPage("tc.research_page.TUBEFILTER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TubeFilter")), new ResearchPage("tc.research_page.TUBEFILTER.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TubeRestrict")), new ResearchPage((AbstractArcaneRecipe)recipes.get("TubeOneway"))).setParents("TUBES").setSecondary().setConcealed().registerResearchItem();
      (new ResearchItem("ESSENTIACRYSTAL", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 5).addAll(Aspects.CRYSTAL, 5).addAll(
              Aspects.EXCHANGE, 3).addAll(Aspects.MAGIC, 5), 8, -2, 1, new ItemStack(ConfigBlocks.blockTube, 1, 7))).setPages(new ResearchPage("tc.research_page.ESSENTIACRYSTAL.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("EssentiaCrystalizer"))).setConcealed().setParents("TUBES").registerResearchItem();
      (new ResearchItem("CENTRIFUGE", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.ENTROPY, 3).addAll(Aspects.MAGIC, 3).addAll(
              Aspects.EXCHANGE, 3).addAll(Aspects.CRAFT, 3), 10, 0, 2, new ItemStack(ConfigBlocks.blockTube, 1, 2))).setPages(new ResearchPage("tc.research_page.CENTRIFUGE.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Centrifuge")), new ResearchPage("tc.research_page.CENTRIFUGE.2"), new ResearchPage("tc.research_page.CENTRIFUGE.3"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TubeBuffer"))).setParents("TUBEFILTER").setConcealed().registerResearchItem();
      (new ResearchItem("THAUMATORIUM", "ALCHEMY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.MAGIC, 6).addAll(
              Aspects.EXCHANGE, 3).addAll(Aspects.CRAFT, 3), 10, -2, 3, new ResourceLocation("thaumcraft", "textures/blocks/alchemyblock.png"))).setPages(new ResearchPage("tc.research_page.THAUMATORIUM.1"), new ResearchPage((List)recipes.get("Thaumatorium")), new ResearchPage("tc.research_page.THAUMATORIUM.2"), new ResearchPage("tc.research_page.THAUMATORIUM.3"), new ResearchPage((AbstractArcaneRecipe)recipes.get("MnemonicMatrix"))).setParents("CENTRIFUGE").setConcealed().registerResearchItem();
   }

   private static void initGolemancyResearch() {
      (new ResearchItem("HUNGRYCHEST", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.HUNGER, 3).addAll(Aspects.VOID, 3), -1, 0, 1, new ItemStack(ConfigBlocks.blockChestHungry))).setPages(new ResearchPage("tc.research_page.HUNGRYCHEST.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("HungryChest"))).setSecondary().registerResearchItem();
      (new ResearchItem("GOLEMFETTER", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.TRAP, 3).addAll(Aspects.MECHANISM, 3), 4, 8, 1, new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 9))).setPages(new ResearchPage("tc.research_page.GOLEMFETTER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("GolemFetter"))).setParents("GOLEMSTONE").setSecondary().registerResearchItem();
      (new ResearchItem("TRAVELTRUNK", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 3).addAll(Aspects.TRAVEL, 3).addAll(
      ...
      (new ResearchItem("GOLEMSTRAW", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 3).addAll(Aspects.MOTION, 3).addAll(
      ...
      (new ResearchItem("GOLEMWOOD", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 4).addAll(Aspects.MOTION, 4).addAll(
              Aspects.TREE, 3).addAll(
      ...
      (new ResearchItem("GOLEMTALLOW", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 3).addAll(Aspects.MOTION, 3).addAll(
      ...
      (new ResearchItem("GOLEMCLAY", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 6).addAll(Aspects.MOTION, 6).addAll(
      ...
      (new ResearchItem("GOLEMFLESH", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 7).addAll(Aspects.MOTION, 7).addAll(
      ...
      (new ResearchItem("GOLEMSTONE", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 6).addAll(Aspects.MOTION, 6).addAll(
      ...
      (new ResearchItem("GOLEMIRON", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 9).addAll(Aspects.MOTION, 9).addAll(
      ...
      (new ResearchItem("GOLEMTHAUMIUM", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SOUL, 10).addAll(Aspects.MOTION, 10).addAll(
      ...
      (new ResearchItem("GOLEMBELL", "GOLEMANCY", new LinkedHashAspectList<>(), 3, 0, 0, new ItemStack(ConfigItems.itemGolemBell))).setPages(new ResearchPage("tc.research_page.GOLEMBELL.1"), new ResearchPage("tc.research_page.GOLEMBELL.2"), new ResearchPage((AbstractArcaneRecipe)recipes.get("GolemBell"))).setParents("GOLEMSTRAW").setStub().registerResearchItem();
      (new ResearchItem("COREGATHER", "GOLEMANCY", new LinkedHashAspectList<>(), -3, 3, 1, new ItemStack(ConfigItems.itemGolemCore, 1, 2))).setPages(new ResearchPage("tc.research_page.COREGATHER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("CoreBlank")), new ResearchPage("tc.research_page.COREGATHER.2"), new ResearchPage((CrucibleRecipe)recipes.get("CoreGather"))).setConcealed().setParents("GOLEMSTRAW").setStub().registerResearchItem();
      (new ResearchItem("COREFILL", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.HUNGER, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREEMPTY", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.VOID, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("CORESORTING", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.VOID, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREUSE", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.TOOL, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREHARVEST", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.HARVEST, 6).addAll(Aspects.CROP, 3).addAll(
      ...
      (new ResearchItem("COREFISHING", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.HARVEST, 3).addAll(
      ...
      (new ResearchItem("CORELUMBER", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.TREE, 6).addAll(Aspects.HARVEST, 3).addAll(
              Aspects.TOOL, 3).addAll(
      ...
      (new ResearchItem("COREGUARD", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.TRAP, 3).addAll(
      ...
      (new ResearchItem("COREBUTCHER", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.WEAPON, 3).addAll(Aspects.BEAST, 3).addAll(
      ...
      (new ResearchItem("CORELIQUID", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.EXCHANGE, 3).addAll(
      ...
      (new ResearchItem("COREALCHEMY", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 3).addAll(Aspects.TRAVEL, 3).addAll(
              Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("UPGRADEAIR", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 6).addAll(Aspects.MOTION, 3), 7, -3, 1, new ItemStack(ConfigItems.itemGolemUpgrade, 1, 0))).setPages(new ResearchPage("tc.research_page.UPGRADEAIR.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("UpgradeAir"))).setConcealed().setSecondary().setParents("GOLEMBELL").registerResearchItem();
      (new ResearchItem("UPGRADEEARTH", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.EARTH, 6).addAll(Aspects.LIFE, 3), 6, -2, 1, new ItemStack(ConfigItems.itemGolemUpgrade, 1, 1))).setPages(new ResearchPage("tc.research_page.UPGRADEEARTH.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("UpgradeEarth"))).setConcealed().setSecondary().setParents("GOLEMBELL").registerResearchItem();
      (new ResearchItem("UPGRADEFIRE", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.FIRE, 6).addAll(Aspects.ENERGY, 3), 5, -1, 1, new ItemStack(ConfigItems.itemGolemUpgrade, 1, 2))).setPages(new ResearchPage("tc.research_page.UPGRADEFIRE.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("UpgradeFire"))).setConcealed().setSecondary().setParents("GOLEMBELL").registerResearchItem();
      (new ResearchItem("UPGRADEWATER", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.WATER, 6).addAll(Aspects.SENSES, 3), 5, 1, 1, new ItemStack(ConfigItems.itemGolemUpgrade, 1, 3))).setPages(new ResearchPage("tc.research_page.UPGRADEWATER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("UpgradeWater"))).setConcealed().setSecondary().setParents("GOLEMBELL").registerResearchItem();
      (new ResearchItem("UPGRADEORDER", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.ORDER, 6).addAll(Aspects.MIND, 3), 6, 2, 1, new ItemStack(ConfigItems.itemGolemUpgrade, 1, 4))).setPages(new ResearchPage("tc.research_page.UPGRADEORDER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("UpgradeOrder"))).setConcealed().setSecondary().setParents("GOLEMBELL").registerResearchItem();
      (new ResearchItem("UPGRADEENTROPY", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.ENTROPY, 6).addAll(Aspects.MIND, 3), 7, 3, 1, new ItemStack(ConfigItems.itemGolemUpgrade, 1, 5))).setPages(new ResearchPage("tc.research_page.UPGRADEENTROPY.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("UpgradeEntropy"))).setConcealed().setSecondary().setParents("GOLEMBELL").registerResearchItem();
      ItemStack ag = new ItemStack(ConfigItems.itemGolemPlacer, 1, 32767);
      ag.setTagInfo("advanced", new NBTTagByte((byte)1));
      (new ResearchItem("ADVANCEDGOLEM", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.LIFE, 3).addAll(Aspects.ENERGY, 3).addAll(
      ...
      (new ResearchItem("TINYHAT", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.LIFE, 1).addAll(
              Aspects.GREED, 1), 5, 10, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 0))).setPages(new ResearchPage("tc.research_page.TINYHAT.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyHat"))).setHidden().setSecondary().setItemTriggers(new ItemStack(Blocks.wool, 1, 32767)).setAspectTriggers(
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYGLASSES", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.SENSES, 1).addAll(
              Aspects.GREED, 1), 6, 10, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 1))).setPages(new ResearchPage("tc.research_page.TINYGLASSES.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyGlasses"))).setHidden().setSecondary().setItemTriggers(new ItemStack(Blocks.wool, 1, 32767)).setAspectTriggers(
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYBOWTIE", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.TRAVEL, 1).addAll(
              Aspects.GREED, 1), 7, 10, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 2))).setPages(new ResearchPage("tc.research_page.TINYBOWTIE.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyBowtie"))).setHidden().setSecondary().setItemTriggers(new ItemStack(Blocks.wool, 1, 32767)).setAspectTriggers(
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYFEZ", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.CLOTH, 2).addAll(Aspects.ENERGY, 1).addAll(
              Aspects.GREED, 1), 8, 10, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 3))).setPages(new ResearchPage("tc.research_page.TINYFEZ.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyFez"))).setHidden().setSecondary().setItemTriggers(new ItemStack(Blocks.wool, 1, 32767)).setAspectTriggers(
              Aspects.CLOTH).registerResearchItem();
      (new ResearchItem("TINYDART", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.FLIGHT, 1).addAll(Aspects.WEAPON, 2).addAll(
              Aspects.GREED, 1), 5, 11, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 4))).setPages(new ResearchPage("tc.research_page.TINYDART.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyDart"))).setHidden().setSecondary().setAspectTriggers(
              Aspects.WEAPON).registerResearchItem();
      (new ResearchItem("TINYVISOR", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.SENSES, 1).addAll(Aspects.ARMOR, 2).addAll(
              Aspects.GREED, 1), 6, 11, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 5))).setPages(new ResearchPage("tc.research_page.TINYVISOR.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyVisor"))).setHidden().setSecondary().setAspectTriggers(
              Aspects.ARMOR).registerResearchItem();
      (new ResearchItem("TINYARMOR", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 1).addAll(Aspects.ARMOR, 2).addAll(
              Aspects.GREED, 1), 7, 11, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 6))).setPages(new ResearchPage("tc.research_page.TINYARMOR.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyArmor"))).setHidden().setSecondary().setAspectTriggers(
              Aspects.ARMOR).registerResearchItem();
      (new ResearchItem("TINYHAMMER", "GOLEMANCY", (new LinkedHashAspectList<>()).addAll(Aspects.METAL, 1).addAll(Aspects.WEAPON, 2).addAll(
              Aspects.GREED, 1), 8, 11, 1, new ItemStack(ConfigItems.itemGolemDecoration, 1, 7))).setPages(new ResearchPage("tc.research_page.TINYHAMMER.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("TinyHammer"))).setHidden().setSecondary().setAspectTriggers(
              Aspects.WEAPON).registerResearchItem();
   }

   private static void initBasicResearch() {
      (new ResearchItem("ASPECTS", "BASICS", new LinkedHashAspectList<>(), 0, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_aspects.png"))).setPages(new ResearchPage("tc.research_page.ASPECTS.1"), new ResearchPage("tc.research_page.ASPECTS.2"), new ResearchPage("tc.research_page.ASPECTS.3")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("PECH", "BASICS", new LinkedHashAspectList<>(), -4, -4, 0, new ResourceLocation("thaumcraft", "textures/misc/r_pech.png"))).setPages(new ResearchPage("tc.research_page.PECH.1"), new ResearchPage("tc.research_page.PECH.2")).setStub().setRound().setAutoUnlock().registerResearchItem();
      ...
      (new ResearchItem("KNOWFRAG", "BASICS", new LinkedHashAspectList<>(), 3, -2, 0, new ItemStack(ThaumcraftItemInstances.KNOWLEDGE_FRAGMENT()))).setPages(new ResearchPage("tc.research_page.KNOWFRAG.1"), new ResearchPage((IRecipe)recipes.get("KnowFrag"))).setStub().setRound().setAutoUnlock().setParents("RESEARCH").registerResearchItem();
      ...
      (new ResearchItem("ORE", "BASICS", new LinkedHashAspectList<>(), -2, -2, 0, new ItemStack(ConfigBlocks.blockCustomOre, 1, 32767))).setPages(new ResearchPage("tc.research_page.ORE.1"), new ResearchPage("tc.research_page.ORE.2"), new ResearchPage(rc.toArray(new IRecipe[0])), new ResearchPage("tc.research_page.ORE.3"), new ResearchPage("tc.research_page.ORE.4")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("PLANTS", "BASICS", new LinkedHashAspectList<>(), -2, -4, 0, new ItemStack(ConfigBlocks.blockCustomPlant, 1, 0))).setPages(new ResearchPage("tc.research_page.PLANTS.1"), new ResearchPage((IRecipe)recipes.get("PlankGreatwood")), new ResearchPage("tc.research_page.PLANTS.2"), new ResearchPage((IRecipe)recipes.get("PlankSilverwood")), new ResearchPage("tc.research_page.PLANTS.3"), new ResearchPage("tc.research_page.PLANTS.4"), new ResearchPage("tc.research_page.PLANTS.5"), new ResearchPage("tc.research_page.PLANTS.6")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("ENCHANT", "BASICS", new LinkedHashAspectList<>(), -4, -2, 0, new ResourceLocation("thaumcraft", "textures/misc/r_enchant.png"))).setPages(new ResearchPage("tc.research_page.ENCHANT.1"), new ResearchPage("tc.research_page.ENCHANT.2")).setStub().setRound().setAutoUnlock().registerResearchItem();
      (new ResearchItem("NODETAPPER1", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("NODEPRESERVE", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 3).addAll(Aspects.GREED, 3).addAll(
      ...
      ((ItemJarNode)jarIs.getItem()).setAspects(jarIs, (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 40).addAll(Aspects.FIRE, 40).addAll(
              Aspects.WATER, 40).addAll(Aspects.EARTH, 40));
      ((ItemJarNode)jarIs.getItem()).setNodeAttributes(jarIs, NodeType.NORMAL, null, "");
      (new ResearchItem("NODEJAR", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.GREED, 3).addAll(
      ...
      (new ResearchItem("NODETAPPER2", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 6).addAll(Aspects.MAGIC, 3).addAll(
      ...
      (new ResearchItem("RESEARCHER1", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.MIND, 3).addAll(Aspects.SENSES, 3).addAll(
      ...
      (new ResearchItem("DECONSTRUCTOR", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.MIND, 3).addAll(Aspects.CRAFT, 3).addAll(
              Aspects.ENTROPY, 3), 6, 2, 1, new ItemStack(ConfigBlocks.blockTable, 1, 14))).setPages(new ResearchPage("tc.research_page.DECONSTRUCTOR.1"), new ResearchPage((AbstractArcaneRecipe)recipes.get("Deconstructor")), new ResearchPage("tc.research_page.DECONSTRUCTOR.2")).setRound().setParents("RESEARCHER1").registerResearchItem();
      (new ResearchItem("RESEARCHER2", "BASICS", (new LinkedHashAspectList<>()).addAll(Aspects.MIND, 6).addAll(Aspects.ORDER, 3).addAll(
      ...
      (new ResearchItem("CRIMSON", "BASICS", new LinkedHashAspectList<>(), 0, 4, 0, new ItemStack(ThaumcraftItemInstances.CRIMSON_RITES()))).setPages(new ResearchPage("tc.research_page.CRIMSON.1")).setStub().setHidden().setRound().setSpecial().registerResearchItem();
      ThaumcraftApi.addWarpToResearch("CRIMSON", 3);
   }

   private static void initEldritchResearch() {
      (new ResearchItem("ELDRITCHMINOR", "ELDRITCH", new LinkedHashAspectList<>(), 1, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_eldritchminor.png"))).setPages(new ResearchPage("tc.research_page.ELDRITCHMINOR.1"), new ResearchPage((CrucibleRecipe)recipes.get("VoidSeed"))).setHidden().setRound().setSpecial().registerResearchItem();
      (new ResearchItem("ELDRITCHMAJOR", "ELDRITCH", new LinkedHashAspectList<>(), -1, 0, 0, new ResourceLocation("thaumcraft", "textures/misc/r_eldritchmajor.png"))).setPages(new ResearchPage("tc.research_page.ELDRITCHMAJOR.1"), new ResearchPage("tc.research_page.ELDRITCHMAJOR.2")).setStub().setHidden().setRound().setSpecial().registerResearchItem();
      new ResearchItem(
              "OCULUS",
              "ELDRITCH",
              new LinkedHashAspectList<>()
              ...
              , -2, 2, 1,
              new ItemStack(ThaumcraftItemInstances.ELDRITCH_EYE()))
      ...
      (new ResearchItem("ENTEROUTER", "ELDRITCH", new LinkedHashAspectList<>(), -3, 4, 1, new ResourceLocation("thaumcraft", "textures/misc/r_outer.png"))).setPages(new ResearchPage("tc.research_page.ENTEROUTER.1")).setStub().setHidden().setRound().setParents("OCULUS").registerResearchItem();
      (new ResearchItem("OUTERREV", "ELDRITCH", (new LinkedHashAspectList<>()).addAll(Aspects.ELDRITCH, 4).addAll(Aspects.MIND, 4), -5, 3, 1, new ResourceLocation("thaumcraft", "textures/misc/r_outerrev.png"))).setPages(new ResearchPage("tc.research_page.OUTERREV.1")).setItemTriggers(new ItemStack(ConfigBlocks.blockEldritch, 1, 5), new ItemStack(ConfigBlocks.blockEldritch, 1, 10)).setLost().setSecondary().setSpecial().setParents("ENTEROUTER").registerResearchItem();
      (new ResearchItem("PRIMPEARL", "ELDRITCH",
              (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 8).addAll(Aspects.EARTH, 8).addAll(Aspects.FIRE, 8).addAll(Aspects.WATER, 8).addAll(
                      Aspects.ORDER, 8).addAll(Aspects.ENTROPY, 8),
              0, 4,
              1,
              new ItemStack(ThaumcraftItemInstances.PRIME_PEARL()))
      ).setPages(
              new ResearchPage("tc.research_page.PRIMPEARL.1"),
              new ResearchPage("tc.research_page.PRIMPEARL.2")
      )
              .setItemTriggers(new ItemStack(ThaumcraftItemInstances.PRIME_PEARL()))
              .setLost()
              .setSecondary()
              .setSpecial()
              .setParents("ELDRITCHMINOR")
              .registerResearchItem();
      (new ResearchItem("PRIMNODE", "ELDRITCH", (new LinkedHashAspectList<>()).addAll(Aspects.AURA, 1).addAll(Aspects.MAGIC, 1).addAll(
      ...
      (new ResearchItem("FOCUSPRIMAL",
              "ELDRITCH", (new LinkedHashAspectList<>())
              .addAll(Aspects.AIR, 6)
              .addAll(Aspects.WATER, 6)
              .addAll(Aspects.FIRE, 6)
              .addAll(Aspects.EARTH, 6)
              .addAll(Aspects.ORDER, 6)
              .addAll(Aspects.ENTROPY, 6)
              .addAll(Aspects.MAGIC, 6),
              4, 1, 2, new ItemStack(ConfigItems.itemFocusPrimal)))
              .setPages(new ResearchPage("tc.research_page.FOCUSPRIMAL.1"),
                      new ResearchPage((AbstractArcaneRecipe)recipes.get("FocusPrimal"))).setConcealed().setParents("ELDRITCHMINOR").registerResearchItem();
      ...
      (new ResearchItem("ROD_primal_staff", "ELDRITCH",
              (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 9)
                      .addAll(Aspects.EARTH, 9)
                      .addAll(Aspects.FIRE, 9)
                      .addAll(Aspects.WATER, 9)
                      .addAll(Aspects.ORDER, 9)
                      .addAll(Aspects.ENTROPY, 9)
                      .addAll(Aspects.TOOL, 9)
                      .addAll(Aspects.MAGIC, 12),
              6, 2, 3,
