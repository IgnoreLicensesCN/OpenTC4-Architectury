...
public class DelayControllableMeleeAttackGoal extends Goal {
    ...
    public DelayControllableMeleeAttackGoal(PathfinderMob arg, double d, boolean bl) {
        this.mob = arg;
    ...
    protected void checkAndPerformAttack(LivingEntity arg, double d) {
        double d0 = this.getAttackReachSqr(arg);
        if (d <= d0 && this.ticksUntilNextAttack <= 0) {
            this.resetAttackCooldown();
            this.mob.swing(InteractionHand.MAIN_HAND);
            this.mob.doHurtTarget(arg);
        }
    }

    public DelayControllableMeleeAttackGoal setAttackInterval(int interval) {
    ...
    protected double getAttackReachSqr(LivingEntity arg) {
        return this.mob.getBbWidth() * 2.0F * this.mob.getBbWidth() * 2.0F + arg.getBbWidth();
    }
}
