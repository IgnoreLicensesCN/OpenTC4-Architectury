...
//              && (this.entity.getHomePosition().getDistanceSquared(
//                      (int)this.entity.posX, (int)this.entity.posY, (int)this.entity.posZ) > 16.0F
//              || this.world.getBlock(
//                      this.entity.getHomePosition().posX, this.entity.getHomePosition().posY, this.entity.getHomePosition().posZ)
