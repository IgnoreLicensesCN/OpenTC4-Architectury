...
public class AILiquidGather extends EntityAIBase {
    ...
    public static void getConnectedFluidBlocks_tweak(World world, int x, int y, int z, Fluid fluid, ArrayList<SourceBlock> sources, float pumpDist) {
        ...
        Set<ChunkCoordinates> seen = new HashSet<>();  // ChunkCoordinates has quite terrible hash function, but there are multiple different optimization mod that optimize this. given the popularity fromAspectVisList those I'd say it's fine to use it
