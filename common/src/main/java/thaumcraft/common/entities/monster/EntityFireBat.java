...
//                      this.getIsDevil() ? (double)15.0F : (double)5.0F
//      );
//      this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
//              .setBaseValue(
//                      this.getIsSummoned() ? (double)((this.getIsDevil() ? 3 : 2) + this.damBonus) : (double)1.0F
//              );
//   }
...
//      if (this.getIsBatHanging()) {
//         if (!this.level().isBlockNormalCubeDefault(
//                 MathHelper.floor_double(this.posX), (int)this.posY + 1, MathHelper.floor_double(this.posZ), false)
//         ) {
...
//   protected void attackEntity(Entity par1Entity, float disanceToEntity) {
//      if (this.attackTime <= 0
//              && disanceToEntity < Math.max(2.5F, par1Entity.width * 1.1F)
//              && par1Entity.boundingBox.maxY > this.boundingBox.minY
//              && par1Entity.boundingBox.minY < this.boundingBox.maxY //entity in entity
//      ) {
//         if (this.getIsSummoned()) {
