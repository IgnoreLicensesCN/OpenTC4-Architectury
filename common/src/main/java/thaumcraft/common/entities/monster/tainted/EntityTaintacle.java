...
//              AxisAlignedBB.getBoundingBox(this.posX, this.posY, this.posZ, this.posX, this.posY, this.posZ).expand(24.0F, 8.0F, 24.0F)
//      );
...
//              && this.level().getBiomeGenForCoords(MathHelper.floor_double(this.posX),
//              MathHelper.floor_double(this.posZ)).biomeID != Config.biomeTaintID) {
...
//      if (this.level().getBiomeGenForCoords(i, k).biomeID == Config.biomeEldritchID
//              || this.level().getBiomeGenForCoords(i, k).biomeID == Config.biomeTaintID
//              && (
//                      this.level().getBlock(i, j, k).getMaterial() == Config.taintMaterial
//                              || this.level().getBlock(i, j, k).getMaterial() == Config.taintMaterial
//                              || this.level().getBlock(i, j - 1, k).getMaterial() == Config.taintMaterial)) {
...
//              && ds.getEntity() != null
//              && this.getDistanceToEntity(ds.getEntity()) > 16.0F && Platform.getEnvironment() != Env.CLIENT
//      ) {
