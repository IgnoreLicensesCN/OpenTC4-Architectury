...
//                 0.0F, 0.03, 0.0F,
//                 0.1F + boss.level().rand.nextFloat() * 0.1F,
//                 0.8F + boss.level().rand.nextFloat() * 0.2F,
//                 0.1F + boss.level().rand.nextFloat() * 0.1F,
//                 0.9F, true, 21, 4, 1, 4 + boss.level().rand.nextInt(4), 0, 0.5F + boss.level().rand.nextFloat() * 0.2F);
//      }
//   }
}
