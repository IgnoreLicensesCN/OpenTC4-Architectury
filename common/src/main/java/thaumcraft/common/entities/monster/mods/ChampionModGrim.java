...
//         Thaumcraft.proxy.drawGenericParticles(boss.level(),
//                 boss.boundingBox.minX + (double)w,
//                 boss.boundingBox.minY + (double)h,
//                 boss.boundingBox.minZ + (double)d,
//                 0.0F, -0.02, 0.0F,
//                 boss.level().rand.nextFloat() * 0.2F,
//                 boss.level().rand.nextFloat() * 0.2F,
//                 boss.level().rand.nextFloat() * 0.2F,
//                 0.8F, false, 160, 10, 1,
//                 8 + boss.level().rand.nextInt(4),
//                 0, 0.6F + boss.level().rand.nextFloat() * 0.4F);
//      }
//   }
}
