...
//         }
//
//         Aspect ta = this.aspectFilter;
//         if (this.aspect != null && this.amount > 0) {
//            ta = this.aspect;
//         } else if (
//                 ic.getEssentiaAmount(Direction.DOWN) > 0
//                 && ic.getSuctionAmount(Direction.DOWN) < this.getSuctionAmount(Direction.UP)
//                         && this.getSuctionAmount(Direction.UP) >= ic.getMinimumSuctionToDrainOut()
//         ) {
