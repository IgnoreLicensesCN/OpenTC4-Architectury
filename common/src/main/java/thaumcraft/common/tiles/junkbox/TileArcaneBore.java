...
public class TileArcaneBore /*extends TileThaumcraft
        implements Container, IWandInteractableBlockOrBlockEntity, TickingBlockEntity*/ {
//    public int spiral = 0;
...
//    private final int itemsPerVis = 20;//inlined?
//
...
//
//        {
//            if (this.fakePlayer instanceof ServerPlayer serverPlayer && this.hasPickaxe && this.getStackInSlot(
//                    1) != null) {
//                if (this.repairCounter++ % 40L == 0L && this.getStackInSlot(1)
//                        .isDamaged()) {
...
//                            this.currentRepairVis.addAll(
//                                    repairAspect,
//                                    VisNetHandler.drainVis(this.level, this.getPos(), repairAspect, repairAmount)
//                            );
//                        }
//                    }
//                }
...
//                            .updateAnimation(this.level, this.fakePlayer, 0, true);
