...
//      if (Platform.getEnvironment() != Env.CLIENT && this.counter++ % 40 == 0 && !this.level().isBlockIndirectlyGettingPowered(this.xCoord, this.yCoord, this.zCoord)
//              && this.hasIngredients()) {
...
//                 || !this.tank.getInfo().fluid.containsFluid(
//                         new FluidStack(FluidRegistry.WATER, 1000))
//         ) {
//            return false;
//         }
//
//          return this.itemStacks[0] != null
//                  && this.itemStacks[0].getItem() instanceof ItemBathSalts;//water and bath salts
//      } else {
//         return this.tank.getInfo().fluid != null && this.tank.getFluid().getFluid().canBePlacedInWorld() && this.tank.getFluidAmount() >= 1000;
//      }
//   }
//
