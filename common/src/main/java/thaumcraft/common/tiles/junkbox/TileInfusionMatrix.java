...
//                || this.instability > 0 && Math.max(1, this.level().rand.nextInt(500)) <= this.instability) {
...
//                } else {
//                    target.addPotionEffect(new PotionEffect(ThaumcraftEffects.VIS_EXHAUST, 2400, 0, true));
//                }
//
//                if (!all) {
//                    break;
...
//            InfusionMatrixBlockEntity.ClientTickContext.SourceFX fx = (InfusionMatrixBlockEntity.ClientTickContext.SourceFX) this.sourceFX.get(fxk);
//            if (fx.ticks <= 0) {
