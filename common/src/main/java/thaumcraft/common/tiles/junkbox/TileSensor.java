...
@Deprecated(forRemoval = true)//get out of history,this should be called performance issue
...
//         }
//
//         List<Integer[]> nbe = (ArrayList)noteBlockEvents.get(this.level());
//         if (nbe != null) {
//            for(Integer[] dat : nbe) {
//               if (dat[3] == this.tone
//                       && dat[4] == this.note
//                       && this.getDistanceFromSquared(
//                       (double)dat[0] + (double)0.5F,
//                       (double)dat[1] + (double)0.5F,
//                       (double)dat[2] + (double)0.5F
//               ) <= (double)4096.0F
//               ) {
...
//   }
//
//   public double getDistanceFromSquared(double par1, double par3, double par5) {
