...
//                        int drain = VisNetHandler.drainCentiVis(this.level(), this.xCoord, this.yCoord, this.zCoord, aspect, Math.min(100, this.aspects.get(aspect)));
//                        if (drain > 0) {
...
//            }//counting rank -> IWandFocusItem#getRank()
//
//            int xp = this.rank * 8;//xp requirement
...
//                    break;
//                }
//            }//canApply (contains upgrade part)
//
//            if (!b) {
//                return false;
//            }
//            if (id <= FocusUpgradeType.types.length - 1
//                    && FocusUpgradeType.types[id] != null
//                    && focus.canApplyUpgrade(
//                            this.getStackInSlot(0),
//                            p,
//                            FocusUpgradeType.types[id],
//                            this.rank
//                    //upgrade exists
//            )
//            )
