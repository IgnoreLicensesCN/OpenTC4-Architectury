...
//
//         Aspect ta = null;
//         if (ic.getEssentiaAmount(this.facing.getOpposite()) > 0
//                 && ic.getSuctionAmount(this.facing.getOpposite()) < this.getSuctionAmount(this.facing)
//                 && this.getSuctionAmount(this.facing) >= ic.getMinimumSuctionToDrainOut()
//         ) {
