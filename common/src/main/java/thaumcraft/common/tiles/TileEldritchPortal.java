...
//            this.level()
//                    .playSound(
//                            (double) this.xCoord + (double) 0.5F,
//                            (double) this.yCoord + (double) 0.5F,
//                            (double) this.zCoord + (double) 0.5F,
...
//                 ServerPlayer.class,
//                 AxisAlignedBB.getBoundingBox(this.xCoord, this.yCoord, this.zCoord, this.xCoord + 1, this.yCoord + 1, this.zCoord + 1)
//                         .expand(0.5F, 1.0F, 0.5F)
//         );
//         if (!ents.isEmpty()) {
//            for(Object e : ents) {
