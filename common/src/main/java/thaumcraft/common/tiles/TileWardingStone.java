...
//                    && this.level().getBlock(this.xCoord, this.yCoord + 1, this.zCoord).isReplaceable(this.level(), this.xCoord, this.yCoord + 1, this.zCoord)
//            ) {
//               this.level().setBlock(this.xCoord, this.yCoord + 1, this.zCoord, ConfigBlocks.blockAiry, 4, 3);
//            }
//
//            if ((this.level().getBlock(this.xCoord, this.yCoord + 2, this.zCoord) != ConfigBlocks.blockAiry
//                    || this.level().getBlockMetadata(this.xCoord, this.yCoord + 2, this.zCoord) != 3)
//                    && this.level().getBlock(this.xCoord, this.yCoord + 2, this.zCoord).isReplaceable(this.level(), this.xCoord, this.yCoord + 2, this.zCoord)
//            ) {
