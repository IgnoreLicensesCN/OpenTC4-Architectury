...
//         boolean hasThingy =
//                 this.level().getBlock(this.xCoord, this.yCoord + 1, this.zCoord) == ConfigBlocks.blockStoneDevice
//                         && this.level().getBlockMetadata(this.xCoord, this.yCoord + 1, this.zCoord) == 8;
//
...
//            int min = 1;
//            if (
//                    wand.getCap(this.getStackInSlot(0)).getTag().equals("iron")
//                    || wand.getRod(this.getStackInSlot(0)).getTag().equals("wood")
//            ) {
//               min = 0;
//            }
//
//            AspectList<Aspect>aspectRequiring = wand.getAspectsWithRoomRemaining(this.getStackInSlot(0));
//            this.draining = false;
//            if (aspectRequiring != null && aspectRequiring.size() > 0) {
//               drainVisLabel:
...
//
//                     for(Aspect aspect : aspectRequiring.getAspects()) {
...
//      return this.level().getTileEntity(this.xCoord, this.yCoord, this.zCoord) == this
//              && par1Player.getDistanceSq(
//                      (double) this.xCoord + (double) 0.5F, (double) this.yCoord + (double) 0.5F, (double) this.zCoord + (double) 0.5F)
//              <= (double) 64.0F;
//   }
