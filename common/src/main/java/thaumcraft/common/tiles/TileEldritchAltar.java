...
//        int w = 15 + this.level.random.nextInt(8) * 2;
//        int h = 15 + this.level.random.nextInt(8) * 2;
//        if (!MazeHandler.mazesInRange(this.xCoord >> 4, this.zCoord >> 4, w, h)) {
//            Thread t = new Thread(new MazeThread(this.xCoord >> 4, this.zCoord >> 4, w, h, this.level.random.nextLong()));
//            t.start();
//            return false;
//        } else {
//            return true;
