...
//            if (Thaumcraft.proxy.playerKnowledge.getAspectPoolFor(player.getCommandSenderName(), aspect) < rr.tags.getAmount(aspect) + this.data.copiedCount) {
//               return;
//            }
//         }
//
//         for(Aspect aspect : rr.tags.getAspects()) {
//            Thaumcraft.proxy.playerKnowledge.addAspectPool(player.getCommandSenderName(), aspect, (short)(-(rr.tags.getAmount(aspect) + this.data.copiedCount)));
//            ResearchManager.scheduleSave(player);
//            PacketHandler.INSTANCE.sendTo(new PacketAspectPool(aspect.getAspectKey(), (short) 0, Thaumcraft.proxy.playerKnowledge.getAspectPoolFor(player.getCommandSenderName(), aspect)), (ServerPlayer)player);
//         }
//
