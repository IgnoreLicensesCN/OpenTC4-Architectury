...
public class BiomeGenMagicalForest /*extends BiomeGenBase*/ {
   ...
   public static int grassColor = Config.blueBiome ? 0x6728396 : 0x5635969;
   public static int skyColor = 0x88CCFF;

   public static Biome createMagicalForest() {
      // 生物生成
      MobSpawnSettings.Builder spawns = new MobSpawnSettings.Builder();
      spawns.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.WOLF, 2, 1, 3));
      spawns.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.HORSE, 2, 1, 3));
      spawns.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.WITCH, 3, 1, 1));
      spawns.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 3, 1, 1));
      if (Config.spawnPech) {
         spawns.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(ThaumcraftEntities.PECH, 10, 1, 2));
      }
      if (Config.spawnWisp) {
         spawns.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(ThaumcraftEntities.WISP, 10, 1, 2));
      }
      ...
      BiomeGenerationSettings.PlainBuilder generation = new BiomeGenerationSettings.PlainBuilder();
      {
         ...
         //suddenly...trees
         PlacedFeature randomPlacedTrees = getPlaceRandomTreeFeature();
         generation.addFeature(
                 GenerationStep.Decoration.VEGETAL_DECORATION.ordinal(),
                 Holder.direct(randomPlacedTrees));
   ...
   private static @NotNull PlacedFeature getPlaceRandomTreeFeature() {
      ...
      Holder<ConfiguredFeature<?, ?>> randomTreeFeatureHolder = Holder.direct(configuredRandomTree);
       return new PlacedFeature(
               randomTreeFeatureHolder, List.of(
               CountPlacement.of(2),
