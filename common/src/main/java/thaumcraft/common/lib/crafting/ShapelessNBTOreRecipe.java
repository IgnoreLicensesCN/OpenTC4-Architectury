...
@Deprecated(forRemoval = true,since = "we have RecipeItemMatcher and impls you can define")
...
//   }
//
//   public boolean matches(InventoryCrafting var1, Level world) {
...
//      return target.getItem() == input.getItem() && ItemStack.areItemStackTagsEqual(target, input) && (target.getDamageValue() == 32767 || target.getDamageValue() == input.getDamageValue());
//   }
//
