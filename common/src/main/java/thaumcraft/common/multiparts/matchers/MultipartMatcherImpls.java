...
public class MultipartMatcherImpls {
    public static final AbstractMultipartMatcher INFERNAL_FURNACE_BEFORE_FORMING =
            new AbstractMultipartMatcher(
                    new AbstractBlockMatcher[][][]//[y][x][z]
                            {
                                    {
    ...
    public static final AbstractMultipartMatcher INFERNAL_FURNACE_FORMED =//TODO
            new AbstractMultipartMatcher(
                    new AbstractBlockMatcher[][][]//[y][x][z]
                            {
                                    {
                                    ...
                                    {
                                            {NETHER_BRICKS_MATCHER,OBSIDIAN_MATCHER,NETHER_BRICKS_MATCHER},
                                            {OBSIDIAN_MATCHER, LAVA_SOURCE_MATCHER,OBSIDIAN_MATCHER},
                                            {NETHER_BRICKS_MATCHER,IRON_BARS_MATCHER,NETHER_BRICKS_MATCHER},//y=1,x=2
                                    },//y=1,
                                    {
                                            {NETHER_BRICKS_MATCHER,OBSIDIAN_MATCHER,NETHER_BRICKS_MATCHER},//y=2,x=0
