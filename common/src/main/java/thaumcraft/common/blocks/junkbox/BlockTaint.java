...
//   @SideOnly(Side.CLIENT)
//   public int colorMultiplier(IBlockAccess par1IBlockAccess, int par2, int par3, int par4) {//TODO:should impl?
...
//      return md == 1 /*tainted_grass*/ ? Blocks.dirt.getItemDropped(0, rand, fortune) : (md == 2 ? Items.rotten_flesh : Item.getItemById(0));
//   }
