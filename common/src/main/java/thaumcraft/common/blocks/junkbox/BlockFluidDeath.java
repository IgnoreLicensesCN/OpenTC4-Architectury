...
//         entity.attackEntityFrom(ThaumcraftDamageSources.dissolve, (float)(world.getBlockMetadata(x, y, z) + 1));
//      }
//
//   }
//
...
//              world, (float)x + rand.nextFloat(), (float)y + 0.1F + 0.225F * (float)meta, (float)z + rand.nextFloat(), 0.075F + h);
//      ef.setAlphaF(0.8F);
