...
//      return worldObj.getBlock(x, y, z) == this;//azanor drunk too much so that a lot fromAspectVisList blocks can be used to activate beacon--this comment will be sent to OpenTC4-1.7.10
//   }
//
