...
//                        ((ItemWispEssence)ess.getItem()).setAspectsWithBase(ess, (new LinkedTreeAspectList<>()).addAll(aspect, 2));
...
//      return worldObj.getBlock(x, y, z) == this;//azanor drunk too much so that a lot of blocks can be used to activate beacon--this comment will be sent to OpenTC4-1.7.10
//   }
//
