...
//              || !(Minecraft.getMinecraft().thePlayer.getCurrentEquippedItem().getItem() instanceof WandCastingItem)
//                      && !(Minecraft.getMinecraft().thePlayer.getCurrentEquippedItem().getItem() instanceof ItemResonator);//"item.ItemResonator.name": "源质谐振器"
...
//   //congratulations Mojang finished this part so GO FUCK OFF.
