    ...
    private static Item getGearItemForSlot(int slot, int quality) {
        switch (slot) {
            case 4: // 头盔
                ...
                else if (quality == 4) return ThaumcraftItems.THAUMIUM_HELMET;
                else if (quality == 5) return Items.DIAMOND_HELMET;
                else if (quality == 6) return ThaumcraftItems.VOID_HELMET;
                break;
            case 3: // 胸甲
                ...
                else if (quality == 4) return ThaumcraftItems.THAUMIUM_CHESTPLATE;
                else if (quality == 5) return Items.DIAMOND_CHESTPLATE;
                else if (quality == 6) return ThaumcraftItems.VOID_CHESTPLATE;
                break;
            case 2: // 护腿
                ...
                else if (quality == 4) return ThaumcraftItems.THAUMIUM_LEGGINGS;
                else if (quality == 5) return Items.DIAMOND_LEGGINGS;
                else if (quality == 6) return ThaumcraftItems.VOID_LEGGINGS;
                break;
            case 1:
                ...
                else if (quality == 4) return ThaumcraftItems.THAUMIUM_BOOTS;
                else if (quality == 5) return Items.DIAMOND_BOOTS;
                else if (quality == 6) return ThaumcraftItems.VOID_BOOTS;
                break;
            case 0:
                ...
                else if (quality == 4) return ThaumcraftItems.THAUMIUM_SWORD;
                else if (quality == 5) return Items.DIAMOND_SWORD;
                else if (quality == 6) return ThaumcraftItems.VOID_SWORD;
                break;
            default:
                return null;
        }
