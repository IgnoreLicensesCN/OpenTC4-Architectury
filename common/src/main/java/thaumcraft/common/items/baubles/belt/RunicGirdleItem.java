...
public class RunicGirdleItem extends AccessoryItem implements IAugmentationRunicShieldProviderItem {
    public RunicGirdleItem(Properties properties) {
        super(properties);
    }
    public RunicGirdleItem() {
    ...
    private static final CalcCacheableObject2IntMap<AbstractRunicShieldType<?>> BASIC_SHIELDS =
            new CalcCacheableObject2IntMap<>(Object2IntMaps.unmodifiable(
                    new Object2IntArrayMap<>(){{
                        put(ThaumcraftRunicShieldTypes.COMMON,10);
                    }}
            ),
                    true);
    @Override
