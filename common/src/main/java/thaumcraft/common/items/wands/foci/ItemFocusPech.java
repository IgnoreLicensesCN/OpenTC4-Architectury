...
public class ItemFocusPech extends ItemFocusBasic {
   ...
   static {
      cost = (new LinkedHashAspectList<>()).addAll(Aspects.EARTH, 10).addAll(Aspects.ENTROPY, 10).addAll(Aspects.WATER, 10);
      costAll = (new LinkedHashAspectList<>()).addAll(Aspects.AIR, 10).addAll(Aspects.FIRE, 10).addAll(Aspects.EARTH, 10).addAll(
              Aspects.ORDER, 10).addAll(Aspects.ENTROPY, 10).addAll(Aspects.WATER, 10);
      nightshade = new FocusUpgradeType(15, new ResourceLocation("thaumcraft", "textures/foci/nightshade.png"), "focus.upgrade.nightshade.name", "focus.upgrade.nightshade.text", (new LinkedHashAspectList<>()).addAll(
