...
public class QuartzWandRodItem extends ThaumcraftAspectRegenWandRodItem implements ICraftingCostAspectOwnerComponentItem<Aspect> {
    public QuartzWandRodItem() {
        super(new Properties(), UnmodifiableCentiVisList.of(Aspects.ORDER,7 * CENTIVIS_MULTIPLIER));
    }
