...
//we already have many things like this and this part could be messy so i want to forget this part
//TODO:[maybe wont finished]impl it
...
//
//   static {
//      cost = (new LinkedHashAspectList<>()).addAll(Aspects.EARTH, 25).addAll(Aspects.ORDER, 25).addAll(Aspects.WATER, 10);
//      delay = new HashMap<>();
//   }
}
