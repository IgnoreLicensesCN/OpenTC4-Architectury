...
public class IceStaffRodItem extends ThaumcraftAspectRegenStaffRodItem implements ICraftingCostAspectOwnerComponentItem<Aspect> {
    public IceStaffRodItem() {
        super(new Properties(), UnmodifiableCentiVisList.of(Aspects.WATER,17 * CENTIVIS_MULTIPLIER));
    }
