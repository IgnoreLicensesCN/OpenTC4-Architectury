...
public class IceWandRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsWandRod, ICraftingCostAspectOwnerComponent<Aspect> {
    public IceWandRodItem() {
        super(new Properties(), getAspectsCentiVisListWithValue(Aspects.WATER,7 * CENTIVIS_MULTIPLIER));
    }
