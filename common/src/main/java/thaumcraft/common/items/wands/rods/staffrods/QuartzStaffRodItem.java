...
public class QuartzStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod {
    public QuartzStaffRodItem() {
        super(new Properties(), getPrimalAspectMapWithValue(175));
    }

    private final Map<Aspect, Integer> capacity = Map.of(Aspect.ORDER,17);
    @Override
    @UnmodifiableView
