...
public class QuartzStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod, ICraftingCostAspectOwner {
    public QuartzStaffRodItem() {
        super(new Properties(), Map.of(Aspects.ORDER,17 * CENTIVIS_MULTIPLIER));
    }
