...
public class BlazeWandRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsWandRod, CraftingCostAspectOwner {
    public BlazeWandRodItem() {
        super(new Properties(), Map.of(Aspect.FIRE,7));
    }
