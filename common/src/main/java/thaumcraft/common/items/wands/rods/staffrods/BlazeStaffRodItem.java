...
public class BlazeStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod, ICraftingCostAspectOwner {
    public BlazeStaffRodItem() {
        super(new Properties(), Map.of(Aspects.FIRE,17 * CENTIVIS_MULTIPLIER));
    }
    ...
    private static final Map<Aspect, Integer> cost = Collections.unmodifiableMap(WandUtils.getPrimalAspectMapWithValue(14 * CENTIVIS_MULTIPLIER));
    @Override
    @UnmodifiableView
