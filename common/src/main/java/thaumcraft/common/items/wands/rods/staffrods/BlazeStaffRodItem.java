...
public class BlazeStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod {
    public BlazeStaffRodItem() {
        super(new Properties(), getPrimalAspectMapWithValue(175));
    }

    private final Map<Aspect, Integer> capacity = Map.of(Aspect.FIRE,17);
    @Override
    @UnmodifiableView
