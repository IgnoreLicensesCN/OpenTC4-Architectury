...
import thaumcraft.api.wands.IWandCapPropertiesOwner;
...
public abstract class ThaumcraftWandCapItem extends Item implements IWandCapPropertiesOwner, IWandComponentNameOwnerItem /*, WandSpellEventListenable(we don't use this in vanilla tc4)*/ {
