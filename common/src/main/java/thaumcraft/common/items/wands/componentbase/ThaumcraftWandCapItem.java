...
public abstract class ThaumcraftWandCapItem extends Item implements IWandCapPropertiesOwner, IWandComponentNameOwner /*, WandSpellEventListenable(we don't use this in vanilla tc4)*/ {
