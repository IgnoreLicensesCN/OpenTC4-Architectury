...
public class ObsidianStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod {
    public ObsidianStaffRodItem() {
        super(new Properties(), getPrimalAspectMapWithValue(175));
    }

    private final Map<Aspect, Integer> capacity = Map.of(Aspect.EARTH,17);
    @Override
    @UnmodifiableView
