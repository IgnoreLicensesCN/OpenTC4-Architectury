...
public class ReedStaffRodItem extends ThaumcraftAspectRegenStaffRodItem implements ICraftingCostAspectOwnerComponentItem<Aspect> {
    public ReedStaffRodItem() {
        super(new Properties(), UnmodifiableCentiVisList.of(Aspects.AIR,17 * CENTIVIS_MULTIPLIER));
    }
