...
public class ReedStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod, ICraftingCostAspectOwner {
    public ReedStaffRodItem() {
        super(new Properties(), Map.of(Aspects.AIR,17 * CENTIVIS_MULTIPLIER));
    }
