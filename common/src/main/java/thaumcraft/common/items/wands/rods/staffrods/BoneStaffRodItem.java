...
public class BoneStaffRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsStaffRod, CraftingCostAspectOwner {
    public BoneStaffRodItem() {
        super(new Properties(), Map.of(Aspect.ENTROPY,17));
    }
