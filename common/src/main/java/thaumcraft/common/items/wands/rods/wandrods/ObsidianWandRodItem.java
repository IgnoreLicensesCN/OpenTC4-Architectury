...
public class ObsidianWandRodItem extends ThaumcraftAspectRegenWandRodItem implements WorkAsWandRod, ICraftingCostAspectOwner {
    public ObsidianWandRodItem() {
        super(new Properties(), Map.of(Aspects.EARTH,7 * CENTIVIS_MULTIPLIER));
    }
