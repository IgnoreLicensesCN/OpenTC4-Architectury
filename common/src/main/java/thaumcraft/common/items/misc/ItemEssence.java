...
//         return stack.getItemDamage() == 1 && this.getEssentiaOwning(stack) != null ? this.getEssentiaOwning(stack).getAspects()[0].getColor() : 16777215;
//      } else {
//         return 16777215;
//      }
//   }
...
//      return inv.addItemStackToInventory(itemStack);
//   }
//   public boolean onItemUseFirst(ItemStack itemstack, Player player, World world, int x, int y, int z, int side, float f1, float f2, float f3) {
...
//      }
//
//      AspectList<Aspect>al = this.getEssentiaOwning(itemstack);
