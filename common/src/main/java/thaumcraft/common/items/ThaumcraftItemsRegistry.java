...
//        );
    ...
    public static final RegistrySupplier<FrostFocusItem> SUPPLIER_FROST_FOCUS = ITEMS.register(
            "frost_focus",
            FrostFocusItem::new
    );
    public static final RegistrySupplier<HellBatFocusItem> SUPPLIER_HELL_BAT_FOCUS = ITEMS.register(
            "hell_bat_focus",
