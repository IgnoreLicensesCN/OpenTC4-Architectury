...
public class GogglesOfRevealingItem extends ArmorItem implements IVisDiscountGear, IGoggles, IAugmentationRunicShieldProviderItem {
    ...
    public GogglesOfRevealingItem() {
        this(ThaumcraftItems.ToolAndArmorMaterial.SPECIAL,
