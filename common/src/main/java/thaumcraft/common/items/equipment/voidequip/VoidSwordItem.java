...
public class VoidSwordItem extends SwordItem implements IWarpingGear {
    public VoidSwordItem(Tier tier, int i, float f, Properties properties) {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        list.add(Component.translatable("enchantment.special.sapless").withStyle(ChatFormatting.GOLD));
