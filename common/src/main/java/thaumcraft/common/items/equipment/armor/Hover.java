...
//                if (aspects != null && aspects.size() > 0 && aspects.get(Aspects.ENERGY) > 0) {
...
//                            player.posX, player.posY, player.posZ, "thaumcraft:jacobs", 0.05F, 1.0F + player.level().rand.nextFloat() * 0.05F, false
//                    );
//                }
//
...
//                    }
//                }
//                if (flyingSpeedModifier[0] > 1.0F) {
//                    flyingSpeedModifier[0] = 1.0F;
//                }
//
//                player.motionX *= flyingSpeedModifier[0];
//                player.motionZ *= flyingSpeedModifier[0];
//            } else if (hover) {
...
//                    && BaublesApi.getBaubles(player).getStackInSlot(3).getItem() instanceof ItemGirdleHover) {
//                mod = 0.8F;
//            }
//
...
//                --fuel;
//                if (fuel > 0) {
//                    ((ItemJarFilled) jar.getItem()).setAspects(jar, (new LinkedHashAspectList<>()).addAll(Aspects.ENERGY, fuel));
//                } else {
//                    ((ItemJarFilled) jar.getItem()).setAspects(jar, (new LinkedHashAspectList<>()).remove(
//                            Aspects.ENERGY));
//                }
//
